...
function u1.GetHighestPriorityGamepad(_) --[[ Line: 75 ]]
...
function u1.BindContextActions(u10) --[[ Line: 86 ]]
    ...
    l__ContextActionService__2:BindActionAtPriority("jumpAction", function(_, p11, _) --[[ Line: 93 ]]
        -- upvalues: u10 (copy)
        u10.isJumping = p11 == Enum.UserInputState.Begin;
        return Enum.ContextActionResult.Sink;
    end, false, u10.CONTROL_ACTION_PRIORITY, Enum.KeyCode.ButtonA);
    l__ContextActionService__2:BindActionAtPriority("moveThumbstick", function(_, p12, p13) --[[ Line: 98 ]]
        -- upvalues: u10 (copy)
...
function u1.UnbindContextActions(p14) --[[ Line: 127 ]]
    -- upvalues: l__None__3 (copy), l__ContextActionService__2 (copy)
...
function u1.OnNewGamepadConnected(p15) --[[ Line: 135 ]]
    -- upvalues: l__None__3 (copy)
...
function u1.OnCurrentGamepadDisconnected(p17) --[[ Line: 162 ]]
    -- upvalues: l__None__3 (copy), l__ContextActionService__2 (copy)
...
function u1.ConnectGamepadConnectionListeners(u19) --[[ Line: 187 ]]
    ...
    u19.gamepadConnectedConn = l__UserInputService__1.GamepadConnected:Connect(function(_) --[[ Line: 188 ]]
        -- upvalues: u19 (copy)
        u19:OnNewGamepadConnected();
    end);
    u19.gamepadDisconnectedConn = l__UserInputService__1.GamepadDisconnected:Connect(function(p20) --[[ Line: 192 ]]
        -- upvalues: u19 (copy)
...
function u1.DisconnectGamepadConnectionListeners(p21) --[[ Line: 200 ]]
