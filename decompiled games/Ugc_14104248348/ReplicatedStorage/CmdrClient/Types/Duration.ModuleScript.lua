-- Decompiled from: ReplicatedStorage.CmdrClient.Types.Duration
-- Class: ModuleScript
...
local function u22(p14, p15, p16, p17) --[[ Line: 65 ]]
    local v18 = p17 or 1;
    local v19 = {};
...
local u33 = {
    Transform = function(p23) --[[ Name: Transform, Line 79 ]]
        -- upvalues: u13 (copy)
        return p23, u13(p23);
    end,
    Validate = function(_, p24) --[[ Name: Validate, Line 83 ]]
        return p24 ~= nil;
    end,
    Autocomplete = function(p25, p26, p27, p28, p29) --[[ Name: Autocomplete, Line 87 ]]
    ...
    Parse = function(_, p32) --[[ Name: Parse, Line 111 ]]
        return p32;
    end
};
return function(p34) --[[ Line: 116 ]]
