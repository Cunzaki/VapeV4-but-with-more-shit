-- Decompiled from: ReplicatedStorage.CmdrClient.Types.Command
-- Class: ModuleScript
...
return function(u1) --[[ Line: 3 ]]
    ...
    local v6 = {
        Transform = function(p2) --[[ Name: Transform, Line 5 ]]
            ...
            return l__Util__1.MakeFuzzyFinder(u1:GetCommandNames())(p2);
        end,
    ...
    u1:RegisterType("commands", l__Util__1.MakeListableType(v6));
end;
