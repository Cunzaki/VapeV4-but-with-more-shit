-- Decompiled from: ReplicatedStorage.CmdrClient.Shared.Dispatcher
-- Class: ModuleScript
...
local u48 = {
    ...
    Run = function(p30, ...) --[[ Name: Run, Line 104 ]]
    ...
    RunHooks = function(p38, p39, p40, ...) --[[ Name: RunHooks, Line 132 ]]
    ...
    PushHistory = function(p43, p44) --[[ Name: PushHistory, Line 164 ]]
    ...
    GetHistory = function(_) --[[ Name: GetHistory, Line 179 ]]
