-- Decompiled from: ReplicatedStorage.Client.Source.Gameplay.Enemy.NewEnemies.ClientEnemy.Impacts.Stomp
-- Class: ModuleScript
...
return {
    Init = function(p2, p3) --[[ Name: Init, Line 18 ]]
        p2.Animations.Stomp:Play(0.2, 1, (p2.Animations.Stomp.Length - 0.45) / p3.TimeUntilImpact);
        p2.Sounds[`Attack{math.random(1, 2)}`]:Play();
    end,
    Spawn = function(p4, p5) --[[ Name: Spawn, Line 25 ]]
