-- Decompiled from: ReplicatedStorage.Client.Source.Gameplay.Drink.Components.DrinkMachine.Machines.SeafoodPot
-- Class: ModuleScript
...
return {
    Created = function(u4) --[[ Name: Created, Line 19 ]]
        ...
        function u4.OnHover(p5) --[[ Line: 24 ]]
        ...
        function u4.Interact(p6, p7) --[[ Line: 36 ]]
