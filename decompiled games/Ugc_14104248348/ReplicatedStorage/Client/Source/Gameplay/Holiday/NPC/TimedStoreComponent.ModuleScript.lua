-- Decompiled from: ReplicatedStorage.Client.Source.Gameplay.Holiday.NPC.TimedStoreComponent
-- Class: ModuleScript
...
l__Mince__4:Get("DailyBuy");
local u1 = l__Mince__4:Get("IndicatorHandler");
local u2 = l__Mince__4:Get("ItemShop");
local v3 = l__Mince__4.Component({
    Tag = "TimedStoreNPC"
});
function v3.PlayEmote(u4, p5) --[[ Line: 23 ]]
    ...
    u6:Play();
    u4.EmoteThread = task.delay(u6.Length, function() --[[ Line: 39 ]]
...
function v3.Construct(u7) --[[ Line: 48 ]]
    -- upvalues: l__Maid__3 (copy), u1 (copy), u2 (copy)
    ...
    u7.Indicator = u1.CreateIndicator(l__Indicator__7);
    ...
    v8.Triggered:Connect(function() --[[ Line: 78 ]]
