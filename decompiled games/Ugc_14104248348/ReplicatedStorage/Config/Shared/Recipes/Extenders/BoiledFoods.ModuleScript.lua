-- Decompiled from: ReplicatedStorage.Config.Shared.Recipes.Extenders.BoiledFoods
-- Class: ModuleScript
...
local u1 = {
    RecipeMatches = { "Lobster", "Crawfish" },
    ApplyRules = {
        Raw = {
            BasePart = {
                RawColor = "Color",
...
function u1.Apply(p16, p17) --[[ Line: 56 ]]
    p16:ApplyToTool(p17:GetAttribute("Boiled") and "Cooked" or "Raw", p17);
end;
return u1;
