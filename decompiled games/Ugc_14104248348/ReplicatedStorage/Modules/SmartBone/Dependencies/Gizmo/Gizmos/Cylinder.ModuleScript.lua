-- Decompiled from: ReplicatedStorage.Modules.SmartBone.Dependencies.Gizmo.Gizmos.Cylinder
-- Class: ModuleScript
...
function u1.Draw(p8, p9, p10, p11, p12) --[[ Line: 16 ]]
...
function u1.Create(p30, p31, p32, p33, p34) --[[ Line: 71 ]]
    local v35 = {
        Enabled = true,
        Destroy = false,
        Transform = p31,
...
function u1.Update(p36, p37) --[[ Line: 89 ]]
