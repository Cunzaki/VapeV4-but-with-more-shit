-- Decompiled from: ReplicatedStorage.Modules.SmartBone.Dependencies.Iris.widgets.Root
-- Class: ModuleScript
...
return function(u1, u2) --[[ Line: 3 ]]
    ...
    u1.WidgetConstructor("Root", {
        ...
        Args = {},
        Events = {},
        Generate = function(_) --[[ Name: Generate, Line 11 ]]
        ...
        Update = function(p10) --[[ Name: Update, Line 85 ]]
            -- upvalues: u3 (ref)
            if u3 > 0 then
                p10.Instance.PseudoWindowScreenGui.PseudoWindow.Visible = true;
            end;
        end,
        Discard = function(p11) --[[ Name: Discard, Line 93 ]]
            -- upvalues: u3 (ref)
            u3 = 0;
            p11.Instance:Destroy();
        end,
        ChildAdded = function(p12, p13) --[[ Name: ChildAdded, Line 97 ]]
            -- upvalues: u3 (ref)
        ...
        ChildDiscarded = function(p14, p15) --[[ Name: ChildDiscarded, Line 116 ]]
            -- upvalues: u3 (ref)
