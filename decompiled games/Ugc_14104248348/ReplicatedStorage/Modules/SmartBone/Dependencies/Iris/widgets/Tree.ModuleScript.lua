-- Decompiled from: ReplicatedStorage.Modules.SmartBone.Dependencies.Iris.widgets.Tree
-- Class: ModuleScript
...
return function(u1, u2) --[[ Line: 3 ]]
    local v10 = {
        ...
        ChildAdded = function(p7) --[[ Name: ChildAdded, Line 28 ]]
            local l__ChildContainer__1 = p7.Instance.ChildContainer;
            l__ChildContainer__1.Visible = p7.state.isUncollapsed.value;
            return l__ChildContainer__1;
        end,
        UpdateState = function(p8) --[[ Name: UpdateState, Line 36 ]]
            -- upvalues: u2 (copy), u1 (copy)
            local l__value__2 = p8.state.isUncollapsed.value;
            local l__Instance__3 = p8.Instance;
            local l__ChildContainer__4 = l__Instance__3.ChildContainer;
        ...
        GenerateState = function(p9) --[[ Name: GenerateState, Line 53 ]]
            -- upvalues: u1 (copy)
            if p9.state.isUncollapsed == nil then
                p9.state.isUncollapsed = u1._widgetState(p9, "isUncollapsed", false);
            end;
        end
    };
    u1.WidgetConstructor("Tree", u2.extend(v10, {
        ...
        Generate = function(u11) --[[ Name: Generate, Line 68 ]]
            ...
            u2.UIPadding(v13, Vector2.new(0, 0)).PaddingTop = UDim.new(0, u1._config.ItemSpacing.Y);
            v13.Parent = v12;
            ...
            v14.ZIndex = u11.ZIndex;
            v14.LayoutOrder = u11.ZIndex;
            v14.Parent = v12;
            ...
            v15.Text = "";
            v15.ZIndex = u11.ZIndex;
            v15.LayoutOrder = u11.ZIndex;
            v15.AutoButtonColor = false;
            u2.applyInteractionHighlights(v15, v14, {
            ...
            v16.ZIndex = u11.ZIndex;
            v16.LayoutOrder = u11.ZIndex;
            v16.Parent = v15;
            ...
            v17.ZIndex = u11.ZIndex;
            v17.LayoutOrder = u11.ZIndex;
            u2.UIPadding(v17, Vector2.new(0, 0)).PaddingRight = UDim.new(0, 21);
            u2.applyTextStyle(v17);
            v17.Parent = v15;
            v15.MouseButton1Click:Connect(function() --[[ Line: 160 ]]
                -- upvalues: u11 (copy)
                u11.state.isUncollapsed:set(not u11.state.isUncollapsed.value);
            end);
            return v12;
        end,
        Update = function(p18) --[[ Name: Update, Line 166 ]]
            -- upvalues: u1 (copy)
            local l__Instance__5 = p18.Instance;
            local l__Button__6 = l__Instance__5.Header.Button;
            local l__TextLabel__7 = l__Button__6.TextLabel;
            local l__UIPadding__8 = l__Instance__5.ChildContainer.UIPadding;
            l__TextLabel__7.Text = p18.arguments.Text or "Tree";
            if p18.arguments.SpanAvailWidth then
                l__Button__6.AutomaticSize = Enum.AutomaticSize.Y;
                l__Button__6.Size = UDim2.fromScale(1, 0);
            else
                l__Button__6.AutomaticSize = Enum.AutomaticSize.XY;
                l__Button__6.Size = UDim2.fromScale(0, 0);
            end;
            if p18.arguments.NoIndent then
                l__UIPadding__8.PaddingLeft = UDim.new(0, 0);
            else
                l__UIPadding__8.PaddingLeft = UDim.new(0, u1._config.IndentSpacing);
            end;
        end
    }));
    u1.WidgetConstructor("CollapsingHeader", u2.extend(v10, {
        ...
        Generate = function(u19) --[[ Name: Generate, Line 198 ]]
            -- upvalues: u1 (copy), u2 (copy)
            ...
            v22.ZIndex = u19.ZIndex;
            v22.LayoutOrder = u19.ZIndex;
            v22.Parent = v20;
            local v23 = Instance.new("TextButton");
            v23.Name = "Button";
            v23.Size = UDim2.new(1, 2 * u1._config.FramePadding.X, 0, 0);
            v23.Position = UDim2.fromOffset(-4, 0);
            ...
            v23.Text = "";
            v23.ZIndex = u19.ZIndex;
            v23.LayoutOrder = u19.ZIndex;
            v23.AutoButtonColor = false;
            v23.ClipsDescendants = true;
            u2.UIPadding(v23, Vector2.new(2 * u1._config.FramePadding.X, u1._config.FramePadding.Y));
            u2.applyFrameStyle(v23, true, true);
            ...
            u2.applyInteractionHighlights(v23, v23, {
            ...
            v24.ZIndex = u19.ZIndex;
            v24.LayoutOrder = u19.ZIndex;
            v24.Parent = v23;
            ...
            v25.ZIndex = u19.ZIndex;
            v25.LayoutOrder = u19.ZIndex;
            u2.UIPadding(v25, Vector2.new(0, 0)).PaddingRight = UDim.new(0, 21);
            u2.applyTextStyle(v25);
            v25.Parent = v23;
            v23.MouseButton1Click:Connect(function() --[[ Line: 296 ]]
                -- upvalues: u19 (copy)
                u19.state.isUncollapsed:set(not u19.state.isUncollapsed.value);
            end);
            return v20;
        end,
        Update = function(p26) --[[ Name: Update, Line 302 ]]
