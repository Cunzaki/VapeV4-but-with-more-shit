-- Decompiled from: ReplicatedStorage.Modules.Signal
-- Class: ModuleScript
...
setmetatable(u6, {
    __index = function(_, p10) --[[ Name: __index, Line 109 ]]
        error(("Attempt to get Connection::%s (not a valid member)"):format((tostring(p10))), 3);
    end,
    __newindex = function(_, p11, _) --[[ Name: __newindex, Line 112 ]]
        error(("Attempt to set Connection::%s (not a valid member)"):format((tostring(p11))), 3);
    end
});
local u12 = {};
u12.__index = u12;
