-- Decompiled from: ReplicatedStorage.Modules.Icon.Elements.Widget
-- Class: ModuleScript
...
return function(u1, u2) --[[ Line: 6 ]]
    ...
    u1:setBehaviour("IconImage", "Image", function(p56) --[[ Line: 372 ]]
    ...
    u1.alignmentChanged:Connect(function(p58) --[[ Line: 379 ]]
    ...
    u61.Parent = u18;
    u61:GetPropertyChangedSignal("Value"):Connect(function() --[[ Line: 390 ]]
