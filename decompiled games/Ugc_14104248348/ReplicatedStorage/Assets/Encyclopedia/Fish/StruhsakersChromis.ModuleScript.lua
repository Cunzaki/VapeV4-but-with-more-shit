-- Decompiled from: ReplicatedStorage.Assets.Encyclopedia.Fish.StruhsakersChromis
-- Class: ModuleScript
...
return {
    ...
    Model = game:GetService("ReplicatedStorage").Assets.FishModels.StruhsakersChromis,
    Icon = {
