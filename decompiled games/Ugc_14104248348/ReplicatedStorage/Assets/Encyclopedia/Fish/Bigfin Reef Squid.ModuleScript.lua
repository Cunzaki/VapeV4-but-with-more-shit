-- Decompiled from: ReplicatedStorage.Assets.Encyclopedia.Fish.Bigfin Reef Squid
-- Class: ModuleScript
...
return {
    ...
    Model = game:GetService("ReplicatedStorage").Assets.FishModels["Bigfin Reef Squid"],
    Icon = {
