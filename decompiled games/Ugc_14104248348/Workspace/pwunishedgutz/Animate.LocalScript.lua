-- Decompiled from: Workspace.pwunishedgutz.Animate
-- Class: LocalScript
...
function onRunning(p108)
    -- upvalues: u57 (ref), l__Humanoid__2 (copy), u58 (ref), u66 (ref), u1 (ref), u14 (copy), u4 (ref)
    local v109 = getHeightScale();
    if u57 ~= nil and l__Humanoid__2.EvaluateStateMachine == false then
        local l__RootPart__5 = l__Humanoid__2.RootPart;
        local l__SensedPart__6 = u57.SensedPart;
        if l__SensedPart__6 then
            local v110 = l__SensedPart__6:GetVelocityAtPosition(u57.HitFrame.Position);
            ...
            local l__Magnitude__9 = u58.MovingDirection.Magnitude;
