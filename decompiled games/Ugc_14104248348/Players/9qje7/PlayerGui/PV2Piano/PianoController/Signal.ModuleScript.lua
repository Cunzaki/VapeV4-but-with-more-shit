-- Decompiled from: Players.9qje7.PlayerGui.PV2Piano.PianoController.Signal
-- Class: ModuleScript
...
function u6.Disconnect(p9) --[[ Line: 85 ]]
...
function u12.Connect(p19, p20) --[[ Line: 206 ]]
    -- upvalues: u6 (copy)
...
function u12.ConnectOnce(p22, u23) --[[ Line: 233 ]]
    local u24 = nil;
    local u25 = false;
    u24 = p22:Connect(function(...) --[[ Line: 236 ]]
...
function u12.GetConnections(p26) --[[ Line: 246 ]]
...
function u12.DisconnectAll(p28) --[[ Line: 265 ]]
...
function u12.Fire(p29, ...) --[[ Line: 290 ]]
...
function u12.FireDeferred(p30, ...) --[[ Line: 312 ]]
...
function u12.Wait(p31) --[[ Line: 336 ]]
    local u32 = coroutine.running();
    local u33 = nil;
    local u34 = false;
    u33 = p31:Connect(function(...) --[[ Line: 340 ]]
...
function u12.Destroy(p35) --[[ Line: 362 ]]
    p35:DisconnectAll();
...
setmetatable(u12, {
    __index = function(_, p37) --[[ Name: __index, Line 373 ]]
        error(("Attempt to get Signal::%s (not a valid member)"):format((tostring(p37))), 2);
    end,
    __newindex = function(_, p38, _) --[[ Name: __newindex, Line 376 ]]
        error(("Attempt to set Signal::%s (not a valid member)"):format((tostring(p38))), 2);
    end
});
return u12;
