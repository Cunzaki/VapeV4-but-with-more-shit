-- Decompiled from: ReplicatedStorage.Assets.ModuleScripts.chrono.Server.Receiver
-- Class: ModuleScript
...
local function u26(p13, p14) --[[ Line: 45 ]]
...
local function u36(p27, p28) --[[ Line: 61 ]]
...
local function u45(p37, p38) --[[ Line: 84 ]]
...
local function u56(p46, p47, p48, p49, p50, p51, p52) --[[ Line: 124 ]]
...
local u57 = {};
local function v75(p58, p59) --[[ Line: 167 ]]
...
function v1.RegisterMiddleMan(p76, p77, p78) --[[ Line: 218 ]]
    ...
    table.sort(u3, function(p80, p81) --[[ Line: 233 ]]
        return p80.priority > p81.priority;
    end);
end;
function v1.UnregisterMiddleMan(p82) --[[ Line: 242 ]]
    -- upvalues: u2 (copy), u3 (ref)
    u2[p82] = nil;
    u3 = {};
    for _, v83 in u2 do
    ...
    table.sort(u3, function(p84, p85) --[[ Line: 248 ]]
        return p84.priority > p85.priority;
    end);
end;
function v1.ShouldBlockEntityCFrame(p86, p87, p88, p89) --[[ Line: 253 ]]
    -- upvalues: u12 (copy)
    return u12(p86, p87, p88, p89);
end;
if l__RunService__2:IsServer() then
    local u90 = 0;
    l__RunService__2.Heartbeat:Connect(function(_) --[[ Line: 259 ]]
    ...
    l__Players__1.PlayerRemoving:Connect(function(p91) --[[ Line: 269 ]]
        -- upvalues: u6 (copy)
        u6[p91] = nil;
    end);
end;
l__Config__8._WaitForLock(function() --[[ Line: 274 ]]
    -- upvalues: u4 (ref), l__Config__8 (copy)
    u4 = l__Config__8._GetConfig("MAX_TOTAL_BYTES_PER_FRAME_PER_PLAYER");
end);
function v1.GetCameraLookVector(p92) --[[ Line: 278 ]]
