...
function u1.saveChanges(p5) --[[ Line: 42 ]]
    ...
    if p5.config and not p5.saved then
        p5.saved = true;
        l__Classes__6._xe5b4354b6db0787c:_x7d4c56fe29c74cc4();
        l__Classes__6._xe5b4354b6db0787c:_x47a618573b7677b3();
    end;
end;
...
function u1.Init(u9) --[[ Line: 94 ]]
    ...
    local v10 = l__Classes__6._xe5b4354b6db0787c:_xcce25b09da694450();
    if v10 then
        u9.config = v10;
        ...
        local function v16(u11) --[[ Line: 108 ]]
            ...
            local function u15(p13) --[[ Line: 124 ]]
                ...
                if not p13 then
                    l__Classes__6._x02c5f8f89640473a:_xa2c2f0587694a915("TAPE_MOVE", true);
                end;
            end;
        ...
        local function v34(u24) --[[ Line: 185 ]]
            ...
            local u26 = l__Classes__6._xd2c44c643b0c3fb4:_x9116adad2412e188(Enum.KeyCode[u24.value]);
        ...
        v16({
            ...
            onInteract = function(p46) --[[ Name: onInteract, Line 350 ]]
                ...
                l__Classes__6._x7c4d08c7bcf3460a:_x218da71a19068c73(p46);
        ...
        v16({
            ...
            onInteract = function(p52) --[[ Name: onInteract, Line 411 ]]
                -- upvalues: l__Classes__6 (ref), u9 (copy)
                l__Classes__6._x9b074161e70581e8._xf0f93a3799b30928 = p52;
            ...
            if u56 == "empty" then
                ...
                v34({
                    ...
                    parseKeycode = function(p58) --[[ Name: parseKeycode, Line 460 ]]
                        ...
                        local v59 = l__Classes__6._xd2c44c643b0c3fb4:_x36756bf5010a6fda(p58);
                        if l__Classes__6._xd2c44c643b0c3fb4:_xb0c25e51d5052cdf(u56:upper(), v59) then
                            l__keybinds__23[u56] = v59.Name;
                            return l__Classes__6._xd2c44c643b0c3fb4:_x9116adad2412e188(v59);
                        end;
        ...
        local function v73(u60, u61) --[[ Line: 478 ]]
            ...
            local function u68(p64) --[[ Line: 482 ]]
                ...
                if not p64 then
                    l__Classes__6._x02c5f8f89640473a:_xa2c2f0587694a915("TAPE_SELECT", true);
                end;
                local v65 = 0;
