...
local u24 = {
    start_down = {
        begin = function(p6) --[[ Name: begin, Line 78 ]]
            ...
            l__Classes__13._x7c4d08c7bcf3460a:_x71befac223e31779();
        end,
    ...
    extract = {
        begin = function(p14) --[[ Name: begin, Line 100 ]]
            ...
            l__Classes__13._x9b074161e70581e8._xb4a858d5a5bba54c = 0;
            local v17 = l__Classes__13._x02c5f8f89640473a:_xa2c2f0587694a915("BUILD_UP");
            ...
            u15:_scheduleExtractIntro(l__extract_intro_run_id__15, v18 - 1.15, function() --[[ Line: 136 ]]
                ...
                u15.extract_intro_windup_sound = l__Classes__13._x02c5f8f89640473a:_xa2c2f0587694a915("EXTRACT_WINDUP", true);
            end);
            if u16 == "Classified" then
                u15:_scheduleExtractIntro(l__extract_intro_run_id__15, v18 - 0.69, function() --[[ Line: 141 ]]
                    ...
                    l__Classes__13._x02c5f8f89640473a:_xa2c2f0587694a915("DNB_BUILDUP", true);
                end);
            end;
            u15:_scheduleExtractIntro(l__extract_intro_run_id__15, v18, function() --[[ Line: 146 ]]
                ...
                if u16 == "Exotic" then
                    l__Classes__13._x02c5f8f89640473a:_xa2c2f0587694a915("GLIMMER2", true);
                    l__Classes__13._x02c5f8f89640473a:_xa2c2f0587694a915("IMPACT_MORE", true);
                elseif u16 == "Elite" then
                    l__Classes__13._x02c5f8f89640473a:_xa2c2f0587694a915("IMPACT_MORE", true);
                else
                    l__Classes__13._x02c5f8f89640473a:_xa2c2f0587694a915("IMPACT", true);
                end;
                l__Classes__13._x02c5f8f89640473a:_xa2c2f0587694a915("TELEPORT_DRAMATIC", true);
                if u16 then
                ...
                l__Classes__13._x7c4d08c7bcf3460a:_xa7529a62c76c8db0(0.5, 3);
                ...
                v22:Play();
                l__Classes__13._x9b074161e70581e8._xb4a858d5a5bba54c = 0.8;
                ...
                if u16 == "Classified" then
                    l__Classes__13._x02c5f8f89640473a:_xa2c2f0587694a915("VICTORY", true);
                    l__Classes__13._x02c5f8f89640473a:_xa2c2f0587694a915("RESULT", true);
                end;
...
function u1._applyEquippedSkin(p234, p235, p236) --[[ Line: 1266 ]]
    ...
    l__Classes__13._x02c5f8f89640473a:_xa2c2f0587694a915("BULLET_GAINED", true);
    l__Classes__13._x02c5f8f89640473a:_xa2c2f0587694a915("TAPE_MOVE", true);
    p234:_updateActions();
end;
            ...
            if v239 == "skin" then
                ...
                if typeof(l__item_id__54) == "string" and typeof(l__skin_id__55) == "number" then
                    if l__selected_slot__52.equipped == true then
                        ...
                        l__Packets__8._x44ecb119ed705f12:Fire(l__item_id__54, l__skin_id__55);
...
function u1._onRevealSlotTick(_, _, _) --[[ Line: 1701 ]]
    ...
    l__Classes__13._x02c5f8f89640473a:_xa2c2f0587694a915("SLOT_TICK", true);
end;
...
function u1._updateScene(p476, p477) --[[ Line: 2322 ]]
    ...
    if l__CurrentCamera__95 then
        if l__Classes__13._x2b1f81c73714b323 then
            l__Classes__13._x2b1f81c73714b323._x7324f78af14e3910 = true;
        end;
...
function u1._startCameraOverride(u484) --[[ Line: 2371 ]]
    ...
    if l__CurrentCamera__96 then
        local l___x20ced43136f3a8e4__97 = l__Classes__13._x20ced43136f3a8e4;
        local v485;
        if l___x20ced43136f3a8e4__97 then
            v485 = l___x20ced43136f3a8e4__97._x8da08b8171b99263 or nil;
        else
            v485 = nil;
        end;
        local v486 = false;
        if l___x20ced43136f3a8e4__97 and l___x20ced43136f3a8e4__97._xe784425b7783ee5a then
            v486 = l___x20ced43136f3a8e4__97:_xe784425b7783ee5a();
        elseif l___x20ced43136f3a8e4__97 and (l___x20ced43136f3a8e4__97._xe9a51df2beb9bdef == true and l__Classes__13.Util) then
            l__Classes__13.Util:unbindFromRenderStep("SpectatorCam");
            l___x20ced43136f3a8e4__97._x9fb2eddc44d0cd7b = nil;
            l___x20ced43136f3a8e4__97._xe9a51df2beb9bdef = false;
            v486 = true;
        end;
        u484.previous_camera_state = {
            ...
            camera_paused = l__Classes__13._x2b1f81c73714b323 and l__Classes__13._x2b1f81c73714b323._x7324f78af14e3910 or false,
        ...
        u484.scene_trove:Add(function() --[[ Line: 2418 ]]
            ...
            if l__CurrentCamera__98 and l__previous_camera_state__99 then
                ...
                u484.sway_goal = 0;
                u484.sway_z_goal = 0;
                if l__previous_camera_state__99.spectator_was_running and l__Classes__13._x20ced43136f3a8e4 then
                    if l__Classes__13._x20ced43136f3a8e4._x2d22ad2b428d420d then
                        l__Classes__13._x20ced43136f3a8e4:_x2d22ad2b428d420d(l__previous_camera_state__99.spectator_target);
                    else
                        l__Classes__13._x20ced43136f3a8e4:_xcc5f292712de0f3a(false, l__previous_camera_state__99.spectator_target);
                    end;
                else
                    if l__Classes__13._x2b1f81c73714b323 then
                        l__Classes__13._x2b1f81c73714b323._x7324f78af14e3910 = l__previous_camera_state__99.camera_paused;
                    end;
...
function u1.close(u499) --[[ Line: 2554 ]]
    ...
    l__Classes__13._x7c4d08c7bcf3460a:_x8bc5dfa5bfb0e7d8();
