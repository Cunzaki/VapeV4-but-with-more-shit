...
function u1._openGiftBrowser(u23, u24) --[[ Line: 123 ]]
    ...
    if u23._gift_browser_open or u23._gift_requesting then
        ...
        local l___xb90403a8caac4128__12 = l__Classes__9._xb90403a8caac4128;
        if l___xb90403a8caac4128__12 and typeof(l___xb90403a8caac4128__12._x003a1e06c5ce82d3) == "function" then
            u23._gift_browser_open = true;
            local v27 = l___xb90403a8caac4128__12:_x003a1e06c5ce82d3("PlayerBrowser", {
                ignore_self = true,
                max_select = 1,
                ...
                selected_callback = function(p25) --[[ Name: selected_callback, Line 139 ]]
                    ...
                    if typeof(p25) == "number" then
                        ...
                        l__Packets__6._xb107e17a2a93fbac:Fire({
                            op = "gift_dev_product",
                        ...
                        if l__tab_asset__14 and (not l__tab_asset__14 or l__tab_asset__14:FindFirstChild("DealsList")) then
                            ...
                            if v50 then
                                u33.trove:Connect(u44.Button.Activated, function() --[[ Line: 306 ]]
                                    ...
                                    l__Packets__6._xb107e17a2a93fbac:Fire(u43.product_id);
                                end);
...
function u1.start(u57) --[[ Line: 340 ]]
    ...
    u57.trove:Connect(l__Packets__6._x56d68a6b15750fcf.OnClientEvent, function(p58) --[[ Line: 341 ]]
        -- upvalues: u57 (copy)
