...
function u1.Init(u35) --[[ Line: 238 ]]
    ...
    local v36 = l__Packets__3._xa1b346ef877bc52a:Fire();
    u35.my_data = v36;
    ...
    if l__dropdown_component__24 then
        ...
        l__dropdown_component__24.onOpenList:Connect(function() --[[ Line: 252 ]]
            ...
            l__Classes__10._x02c5f8f89640473a:_xa2c2f0587694a915("TAPE_SELECT", true);
        end);
        l__dropdown_component__24.onSelectionFinished:Connect(function(p37) --[[ Line: 256 ]]
            ...
            if u35.customizable then
                ...
                if l__meta__25 then
                    l__Packets__3._x37821f9f8b2dd72c:Fire(l__meta__25);
                    l__Classes__10._x02c5f8f89640473a:_xa2c2f0587694a915("TAPE_MOVE", true);
