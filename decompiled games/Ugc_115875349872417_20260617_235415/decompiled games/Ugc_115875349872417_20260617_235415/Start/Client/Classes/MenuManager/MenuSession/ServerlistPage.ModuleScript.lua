...
function u1.cycleRegionFilter(p27) --[[ Line: 218 ]]
    ...
    l__Classes__8._x02c5f8f89640473a:_xa2c2f0587694a915("CASETTE_PLAY", true);
...
function u1.sendSnapshotRequest(p37, p38, p39) --[[ Line: 276 ]]
    ...
    if p38 then
        ...
        if p39 or (not v41 or v40 - v41 >= 5) then
            ...
            l__Packets__3._x7a2ae673a30543e6:Fire({
                op = "get_snapshot",
                server_type = p38
            });
        end;
...
function u1.requestLoadMore(u49) --[[ Line: 319 ]]
    ...
    if u49.load_more_db then
        ...
        l__Classes__8._x02c5f8f89640473a:_xa2c2f0587694a915("CASETTE_PLAY", true);
        l__Packets__3._x7a2ae673a30543e6:Fire(v50);
    end;
end;
        ...
        local function u64(p53, p54) --[[ Line: 353 ]]
            ...
            if u51.render_id == l__render_id__17 then
                ...
                local u62 = u55.Button.Activated:Connect(function() --[[ Line: 379 ]]
                    ...
                    l__Classes__8._x02c5f8f89640473a:_xa2c2f0587694a915("UI_CLICK", true);
                    if u61 then
                        u61 = false;
...
function u1.tryJoinServer(_, p73) --[[ Line: 481 ]]
    ...
    if type(p73) == "table" then
        ...
        if type(v74) == "number" then
            ...
            l__Classes__8._x02c5f8f89640473a:_xa2c2f0587694a915("TAPE_MOVE", true);
            l__Packets__3._x0e45f811eb4ba377:Fire(v75);
        end;
    end;
end;
function u1.Init(u76) --[[ Line: 501 ]]
    ...
    u76.trove:Add(l__Packets__3._x7a2ae673a30543e6.OnClientEvent:Connect(function(p77) --[[ Line: 505 ]]
        -- upvalues: u76 (copy)
