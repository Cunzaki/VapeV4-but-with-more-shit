    ...
    if u5 then
        ...
        task.spawn(function() --[[ Line: 85 ]]
            ...
            local v7, v8 = pcall(function() --[[ Line: 86 ]]
                ...
                return l__Packets__6._x2cc339cff5a4e1eb:Fire();
            end);
            if v7 then
                local v9;
...
function u1.new(p11, p12) --[[ Line: 125 ]]
    ...
    l__Packets__6._x16343f5702c10d0e:Fire();
    u13.onItemProfileUpdated = u13.trove:Construct(l__Signal__7);
    u13.trove:Connect(l__Packets__6._x16343f5702c10d0e.OnClientEvent, function(p15) --[[ Line: 141 ]]
        -- upvalues: u13 (copy)
    ...
    local v16 = {
        ...
        RETURN = {
            ...
            onPressed = function() --[[ Name: onPressed, Line 270 ]]
                ...
                l__Packets__6._x0e45f811eb4ba377:Fire({
...
function u1.requestDeploy(p53) --[[ Line: 452 ]]
    ...
    if p53.pagelocked then
        ...
        if v54 < p53.next_deploy_request_at then
            ...
            l__Packets__6._x3d8fafaf89950026:Fire();
        end;
    end;
end;
function u1.initializeInput(u55) --[[ Line: 466 ]]
    ...
    u55.os_ui.HideButton.Activated:Connect(function() --[[ Line: 490 ]]
        ...
        l__Classes__13._x02c5f8f89640473a:_xa2c2f0587694a915("BACK2", true);
        if #u58 == 0 then
...
function u1.initializeVisuals(u61) --[[ Line: 510 ]]
    ...
    local u62 = l__Classes__13._x596eb619070480ba:_x99c2a19f9a3f5eff("yen");
    if u62 then
    ...
    local u63 = l__Classes__13._x596eb619070480ba:_x99c2a19f9a3f5eff("crimson");
    if u63 then
...
function u1.openPage(u74, u75, ...) --[[ Line: 629 ]]
    ...
    if u74.current_page ~= u75 then
        ...
        l__Classes__13._x02c5f8f89640473a:_xa2c2f0587694a915("BACK1", true);
    end;
...
function u1.start(u96, p97) --[[ Line: 745 ]]
    ...
    if l__Classes__13._xce372113b7898ad8 then
        l__Classes__13._xce372113b7898ad8:_xbcd7ec9c81360ce4(u96.os_ui.RightContainer.MainOS.NotificationList, true);
    end;
    if l__Classes__13._x3103fdab012bc1c0 then
        l__Classes__13._x3103fdab012bc1c0:_x26bc3c27878259a9();
    end;
