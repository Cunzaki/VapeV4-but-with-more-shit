    ...
    u42.entries_trove:Connect(p44.Button.Activated, function() --[[ Line: 216 ]]
        ...
        if v45 then
            if v45.claimable then
                l__Classes__7._x141821b549bd7368:_x6de0a7ea54f1aab2(u43);
                ...
                if v46 then
                    ...
                    l__Classes__7._x02c5f8f89640473a:_xa2c2f0587694a915("GOAL_COMPLETE", true);
...
function u1.Init(u69) --[[ Line: 328 ]]
    ...
    local v70 = l__Classes__7._x141821b549bd7368:_xffd26d723e9f3596();
    local v71 = 0;
    for _ in pairs(v70) do
        v71 = v71 + 1;
    end;
    if v71 == 0 then
        l__Classes__7._x141821b549bd7368._x0d308f41c09b6193:Once(function(p72) --[[ Line: 332 ]]
            -- upvalues: u69 (copy)
            u69:refreshEntries(p72);
        end);
    else
        u69:refreshEntries(l__Classes__7._x141821b549bd7368:_xffd26d723e9f3596());
    end;
    u69.trove:Connect(l__Classes__7._x141821b549bd7368._x0d308f41c09b6193, function(p73) --[[ Line: 337 ]]
        -- upvalues: u69 (copy)
        u69:refreshEntries(p73);
    end);
    u69.trove:Connect(l__Classes__7._x141821b549bd7368._xc1ca12312cfb4a3d, function(p74, p75) --[[ Line: 341 ]]
        -- upvalues: u69 (copy)
        u69:_upsertContractEntry(p74, p75);
        u69:refreshAlert();
        u69:_updateRefreshTimers();
    end);
    u69.trove:Connect(l__Classes__7._x141821b549bd7368._x71994bb8e679c928, function(p76) --[[ Line: 347 ]]
        -- upvalues: u69 (copy)
