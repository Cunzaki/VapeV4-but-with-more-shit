...
function u1._bindPackets(u24) --[[ Line: 123 ]]
    ...
    u24._trove:Connect(l__Packets__2._x2925dacc9725d2ce.OnClientEvent, function(p25) --[[ Line: 124 ]]
        -- upvalues: u24 (copy)
        u24:_handleQueueOp(p25);
    end);
    u24._trove:Connect(l__Packets__2._x88051fb7128eb54b.OnClientEvent, function(p26) --[[ Line: 128 ]]
        -- upvalues: u24 (copy)
...
function u1.enqueue(_, p73) --[[ Line: 410 ]]
    ...
    if #v74 == 0 then
        ...
        l__Packets__2._x2925dacc9725d2ce:Fire({
            op = "enqueue",
            queue_ids = v74
        });
    end;
...
function u1.partyIntent(_, p76) --[[ Line: 435 ]]
    ...
    if typeof(p76) == "number" then
        l__Packets__2._x88051fb7128eb54b:Fire({
            op = "party_intent",
            target_id = p76
        });
    end;
