...
function u1._showInvitePrompt(u14, p15) --[[ Line: 153 ]]
    ...
    local v16 = l__Classes__7._xce372113b7898ad8:_x80404b1f52c3b823({
        lifetime = 20,
        play_sound = true,
...
function u1._onQueueStart(p44) --[[ Line: 309 ]]
    ...
    l__Classes__7._x02c5f8f89640473a:_xa2c2f0587694a915("BEEP2", true);
...
function u1._onQueueEnd(p45) --[[ Line: 331 ]]
    ...
    l__Classes__7._x02c5f8f89640473a:_xa2c2f0587694a915("BEEP1", true);
...
function u1._initState(u88) --[[ Line: 621 ]]
    ...
    u88._trove:Connect(l__PartyContainer__35.AddIcon.Button.Activated, function() --[[ Line: 648 ]]
        ...
        l__Classes__7._xb90403a8caac4128:_x003a1e06c5ce82d3("PlayerBrowser", {
