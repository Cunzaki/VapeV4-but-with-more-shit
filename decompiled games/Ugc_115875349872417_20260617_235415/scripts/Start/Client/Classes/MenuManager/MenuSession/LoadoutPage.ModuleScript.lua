...
function u1.openSection(p76, p77, p78) --[[ Line: 410 ]]
    ...
    if p78 == true then
        l__Classes__9._x02c5f8f89640473a:_xa2c2f0587694a915("BACK1", true);
    end;
...
function u1.selectEntry(u84, p85, p86) --[[ Line: 445 ]]
    ...
    if p85 then
        if p86 == true then
            l__Classes__9._x02c5f8f89640473a:_xa2c2f0587694a915("UI_CLICK", true);
        end;
    ...
    if p95 and p95.owned then
        if u3[p95.item_type] then
            ...
            if v96 and v96.equipped_loadout then
                l__Classes__9._x02c5f8f89640473a:_xa2c2f0587694a915("TAPE_MOVE", true);
                l__Classes__9._x02c5f8f89640473a:_xa2c2f0587694a915("BULLET_GAINED", true);
                v96.equipped_loadout[p95.item_type] = p95.item_id;
                l__Packets__5._x7f93448307b05ecf:Fire({
...
function u1.tryPurchaseItem(u97, u98) --[[ Line: 560 ]]
    ...
    if v99 then
        if v99.purchasable then
            ...
            l__Classes__9._xb90403a8caac4128:_x003a1e06c5ce82d3("Modal", {
                ...
                actions = {
                    {
                        ...
                        action_callback = function() --[[ Name: action_callback, Line 611 ]]
                            ...
                            if u101 < (u104 and u103 or u107) then
                                ...
                                l__Packets__5._xb091fe04e773fa7b:Fire({
                                    op = "buy",
            ...
            actions = {
                {
                    ...
                    action_callback = function() --[[ Name: action_callback, Line 663 ]]
                        ...
                        l__Packets__5._xb5bc17d25fad4165:Fire({
...
function u1.Init(u126) --[[ Line: 782 ]]
    ...
    u126.yen_inst = l__Classes__9._x596eb619070480ba:_x99c2a19f9a3f5eff("yen");
    u126.crimson_inst = l__Classes__9._x596eb619070480ba:_x99c2a19f9a3f5eff("crimson");
    u126:_buildItems();
