...
function u1.new(p24, p25) --[[ Line: 104 ]]
    -- upvalues: u1 (copy), l__InternalSymbols__8 (copy), l__Trove__4 (copy), l__UIAssets__6 (copy)
    local v26 = setmetatable({}, u1);
    v26.menu_session = l__InternalSymbols__8.owner("MenuSession", p25);
    v26.parent_os = p24;
    ...
    u42.entries_trove:Connect(p44.Button.Activated, function() --[[ Line: 216 ]]
        ...
        if v45 then
            if v45.claimable then
                l__Classes__7._x8c96abfd9981a439:_xedd262c03ff71135(u43);
                ...
                if v46 then
                    ...
                    l__Classes__7._xbe184fb1376a575d:_x7ab8b42cc5920a78("GOAL_COMPLETE", true);
...
function u1.Init(u69) --[[ Line: 328 ]]
    ...
    local v70 = l__Classes__7._x8c96abfd9981a439:_xa9dd9c8e498c5e89();
    local v71 = 0;
    for _ in pairs(v70) do
        v71 = v71 + 1;
    end;
    if v71 == 0 then
        l__Classes__7._x8c96abfd9981a439._xf88440d3e07bfe35:Once(function(p72) --[[ Line: 332 ]]
            -- upvalues: u69 (copy)
            u69:refreshEntries(p72);
        end;
    else
        u69:refreshEntries(l__Classes__7._x8c96abfd9981a439:_xa9dd9c8e498c5e89());
    end;
    u69.trove:Connect(l__Classes__7._x8c96abfd9981a439._xf88440d3e07bfe35, function(p73) --[[ Line: 337 ]]
        -- upvalues: u69 (copy)
        u69:refreshEntries(p73);
    end;
    u69.trove:Connect(l__Classes__7._x8c96abfd9981a439._x42e15310c9d8b835, function(p74, p75) --[[ Line: 341 ]]
        -- upvalues: u69 (copy)
        u69:_upsertContractEntry(p74, p75);
        u69:refreshAlert();
        u69:_updateRefreshTimers();
    end;
    u69.trove:Connect(l__Classes__7._x8c96abfd9981a439._xfd274174b9df963f, function(p76) --[[ Line: 347 ]]
        -- upvalues: u69 (copy)
