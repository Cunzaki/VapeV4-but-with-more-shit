...
function u1._openBannerGiftBrowser(u166, u167) --[[ Line: 781 ]]
    ...
    elseif typeof(u167) == "table" and typeof(u167.product_id) == "number" then
        local l___xd00ac57201023755__32 = l__Classes__13._xd00ac57201023755;
        if l___xd00ac57201023755__32 and typeof(l___xd00ac57201023755__32._x4782af5368e4c758) == "function" then
            u166._gift_browser_open = true;
            u166:_queuePurchaseOptionsRefresh();
            local v170 = l___xd00ac57201023755__32:_x4782af5368e4c758("PlayerBrowser", {
                ignore_self = true,
                max_select = 1,
                ...
                selected_callback = function(p168) --[[ Name: selected_callback, Line 802 ]]
                    ...
                    if typeof(p168) == "number" then
                        ...
                        u166:_queuePurchaseOptionsRefresh();
                        l__Packets__8._x4a9e94f14df7f3b8:Fire({
                            op = "gift_dev_product",
...
function u1._notifyPullError(_, p303) --[[ Line: 1379 ]]
    ...
    if p303 == "insufficient_eligible_crimson" then
        l__Classes__13._xd0d75b75975ea69f:_x00e1d9aa2084cbf1({
            play_sound = true,
            main_text = u3[p303]
        });
    end;
...
function u1._startShowcaseBannerPull(u348, p349, u350, u351) --[[ Line: 1522 ]]
    ...
    l__Classes__13._xbe184fb1376a575d:_x7ab8b42cc5920a78("EXTRACT_SOUND", true);
    ...
    task.spawn(function() --[[ Line: 1536 ]]
        ...
        local v355, v356 = pcall(function() --[[ Line: 1537 ]]
            ...
            return l__Packets__8._xd5755b1b02f60b99:Fire(u354, u350.id, u351);
        end;
...
function u1.activateBannerPurchaseOption(p369, p370, p371) --[[ Line: 1625 ]]
    ...
    if typeof(p371) == "table" then
        if p371.kind == "robux" then
            ...
            l__Packets__8._x4a9e94f14df7f3b8:Fire(p371.product_id);
            return true;
    ...
    if u374 and not u372.pull_in_flight then
        ...
        task.spawn(function() --[[ Line: 1689 ]]
            ...
            local v376, v377 = pcall(function() --[[ Line: 1690 ]]
                ...
                return l__Packets__8._xd5755b1b02f60b99:Fire(u375, u374.id, u373);
            end;
...
function u1._bind(u432) --[[ Line: 1933 ]]
    ...
    u432.yen_inst = l__Classes__13._x7430d6d194f43373:_x57c044514acd3a73("yen");
    u432.crimson_inst = l__Classes__13._x7430d6d194f43373:_x57c044514acd3a73("crimson");
    ...
    u432.trove:Connect(l__Packets__8._xfaa2c2e4ef7509b5.OnClientEvent, function(p436) --[[ Line: 1977 ]]
        -- upvalues: u432 (copy)
    ...
    u432.trove:Connect(l__Packets__8._x51cb2066c94db9ba.OnClientEvent, function(p438) --[[ Line: 2018 ]]
        -- upvalues: u432 (copy)
