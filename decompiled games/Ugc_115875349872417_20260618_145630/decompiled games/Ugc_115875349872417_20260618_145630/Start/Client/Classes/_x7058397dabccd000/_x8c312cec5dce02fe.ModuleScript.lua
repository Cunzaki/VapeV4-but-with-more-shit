        ...
        for v1110 = 53, 283, 46 do
            if v1110 > 145 then
                if v1110 <= 191 then
                    ...
                    if v1111 ~= 7738 then
                        if v1111 == -2 then
                            return -2, v1108, v1109, p1103, v1112;
                        end;
                    end;
                ...
                local v1113;
                v1113, v1108, p1103, v1109, v1107 = p1096:bI(v1108, p1103, p1098, v1107, p1106, p1101, p1097, v1109, v1110, p1100);
                local _ = v1113 == 43886;
            end;
        end;
        return nil, v1108, v1109, p1103;
    end,
