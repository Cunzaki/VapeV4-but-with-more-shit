                                    ...
                                    if v1378 < 86 then
                                        if v1378 < 83 then
                                            ...
                                            elseif v1378 == 82 then
                                                v1367 = u107[v1362];
                                                v1360[v1367] = v1360[v1367](u96[24](v1367 + u110[v1362] - 1, v1367 + 1, v1360));
                                                v1365 = v1367;
                                            else
    ...
    UK = function(p2646, p2647, p2648, p2649, p2650, p2651, p2652, p2653, p2654, p2655, p2656) --[[ Name: UK, Line 3 ]]
        for v2657 = 1, p2653 do
            ...
            for v2668 = 59, 396, 56 do
                local v2669;
                v2669, v2665, v2661, v2666, v2667 = p2646:mk(v2667, v2663, v2660, p2652, v2661, p2655, v2657, v2659, p2651, p2650, v2665, v2666, v2658, v2662, v2668);
                if v2669 == 38144 then
                    break;
                end;
                local _ = v2669 == 47333;
            ...
            for v2670 = 3, 111, 49 do
                ...
                local v2675, v2676 = p2646:ak(p2651, p2649, v2658, p2650, v2661, v2666, p2648, p2647, v2664, v2657, p2654, v2667, v2665);
                if v2675 ~= 50977 then
                    if v2675 == -2 then
                        return -2, v2676;
                    end;
