-- Decompiled from: Start.Client.Classes._xc2aea7afbdbc2790
-- Class: ModuleScript
...
function u1._x90d4581ac99dd483() --[[ Line: 26 ]]
    ...
    v3._x48c8872cb7f2d88b = {};
    v3._x43da26d126b3e6a1 = {};
    return v3;
end;
function u1._xa062e75791e7ac86(p4, p5, p6) --[[ Line: 36 ]]
    local v7 = p4._x48c8872cb7f2d88b[p5];
    if v7 then
        local v8 = v7[p6];
        if v8 then
            return v8;
...
function u1._x67f3623e7542e88b(u9, p10) --[[ Line: 54 ]]
    ...
    local v13 = u9._x48c8872cb7f2d88b[v11];
    local v14 = u9._x48c8872cb7f2d88b[v12];
    local function v19(p15, p16, ...) --[[ Line: 66 ]]
        -- upvalues: u9 (copy)
        if p15 then
            local v17 = p15[p16];
            if v17 then
                v17:Fire(...);
                local v18 = u9._x43da26d126b3e6a1[p16];
                if v18 then
                    v18:Fire(...);
                end;
            else
...
function u1._xe53615d96cf36a6b(u20) --[[ Line: 93 ]]
    -- upvalues: l__Packets__2 (copy), l__Signal__3 (copy), u2 (copy), l__LocalPlayer__4 (copy)
    l__Packets__2.unreliablePackets._xeaae65f9581e0520.OnClientEvent:Connect(function(...) --[[ Line: 94 ]]
        -- upvalues: u20 (copy)
        u20:_x67f3623e7542e88b(...);
    end;
    for _, v21 in { "onKill" } do
        local v22 = l__Signal__3.new();
        u20._x43da26d126b3e6a1[v21] = v22;
    end;
    local function u26(p23) --[[ Line: 105 ]]
        -- upvalues: u2 (ref), l__Signal__3 (ref), u20 (copy)
        local v24 = {};
        for _, v25 in u2 do
            v24[v25] = l__Signal__3.new();
        end;
        u20._x48c8872cb7f2d88b[p23] = v24;
    end;
    ...
    game:GetService("Players").PlayerAdded:Connect(function(p28) --[[ Line: 121 ]]
        -- upvalues: u26 (copy)
        u26(p28);
    end;
    game:GetService("Players").PlayerRemoving:Connect(function(p29) --[[ Line: 125 ]]
        -- upvalues: u20 (copy)
        local v30 = u20._x48c8872cb7f2d88b[p29];
        if v30 then
            for _, v31 in pairs(v30) do
                v31:DisconnectAll();
            end;
        end;
        u20._x48c8872cb7f2d88b[p29] = nil;
    end;
end;
return u1;
