-- Decompiled from: ReplicatedStorage.Assets.ModuleScripts.SkinDefs
-- Class: ModuleScript
    ...
    defs = {
        Redliner = {
            ...
            [l__CEnum__16.Skins.Inheritor] = {
                ...
                skinInitializer = function(p44) --[[ Name: skinInitializer, Line 462 ]]
            ...
            [l__CEnum__16.Skins.Morningstar] = {
                hidden = true,
                rarity = "Exclusive",
                name = "Horizon",
                item_id = "Redliner",
                creator = "Reverity",
                model = "Morningstar1P",
                rig_3p = "Morningstar3P",
                skin_id = l__CEnum__16.Skins.Morningstar
            },
...
local function u52(p48) --[[ Line: 667 ]]
    -- upvalues: u52 (copy)
...
local function u58(p53, p54, p55) --[[ Line: 680 ]]
...
function u47.normalizeDefinition(p59, p60, p61) --[[ Line: 694 ]]
    -- upvalues: u58 (copy)
...
function u47.normalizeDefs() --[[ Line: 702 ]]
    -- upvalues: u47 (copy)
...
u47.normalizeDefs();
function u47.getDefs() --[[ Line: 712 ]]
    -- upvalues: u47 (copy)
    return u47.defs;
end;
function u47.findByPath(p66, p67) --[[ Line: 716 ]]
    if not p66 then
        return nil;
    end;
...
function u47.getSkinFolder(p69, p70, p71) --[[ Line: 748 ]]
...
function u47.resolveReference(p75, p76) --[[ Line: 776 ]]
    -- upvalues: u47 (copy)
...
function u47.resolveReferenceWithFallback(p77, p78, p79) --[[ Line: 788 ]]
    -- upvalues: u47 (copy)
...
function u47.resolveRig3P(p81, p82) --[[ Line: 801 ]]
...
function u47.resolveAnimations3P(p87, p88) --[[ Line: 815 ]]
    -- upvalues: u47 (copy), l__ReplicatedStorage__15 (copy)
...
function u47.getSkin(p93, p94) --[[ Line: 829 ]]
    -- upvalues: u47 (copy)
...
function u47.getDefinitionsBySkinId(p97) --[[ Line: 839 ]]
    -- upvalues: u47 (copy)
    local v98 = {};
    ...
    table.sort(v98, function(p102, p103) --[[ Line: 855 ]]
        return p102.item_id < p103.item_id;
    end;
    return v98;
end;
function u47.isValidForItem(p104, p105) --[[ Line: 862 ]]
    -- upvalues: u47 (copy)
    return u47.getSkin(p104, p105) ~= nil;
end;
function u47.getEquippedOrDefault(p106, p107) --[[ Line: 866 ]]
    -- upvalues: u47 (copy)
