-- Decompiled from: Start.Client.Classes._x32ae459de0772e82._x828224cc752f9bda
-- Class: ModuleScript
...
l__Workspace__12:GetPropertyChangedSignal("CurrentCamera"):Connect(function() --[[ Line: 26 ]]
...
local u3 = {};
u3.__index = u3;
function u3._x90d4581ac99dd483(p4, p5) --[[ Line: 50 ]]
    -- upvalues: u3 (copy)
    local v6 = setmetatable({}, u3);
    v6._xdf7ab86ee22adbf7 = p4;
    v6._xe1d0e0373613197b = p5;
    v6._x03d897fcf8b9bec4 = p5 * 0;
    return v6;
end;
function u3._x31122d29939618f8(p7, p8, p9) --[[ Line: 58 ]]
    -- upvalues: l__exp__3 (copy)
    local v10 = p7._xdf7ab86ee22adbf7 * 2 * 3.141592653589793;
    local l___xe1d0e0373613197b__17 = p7._xe1d0e0373613197b;
    local l___x03d897fcf8b9bec4__18 = p7._x03d897fcf8b9bec4;
    local v11 = p9 - l___xe1d0e0373613197b__17;
    local v12 = l__exp__3(-v10 * p8);
    local v13 = p9 + (l___x03d897fcf8b9bec4__18 * p8 - v11 * (v10 * p8 + 1)) * v12;
    local v14 = (v10 * p8 * (v11 * v10 - l___x03d897fcf8b9bec4__18) + l___x03d897fcf8b9bec4__18) * v12;
    p7._xe1d0e0373613197b = v13;
    p7._x03d897fcf8b9bec4 = v14;
    return v13;
end;
function u3._x639c700b1a769edc(p15, p16) --[[ Line: 75 ]]
    p15._xe1d0e0373613197b = p16;
    p15._x03d897fcf8b9bec4 = p16 * 0;
end;
local u17 = Vector3.new();
local u18 = Vector2.new();
local u19 = 0;
local u20 = u3._x90d4581ac99dd483(10, (Vector3.new()))._x90d4581ac99dd483(10, Vector2.new())._x90d4581ac99dd483(10, 0);
local u21 = {};
local function u23(p22) --[[ Line: 102 ]]
...
local u29 = 1;
function u21._x7c28f8e77616b915(p30) --[[ Line: 153 ]]
...
function u21._x690d8fdccd8215ff(_) --[[ Line: 173 ]]
...
function u21._x985bc42b80340821(_) --[[ Line: 183 ]]
...
function u21._x27b8162a406ef96e() --[[ Line: 245 ]]
...
local function u73(p63) --[[ Line: 260 ]]
...
local function u81(p74) --[[ Line: 290 ]]
    ...
    local v75 = u20:_x31122d29939618f8(p74, u21._x7c28f8e77616b915(p74));
    local v76 = u20:_x31122d29939618f8(p74, u21._x690d8fdccd8215ff(p74));
    local v77 = u20:_x31122d29939618f8(p74, u21._x985bc42b80340821(p74));
...
function u82._xcea699c6e98f7f2e() --[[ Line: 339 ]]
...
function u82._x174055784e3761e9() --[[ Line: 376 ]]
...
local function u93() --[[ Line: 407 ]]
    ...
    u20:_x639c700b1a769edc((Vector3.new()));
    u20:_x639c700b1a769edc(Vector2.new());
    u20:_x639c700b1a769edc(0);
    u82._xcea699c6e98f7f2e();
    l__RunService__10:BindToRenderStep("Freecam", Enum.RenderPriority.Camera.Value, u81);
    u21._x0386cce769d2b00b();
end;
local function u95() --[[ Line: 422 ]]
    -- upvalues: u21 (copy), l__RunService__10 (copy), u82 (copy), l__LocalPlayer__13 (ref)
    u21._x27b8162a406ef96e();
    l__RunService__10:UnbindFromRenderStep("Freecam");
    u82._x174055784e3761e9();
...
function v1._x3066b638ee2d6a82(_) --[[ Line: 438 ]]
    -- upvalues: u93 (copy)
    u93();
end;
function v1._x93aa151a87226b31(_) --[[ Line: 442 ]]
    -- upvalues: u95 (copy)
    u95();
end;
return v1;
