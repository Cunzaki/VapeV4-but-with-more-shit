-- Decompiled from: Start.Client.Classes._xafc4950d7b094088
-- Class: ModuleScript
...
u5.__index = u5;
local u6 = {
    GrapplerCrosshair = script.Crosshairs._xb90b415799d4f192,
    MeleeCrosshair = script.Crosshairs._x856b23c46c689503
};
local l__LocalPlayer__16 = game:GetService("Players").LocalPlayer;
local function u10(p7) --[[ Line: 60 ]]
...
local function u15(p11) --[[ Line: 83 ]]
...
local function u32(p16, p17, p18) --[[ Line: 119 ]]
...
function u5._x90d4581ac99dd483() --[[ Line: 153 ]]
    -- upvalues: u5 (copy), l__Trove__10 (copy), l__Signal__8 (copy)
    local v33 = setmetatable({}, u5);
    v33._xef1fb561476b0a5b = Instance.new("ScreenGui");
    v33._xef1fb561476b0a5b.ZIndexBehavior = Enum.ZIndexBehavior.Sibling;
    v33._xef1fb561476b0a5b.Name = "GameplayUI";
    v33._xef1fb561476b0a5b.ResetOnSpawn = false;
    v33._xef1fb561476b0a5b.DisplayOrder = 1;
    v33._xef1fb561476b0a5b.IgnoreGuiInset = true;
    v33._x8d0ed1c9aea7e692 = {};
    v33._xa0ff5cd48e83ed6e = { "CENTER", "OUTER-CENTER", "MEDIUM" };
    v33._xe47bf301ff0f8f5e = {};
    v33._xb2e12cde47dd8c35 = 0;
    v33._x624d4a774740097d = l__Trove__10.new();
    v33._x964f370fda99e2af = nil;
    v33._x9b73fdaa3921c1ae = l__Trove__10.new();
    v33._xf95a56fe36175fb9 = nil;
    v33._xe5434ea5f8966bcf = nil;
    v33._x94bf8ce037c8a7b1 = nil;
    v33._xf7a05a20e5febce9 = nil;
    v33._xfaeb146734fa90d1 = {};
    v33._x539d520919c8249a = nil;
    v33._x5b461b8c1fe66c71 = {};
    v33._x90351985ddcad7ec = {};
    v33._x0774fa5576a11975 = "Gradient";
    v33._x1e3533fdfead91a8 = nil;
    v33._xf37c1678737d878f = nil;
    v33._x8dd51b11e203fc8e = 0;
    v33._xdcc8a5e630d23bea = {
        attempt_connect = l__Signal__8.new(),
        create_gameplay_cue = l__Signal__8.new()
    };
    return v33;
end;
function u5._x4a32d66b3276d269(p34, p35) --[[ Line: 197 ]]
    -- upvalues: u6 (copy), l__InternalSymbols__15 (copy)
    local v36 = u6[p35];
    if v36 then
        local v37 = l__InternalSymbols__15.owner("", require(v36))._x90d4581ac99dd483();
        v37:_xe53615d96cf36a6b();
        table.insert(p34._x8d0ed1c9aea7e692, v37);
        return v37;
    end;
    warn("INVALID crosshair_name : " .. p35);
end;
function u5._xdc0a0193deec55d1(p38, p39) --[[ Line: 213 ]]
    -- upvalues: l__InternalSymbols__15 (copy)
    local v40 = l__InternalSymbols__15.owner("", p39);
    local v41 = table.find(p38._x8d0ed1c9aea7e692, v40);
    if v41 then
        table.remove(p38._x8d0ed1c9aea7e692, v41);
    else
        warn("removeCrosshair FAILED FOR CROSSHAIR : " .. v40._x9f381b99fa9097bd);
    end;
end;
function u5._x083003f139a3dbe6(p42) --[[ Line: 223 ]]
    -- upvalues: l__InternalSymbols__15 (copy)
    local v43 = {};
    local v44 = {};
    for _, v45 in ipairs(p42._xa0ff5cd48e83ed6e) do
        local v46 = nil;
        for _, v47 in ipairs(p42._x8d0ed1c9aea7e692) do
            local v48 = l__InternalSymbols__15.owner("", v47);
            if v48._x6679dae12d5569bf and #v48._x7a433e88d76bfbbf > 0 then
                for _, v49 in ipairs(v48._x7a433e88d76bfbbf) do
                    if v49 == v45 then
                        if not v46 or v48._xa421b937c4699429 > v46.priority then
                            v46 = v48;
                        end;
                        break;
                    end;
        ...
        if v46 then
            v43[v46] = true;
            for _, v50 in ipairs(p42._x8d0ed1c9aea7e692) do
                local v51 = l__InternalSymbols__15.owner("", v50);
                if v51._x6679dae12d5569bf and (v51 ~= v46 and #v51._x7a433e88d76bfbbf > 0) then
                    for _, v52 in ipairs(v51._x7a433e88d76bfbbf) do
                        if v52 == v45 then
                            v44[v51] = true;
                            break;
                        end;
    ...
    for _, v53 in ipairs(p42._x8d0ed1c9aea7e692) do
        local v54 = l__InternalSymbols__15.owner("", v53);
        if v54._x6679dae12d5569bf and #v54._x7a433e88d76bfbbf == 0 then
            v43[v54] = true;
        end;
    end;
    p42._xa484e8124dde606b = p42._xa484e8124dde606b or {};
    for v55, _ in pairs(v44) do
        local v56 = l__InternalSymbols__15.owner("", v55);
        if not p42._xa484e8124dde606b[v56] then
            if v56._x031a6113d489e09a then
                v56._x031a6113d489e09a:Fire();
            end;
            p42._xa484e8124dde606b[v56] = true;
        end;
    end;
    local v57 = {};
    for v58, _ in pairs(p42._xa484e8124dde606b) do
        local v59 = l__InternalSymbols__15.owner("", v58);
        if not v44[v59] then
            table.insert(v57, v59);
        end;
    end;
    for _, v60 in ipairs(v57) do
        local v61 = l__InternalSymbols__15.owner("", v60);
        if v61.OnRestore then
            v61.OnRestore:Fire();
        end;
        p42._xa484e8124dde606b[v61] = nil;
    end;
    local v62 = {};
...
function u5._x9bf5bab2ba494b47(p64, p65) --[[ Line: 306 ]]
    -- upvalues: l__InternalSymbols__15 (copy)
    local v66 = p64:_x083003f139a3dbe6();
    local v67 = {};
    for _, v68 in ipairs(v66) do
        v67[v68] = true;
    end;
    for _, v69 in ipairs(p64._x8d0ed1c9aea7e692) do
        local v70 = l__InternalSymbols__15.owner("", v69);
        if v70._x6679dae12d5569bf then
            if v67[v70] then
                if not v70._x9d0c0a6d51e5104c then
                    v70._x9d0c0a6d51e5104c = true;
                    v70:_x8fcdafeb8ad3312d();
                end;
                v70:_x449065fc95251217(p65);
            elseif v70._x9d0c0a6d51e5104c then
                v70._x9d0c0a6d51e5104c = false;
                v70:_x4209447529b7cd98();
            end;
        elseif v70._x9d0c0a6d51e5104c then
            v70._x9d0c0a6d51e5104c = false;
            v70:_x4209447529b7cd98();
...
function u5._x8698f905538773a3(p71, p72) --[[ Line: 338 ]]
    -- upvalues: u1 (ref), l__Classes__14 (copy), l__UserInputService__2 (copy)
    p71._xb2e12cde47dd8c35 = math.deg(u1._x98d5fd112c62c9d8);
    if l__Classes__14._x302afce6669630c0._xf180b73116666c39 or (l__Classes__14._x7430d6d194f43373._x48da6bf6d188aa71 or l__Classes__14._xb880259db2a1f0f1 and l__Classes__14._xb880259db2a1f0f1._x74c655fada9e6996) then
        l__UserInputService__2.MouseIconEnabled = true;
    else
        local v73 = l__UserInputService__2;
        local v74;
        if l__Classes__14._x7430d6d194f43373._x3668b6edfe3dbbd4 == "alive" then
            v74 = l__Classes__14._x32ae459de0772e82._x90d2e1498eb5b292;
        else
            v74 = false;
        end;
        v73.MouseIconEnabled = not v74 or false;
    end;
    p71:_x9bf5bab2ba494b47(p72);
    for _, v75 in p71._xe47bf301ff0f8f5e do
        if v75.connection then
            v75.connection();
        end;
    end;
end;
function u5._x24f649dbbf76dcfb(u76) --[[ Line: 353 ]]
    -- upvalues: l__Classes__14 (copy), u3 (ref), u2 (ref), u4 (ref), l__UIAssets__5 (copy), l__TweenService__3 (copy), l__Packets__7 (copy)
    local function u82(p77) --[[ Line: 402 ]]
        ...
        local v79, v80;
        if v78 then
            local l___xf7a05a20e5febce9__18 = u76._xf7a05a20e5febce9;
            if p77.spectate_impact == nil then
                v79 = l___xf7a05a20e5febce9__18 and (l___xf7a05a20e5febce9__18.impact or 0) or 0;
            else
                v79 = p77.spectate_impact;
            end;
            if p77.spectate_impact_limit == nil then
                v80 = l___xf7a05a20e5febce9__18 and l___xf7a05a20e5febce9__18.impact_limit or 1;
            else
                v80 = p77.spectate_impact_limit;
            end;
        else
            v79 = l__Classes__14._x7430d6d194f43373:_x57c044514acd3a73("impact").Value;
            v80 = l__Classes__14._x7430d6d194f43373:_x57c044514acd3a73("impact_limit").Value;
        end;
        local v81 = (v79 or 0) / math.max(v80 or 0, 1);
        return math.clamp(v81, 0, 1);
    end;
    local function u145(u83, u84) --[[ Line: 449 ]]
        ...
        if u84 then
            ...
            if u76._xe47bf301ff0f8f5e[u83] then
            ...
            elseif u84.indicator_type == "timing_only" then
                ...
                u87.Parent = u76._xef1fb561476b0a5b;
                local u88 = nil;
                local v89 = {
                    indicator_ui = u87,
                ...
                function v89.connection(_) --[[ Line: 474 ]]
                    ...
                    if not v96 then
                        u76._xe47bf301ff0f8f5e[u83] = nil;
                        u87:Destroy();
                        return;
                    end;
                    if u86 then
                    ...
                    elseif u84.require_los then
                        ...
                        local v99;
                        if v98 then
                            v99 = u76._xe5434ea5f8966bcf;
                            if v99 then
                                v99 = u76._xe5434ea5f8966bcf.Character;
                            end;
                        else
                            v99 = u3._xbcaafe2ed14862c8;
                        end;
                        local v100;
                        if v99 then
                    ...
                    if u87 and v101 then
                        ...
                        if v103 then
                            ...
                            local v106;
                            if v105 then
                                v106 = u76._xe5434ea5f8966bcf;
                                if v106 then
                                    v106 = u76._xe5434ea5f8966bcf.Character;
                                end;
                            else
                                v106 = u3._xbcaafe2ed14862c8;
                            end;
                            if u76._xf95a56fe36175fb9 == nil or v106 == nil then
                                v104 = false;
                            else
                                v104 = v106.Parent ~= nil;
                            end;
                        else
                            v104 = u4._x3668b6edfe3dbbd4 == "alive";
                        end;
                        if v104 then
                ...
                local v107 = v89;
                u76._xe47bf301ff0f8f5e[u83] = v107;
            else
                ...
                u108.Parent = u76._xef1fb561476b0a5b;
                local u110 = os.clock();
                local u111 = nil;
                local v112 = {
                ...
                v112.parry_tweens = {};
                function v112.connection(_) --[[ Line: 581 ]]
                    ...
                    local function v118(p114) --[[ Line: 582 ]]
                    ...
                    elseif u84.require_los then
                        ...
                        local v122;
                        if v121 then
                            v122 = u76._xe5434ea5f8966bcf;
                            if v122 then
                                v122 = u76._xe5434ea5f8966bcf.Character;
                            end;
                        else
                            v122 = u3._xbcaafe2ed14862c8;
                        end;
                        local v123;
                        if v122 then
                    ...
                    if u108 and (v125 and (v126 and os.clock() - u110 <= 5)) then
                        ...
                        if v128 then
                            ...
                            local v131;
                            if v130 then
                                v131 = u76._xe5434ea5f8966bcf;
                                if v131 then
                                    v131 = u76._xe5434ea5f8966bcf.Character;
                                end;
                            else
                                v131 = u3._xbcaafe2ed14862c8;
                            end;
                            if u76._xf95a56fe36175fb9 == nil or v131 == nil then
                                v129 = false;
                            else
                                v129 = v131.Parent ~= nil;
                            end;
                        else
                            v129 = u4._x3668b6edfe3dbbd4 == "alive";
                        end;
                        if v129 then
                ...
                local v144 = v112;
                u76._xe47bf301ff0f8f5e[u83] = v144;
            end;
        else
            warn("COULD NOT FIND shot_data FOR SHOOTER");
        end;
    end;
    local function u151(p146, p147) --[[ Line: 662 ]]
        -- upvalues: u76 (copy), l__Classes__14 (ref), l__TweenService__3 (ref)
        if u76._xe47bf301ff0f8f5e[p146] then
            local v148 = u76._xe47bf301ff0f8f5e[p146];
            local l__indicator_ui__33 = v148.indicator_ui;
            local v149 = l__Classes__14._x255cd8d76027f039._x610ae198723d5ccb[p146];
            if v149 then
                pcall(v149);
            end;
            ...
            u76._xe47bf301ff0f8f5e[p146] = nil;
        end;
    end;
    l__Packets__7._x65729782b2a34ba4.OnClientEvent:Connect(function(p152, p153) --[[ Line: 732 ]]
        -- upvalues: u76 (copy), u145 (copy)
        if u76._xf95a56fe36175fb9 then
        else
            u145(p152, p153);
        end;
    end);
    l__Packets__7._xfaeb5b6dbfe4a213.OnClientEvent:Connect(function(p154, p155) --[[ Line: 740 ]]
        -- upvalues: u151 (copy)
        u151(p154, p155);
    end);
    l__Packets__7._xeab8c95de187561c.OnClientEvent:Connect(function(p156, p157, p158) --[[ Line: 744 ]]
        -- upvalues: u76 (copy), u145 (copy)
        local v159 = u76._xe5434ea5f8966bcf and u76._xf95a56fe36175fb9;
        if v159 then
            v159 = tostring(u76._xe5434ea5f8966bcf.UserId) == tostring(p156);
        end;
        if v159 then
            u145(p157, p158);
        end;
    end);
    l__Packets__7._xc496960301642853.OnClientEvent:Connect(function(p160, p161, p162) --[[ Line: 750 ]]
        -- upvalues: u76 (copy), u151 (copy)
        local v163 = u76._xe5434ea5f8966bcf and u76._xf95a56fe36175fb9;
        if v163 then
            v163 = tostring(u76._xe5434ea5f8966bcf.UserId) == tostring(p160);
        end;
        if v163 then
            u151(p161, p162);
        end;
...
function u5._x64a18bcc98fdf773(p164) --[[ Line: 757 ]]
    if p164._x964f370fda99e2af and p164._x964f370fda99e2af.Parent ~= nil then
        local l__AugmentHolder__41 = p164._x964f370fda99e2af.Main.BottomLeft.AugmentContainer.AugmentHolder;
        return {
...
function u5._x1c4ac4ec2fd3ec91(p165) --[[ Line: 769 ]]
    if p165._x964f370fda99e2af then
        return p165.shot_progress_inst;
    end;
end;
function u5._x2d147abfc340ba12(p166) --[[ Line: 774 ]]
    p166._x624d4a774740097d:Clean();
    p166._x1e3533fdfead91a8 = nil;
end;
function u5._x5e25093725b68fa6(p167) --[[ Line: 779 ]]
    if p167._xf95a56fe36175fb9 then
        return p167._xf95a56fe36175fb9:FindFirstChild("Main") or p167._xf95a56fe36175fb9;
    else
        return nil;
    end;
end;
function u5._x99be46d90a73ed55(p168, p169) --[[ Line: 787 ]]
    local v170 = p168:_x5e25093725b68fa6();
    if not v170 then
        return nil;
    end;
...
function u5._xdeda307f6fb9ac6a(p172) --[[ Line: 796 ]]
    for _, v173 in {
        { "BottomLeft", "StaminaContainer" },
        { "BottomLeft", "AugmentContainer" },
        { "BottomCenter", "GameplayCues" }
    } do
        local v174 = p172:_x99be46d90a73ed55(v173);
    ...
    for _, v175 in {
        ...
        local l___xf95a56fe36175fb9__42 = p172._xf95a56fe36175fb9;
        for _, v176 in v175 do
            if not l___xf95a56fe36175fb9__42 then
                l___xf95a56fe36175fb9__42 = nil;
                break;
            end;
            l___xf95a56fe36175fb9__42 = l___xf95a56fe36175fb9__42:FindFirstChild(v176);
        end;
        if l___xf95a56fe36175fb9__42 and l___xf95a56fe36175fb9__42:IsA("GuiObject") then
            l___xf95a56fe36175fb9__42.Visible = false;
        end;
    end;
    local v177 = p172:_x99be46d90a73ed55({ "BottomLeft", "GunContainer", "GunKey" });
    if v177 and v177:IsA("GuiObject") then
        v177.Visible = false;
    end;
end;
function u5._x137a72a725cf1e50(_, p178, p179) --[[ Line: 815 ]]
...
function u5._x69476e2b5ad8ae53(p189, p190) --[[ Line: 862 ]]
    local v191 = p189:_x99be46d90a73ed55({ "BottomCenter", "KillstreakVisualizer" });
    if v191 then
        ...
        local l__killstreak__43 = p189._xfaeb146734fa90d1.killstreak;
        if l__killstreak__43 and l__killstreak__43 < v192 then
            p189:_x137a72a725cf1e50(v191, v192);
        end;
        p189._xfaeb146734fa90d1.killstreak = v192;
    end;
end;
function u5._x429bc84ff8a84b4e(p195, p196) --[[ Line: 882 ]]
    -- upvalues: l__TweenService__3 (copy)
    local v197 = p195:_x99be46d90a73ed55({
        "BottomCenter",
        "HealthContainer",
        "HealthMain",
        "Bar",
    ...
    if v197 and v197:IsA("GuiObject") then
        ...
        local l__health__44 = p195._xfaeb146734fa90d1.health;
        if l__health__44 then
            local v204 = l__health__44 - v198;
            if v204 > 0 then
                local v205 = p195:_x99be46d90a73ed55({
                    "BottomCenter",
                    "HealthContainer",
                    "HealthMain",
                    "Bar",
        ...
        p195._xfaeb146734fa90d1.health = v198;
    end;
end;
function u5._xfca86d8ad7e78fce(p208, p209) --[[ Line: 922 ]]
    -- upvalues: u2 (ref)
    local l___xf7a05a20e5febce9__45 = p208._xf7a05a20e5febce9;
    local v210 = p208:_x99be46d90a73ed55({ "TopCenter", "ImpactHolder" });
    local v211 = p208:_x99be46d90a73ed55({ "TopCenter", "ImpactHolder", "ImpactContainer" });
    local v212 = p208:_x99be46d90a73ed55({
        "TopCenter",
        "ImpactHolder",
        "ImpactContainer",
        "ImpactMain",
    ...
    local v213 = p208:_x99be46d90a73ed55({
        "TopCenter",
        "ImpactHolder",
        "ImpactContainer",
        "ImpactMain",
    ...
    if l___xf7a05a20e5febce9__45 and (v210 and (v212 and v212:IsA("GuiObject"))) then
        local v214 = l___xf7a05a20e5febce9__45.impact or 0;
        local v215 = math.max(l___xf7a05a20e5febce9__45.impact_limit or 0, 1);
        local v216 = l___xf7a05a20e5febce9__45.is_breaking == true;
        local v217 = math.clamp((p209 or 0) * 14, 0, 1);
        local l__Scale__46 = v212.Size.X.Scale;
        local v218 = p208._xfaeb146734fa90d1.impact_delayed_fill or 0;
        if v216 then
            local v219 = math.max(l___xf7a05a20e5febce9__45.break_duration or 0, 0.001);
            local l__break_remaining__47 = l___xf7a05a20e5febce9__45.break_remaining;
            if l___xf7a05a20e5febce9__45.break_end_time and l___xf7a05a20e5febce9__45.break_end_time > 0 then
                local v220 = l___xf7a05a20e5febce9__45.break_end_time - workspace:GetServerTimeNow();
            ...
            p208._xfaeb146734fa90d1.impact_delayed_fill = v222;
        ...
        elseif v214 > 0 then
            ...
            p208._xfaeb146734fa90d1.impact_delayed_fill = v230;
            ...
            p208._xfaeb146734fa90d1.impact_delayed_fill = v218 + (0 - v218) * math.clamp(v217, 0, 1);
            if v213 and v213:IsA("GuiObject") then
                v213.Visible = false;
            end;
            if v232 <= 0.001 then
                ...
                p208._xfaeb146734fa90d1.impact_delayed_fill = 0;
            end;
        end;
    end;
end;
function u5._xa193d65079528411(p233) --[[ Line: 1008 ]]
    if p233._x539d520919c8249a then
        p233._x539d520919c8249a:Destroy();
        p233._x539d520919c8249a = nil;
    end;
    for _, v234 in p233._x5b461b8c1fe66c71 do
        if v234 then
            v234:Destroy();
        end;
    end;
    p233._x5b461b8c1fe66c71 = {};
end;
function u5._x5e5c51d4c8534fdc(p235, p236, p237) --[[ Line: 1022 ]]
    -- upvalues: l__UIAssets__5 (copy)
    p235:_xa193d65079528411();
    local v238 = p235:_x99be46d90a73ed55({ "BottomLeft", "GunContainer" });
    if v238 then
        ...
        if v240 then
            p235._x539d520919c8249a = v240:Clone();
            p235._x539d520919c8249a.Parent = v238;
        end;
        ...
        if v241 then
            ...
            for v243 = 1, p237 do
                ...
                v244.Parent = v241;
                p235._x5b461b8c1fe66c71[v243] = v244;
            end;
        end;
    end;
end;
function u5._x8b4199feff3e448e(_, p245, p246) --[[ Line: 1059 ]]
...
function u5._xaadf392a4c5f5703(p250, p251) --[[ Line: 1067 ]]
    -- upvalues: l__TweenService__3 (copy), u2 (ref)
    ...
    if l__gun_item_id__49 ~= p250._xfaeb146734fa90d1.gun_item_id or v255 ~= p250._xfaeb146734fa90d1.max_bullets then
        p250:_x5e5c51d4c8534fdc(l__gun_item_id__49 or "Castigate", v255);
        p250._xfaeb146734fa90d1.gun_item_id = l__gun_item_id__49;
        p250._xfaeb146734fa90d1.max_bullets = v255;
        p250._xfaeb146734fa90d1.bullet_count = nil;
    end;
    local v258 = p250._xfaeb146734fa90d1.heat ~= v252;
    local l__bullet_count__50 = p250._xfaeb146734fa90d1.bullet_count;
    if v258 or l__bullet_count__50 == nil then
        for v259, v260 in p250._x5b461b8c1fe66c71 do
            p250:_x8b4199feff3e448e(v260, v259 <= v257);
        end;
        if l__bullet_count__50 then
            if l__bullet_count__50 < v257 and p250._x539d520919c8249a then
                local v261 = p250._x539d520919c8249a:FindFirstChild("Flash");
                ...
                local v262 = p250._x5b461b8c1fe66c71[v257];
                if v262 then
            ...
            elseif v257 < l__bullet_count__50 then
                local v263 = p250._x5b461b8c1fe66c71[v257 + 1];
                if v263 then
        ...
        local l___x539d520919c8249a__51 = p250._x539d520919c8249a;
        if l___x539d520919c8249a__51 then
            l___x539d520919c8249a__51 = p250._x539d520919c8249a:FindFirstChildWhichIsA("UIGradient");
        end;
        if l___x539d520919c8249a__51 and v254 > 0 then
            ...
            l__TweenService__3:Create(l___x539d520919c8249a__51, TweenInfo.new(0.3, Enum.EasingStyle.Cubic, Enum.EasingDirection.Out), {
                Offset = Vector2.new(0, v266)
            }):Play();
        end;
        p250._xfaeb146734fa90d1.bullet_count = v257;
        p250._xfaeb146734fa90d1.heat = v252;
    end;
end;
function u5._x012822ec27294188(p267) --[[ Line: 1137 ]]
    local v268 = p267:_x99be46d90a73ed55({ "BottomCenter", "SpeedVisualizer" });
    if v268 then
        local l___xf7a05a20e5febce9__52 = p267._xf7a05a20e5febce9;
        local v269;
        if l___xf7a05a20e5febce9__52 then
            local l__speed__53 = l___xf7a05a20e5febce9__52.speed;
            if l__speed__53 == nil and typeof(l___xf7a05a20e5febce9__52.velocity) == "Vector3" then
                local l__velocity__54 = l___xf7a05a20e5febce9__52.velocity;
...
function u5._xfc884c31374f8326(p271, p272) --[[ Line: 1159 ]]
    p271:_x012822ec27294188();
    p271:_xfca86d8ad7e78fce(p272);
    local l___xf7a05a20e5febce9__55 = p271._xf7a05a20e5febce9;
    local v273 = p271:_x99be46d90a73ed55({ "BottomCenter", "KillstreakVisualizer" });
    if l___xf7a05a20e5febce9__55 and (v273 and (l___xf7a05a20e5febce9__55.killstreak or 0) >= 1) then
        local v274 = v273:FindFirstChild("Radial");
        if v274 and v274:IsA("GuiObject") then
            v274.Rotation = (v274.Rotation + p272 * 90 * ((l___xf7a05a20e5febce9__55.killstreak or 0) % 2 == 0 and -1 or 1)) % 360;
        end;
    end;
end;
function u5._x4c8394e631a87ac3(u275, p276) --[[ Line: 1176 ]]
    -- upvalues: l__Classes__14 (copy), l__UIAssets__5 (copy), l__LocalPlayer__16 (copy), l__RunService__1 (copy)
    u275:_xdc3b5df4fbf49698();
    u275:_x5b0b306be33b2083();
    ...
    if v277 then
        local l___x964f370fda99e2af__56 = u275._x964f370fda99e2af;
        if l___x964f370fda99e2af__56 then
            l___x964f370fda99e2af__56 = u275._x964f370fda99e2af:FindFirstChild("Main");
        end;
        if l___x964f370fda99e2af__56 and l___x964f370fda99e2af__56:IsA("GuiObject") then
            u275._x94bf8ce037c8a7b1 = l___x964f370fda99e2af__56.Visible;
            l___x964f370fda99e2af__56.Visible = false;
        end;
        u275._xe5434ea5f8966bcf = p276;
        u275._xf95a56fe36175fb9 = v277:Clone();
        u275._xf7a05a20e5febce9 = nil;
        u275._xfaeb146734fa90d1 = {
            killstreak = 0
        };
        u275._x5b461b8c1fe66c71 = {};
        u275._xef1fb561476b0a5b.Enabled = true;
        u275._x9b73fdaa3921c1ae:Add(u275._xf95a56fe36175fb9);
        if u275._xf95a56fe36175fb9:IsA("ScreenGui") then
            u275._xf95a56fe36175fb9.ResetOnSpawn = false;
            u275._xf95a56fe36175fb9.IgnoreGuiInset = true;
            u275._xf95a56fe36175fb9.Parent = l__LocalPlayer__16.PlayerGui;
        else
            u275._xf95a56fe36175fb9.Parent = u275._xef1fb561476b0a5b;
        end;
        u275:_xdeda307f6fb9ac6a();
        u275._x9b73fdaa3921c1ae:Connect(l__RunService__1.RenderStepped, function(p278) --[[ Line: 1216 ]]
            -- upvalues: u275 (copy)
            u275:_xfc884c31374f8326(p278);
        end);
    else
        warn("NO SpectateHUD UI ASSET FOUND");
    end;
end;
function u5._x91910985bdfe9fdd(p279, p280) --[[ Line: 1221 ]]
    if p279._xf95a56fe36175fb9 and typeof(p280) == "table" then
        p279._xf7a05a20e5febce9 = p280;
        p279:_x69476e2b5ad8ae53(p280);
        p279:_x429bc84ff8a84b4e(p280);
        p279:_xaadf392a4c5f5703(p280);
    end;
end;
function u5._x5b0b306be33b2083(p281) --[[ Line: 1232 ]]
    for v282, v283 in p281._xe47bf301ff0f8f5e do
        if v283.indicator_ui then
            v283.indicator_ui:Destroy();
        end;
        p281._xe47bf301ff0f8f5e[v282] = nil;
    end;
end;
function u5._x0e8835ea29aa398a(p284) --[[ Line: 1241 ]]
    local v285 = {};
    for v286, v287 in p284._xe47bf301ff0f8f5e do
        if v287.is_spectate then
            table.insert(v285, v286);
        end;
    end;
    for _, v288 in v285 do
        local v289 = p284._xe47bf301ff0f8f5e[v288];
        if v289 and v289.indicator_ui then
            v289.indicator_ui:Destroy();
        end;
        p284._xe47bf301ff0f8f5e[v288] = nil;
    end;
end;
function u5._xdc3b5df4fbf49698(p290) --[[ Line: 1258 ]]
    -- upvalues: l__Classes__14 (copy)
    local l___x964f370fda99e2af__57 = p290._x964f370fda99e2af;
    if l___x964f370fda99e2af__57 then
        l___x964f370fda99e2af__57 = p290._x964f370fda99e2af:FindFirstChild("Main");
    end;
    if p290._x94bf8ce037c8a7b1 ~= nil and (l___x964f370fda99e2af__57 and l___x964f370fda99e2af__57:IsA("GuiObject")) then
        l___x964f370fda99e2af__57.Visible = p290._x94bf8ce037c8a7b1;
    end;
    if l__Classes__14.MenuManager.in_menu then
        l__Classes__14.MenuManager.screen.Enabled = true;
    end;
    p290:_x0e8835ea29aa398a();
    p290._x9b73fdaa3921c1ae:Clean();
    p290._xf95a56fe36175fb9 = nil;
    p290._xe5434ea5f8966bcf = nil;
    p290._x94bf8ce037c8a7b1 = nil;
    p290._xf7a05a20e5febce9 = nil;
    p290._xfaeb146734fa90d1 = {};
    p290._x539d520919c8249a = nil;
    p290._x5b461b8c1fe66c71 = {};
end;
function u5._x0c03f29ad12df05e(p291, p292) --[[ Line: 1279 ]]
    ...
    if p291._x964f370fda99e2af then
        ...
        if v302 then
            ...
            if v319 and u320 then
                ...
                u293:Add(u320:GetPropertyChangedSignal("AbsolutePosition"):Connect(function() --[[ Line: 1450 ]]
                ...
                u293:Add(u320:GetPropertyChangedSignal("AbsoluteSize"):Connect(function() --[[ Line: 1454 ]]
                    -- upvalues: u32 (ref), u322 (copy), u320 (copy), u321 (copy)
            ...
            u293:Add(l__Classes__14._x7430d6d194f43373:_x685b03ceb3f7e330("onHit"):Once(function() --[[ Line: 1469 ]]
                -- upvalues: u306 (copy)
                u306:cancel();
            end));
            u293:Add(l__Classes__14._x7430d6d194f43373:_x685b03ceb3f7e330("onDamageTaken"):Once(function() --[[ Line: 1473 ]]
                -- upvalues: u306 (copy)
                u306:cancel();
            end));
            u293:Add(u305.Destroying:Connect(function() --[[ Line: 1477 ]]
                -- upvalues: u306 (copy)
                u306:cancel();
            end));
            u306:finally(function() --[[ Line: 1481 ]]
                ...
                task.delay(8.05, function() --[[ Line: 1486 ]]
                    -- upvalues: u293 (ref)
                    u293:Clean();
                end);
            end);
            u305.Parent = p291._x964f370fda99e2af;
            return u306;
        end;
...
function u5._x19a8c13b7d43296b(u327, u328) --[[ Line: 1496 ]]
    ...
    if u327._x964f370fda99e2af then
        ...
        task.spawn(function() --[[ Line: 1504 ]]
            ...
            (function() --[[ Name: startModule, Line 1505 ]]
                ...
                local l__GunContainer__62 = u327._x964f370fda99e2af.Main.BottomLeft.GunContainer;
                ...
                local function u349() --[[ Line: 1565 ]]
                    ...
                    local l__KeyCode__64 = l__Classes__14._x3e046bec2684f59c:_xc9966245cd0a44a8("GUN").KeyCode;
                    l__GunContainer__62.GunKey.KeyText.Text = l__Classes__14._x3e046bec2684f59c:_xfeef7f7b762e94d9(l__KeyCode__64);
                    local function v347() --[[ Line: 1574 ]]
                        ...
                        l__Classes__14._xbe184fb1376a575d:_x7ab8b42cc5920a78("BULLET_GAINED", true);
                ...
                u349();
                local v350 = u329.Changed:Connect(function(_) --[[ Line: 1615 ]]
                    -- upvalues: u349 (copy)
                    u349();
                end);
                u327._x624d4a774740097d:Add(v350);
            end)();
        end);
    else
...
function u5._xaf76eb01fb5dda1c(p351, p352) --[[ Line: 1627 ]]
    if p351._x1e3533fdfead91a8 and typeof(p351._x1e3533fdfead91a8) == "function" then
        return p351._x1e3533fdfead91a8(p352);
    end;
end;
function u5._x70830fd0300678f5(u353, p354) --[[ Line: 1633 ]]
    -- upvalues: l__Promise__9 (copy), l__TweenService__3 (copy)
    if u353._x964f370fda99e2af then
        if u353._xf37c1678737d878f then
            u353._xf37c1678737d878f:cancel();
        end;
        local u355 = os.clock();
        u353._x8dd51b11e203fc8e = u355;
        local l___x964f370fda99e2af__68 = u353._x964f370fda99e2af;
        local l__HeaderNotifLabel__69 = l___x964f370fda99e2af__68.Misc.HeaderNotifLabel;
        local l__HeaderSubtext__70 = l___x964f370fda99e2af__68.Misc.HeaderSubtext;
        ...
        if p354.life_time then
            ...
            u353._xf37c1678737d878f:andThen(function() --[[ Line: 1671 ]]
                -- upvalues: u353 (copy), u355 (copy), l__HeaderNotifLabel__69 (copy), l__HeaderSubtext__70 (copy)
                if u353._x8dd51b11e203fc8e == u355 then
                    l__HeaderNotifLabel__69.Text = "";
                    l__HeaderSubtext__70.Text = "";
...
function u5._xcb7fcd214aed2202(u357) --[[ Line: 1679 ]]
    ...
    u357._x964f370fda99e2af = u358;
    u357._x624d4a774740097d:Add(u358);
    local l___x32ae459de0772e82__72 = l__Classes__14._x32ae459de0772e82;
    local u359 = 0;
    local v363 = l__RunService__1.RenderStepped:Connect(function() --[[ Line: 1689 ]]
        -- upvalues: l___x32ae459de0772e82__72 (copy), l__Classes__14 (ref), l__Main__71 (copy), u3 (ref), u2 (ref), u359 (ref)
        local v360 = l___x32ae459de0772e82__72._x99066ac348930027 * 25 + l__Classes__14._x32ae459de0772e82._xfb85155ec89e5a89.shake_spring_x.Velocity * 0.5;
        local v361 = l___x32ae459de0772e82__72._xb30b7f13778b9dbc * 25;
        local v362 = math.clamp(l___x32ae459de0772e82__72._x98d5fd112c62c9d8, -1, 1);
        l__Main__71.Position = UDim2.fromScale(0.5 - v360, 0.5 - v361);
        l__Main__71.Rotation = v362 * 10;
        if u3._x1d287c838240a901 then
            u359 = u2:numLerp(u359, u2:convNumRange(math.clamp(u3._x1d287c838240a901.Magnitude, 50, 150), 50, 150, 0, 0.02), 0.08);
            l__Main__71.Size = UDim2.fromScale(u359 + 1, u359 + 1);
        end;
    end);
    u357._x624d4a774740097d:Add(v363);
    function u357._x1e3533fdfead91a8(p364) --[[ Line: 1713 ]]
        ...
        if p364.cue_type == "message" then
            ...
            return function() --[[ Name: cleanup, Line 1736 ]]
                -- upvalues: u366 (copy)
                if u366 then
                    u366:Destroy();
                end;
    ...
    local v367 = l__GuiService__74:GetPropertyChangedSignal("TopbarInset"):Connect(function() --[[ Line: 1756 ]]
    ...
    local v369 = l__RunService__1.Heartbeat:Connect(function() --[[ Line: 1760 ]]
        -- upvalues: l__Classes__14 (ref), l__Main__71 (copy)
        local v368 = not l__Classes__14._x7058397dabccd000._x1d287c838240a901 and "0 u/s" or math.floor((l__Classes__14._x7058397dabccd000._x1d287c838240a901 * Vector3.new(1, 0, 1)).Magnitude * 10) / 10 .. " u/s";
        l__Main__71.BottomCenter.SpeedVisualizer.Text = v368;
    end);
    u357._x624d4a774740097d:Add(v367);
    u357._x624d4a774740097d:Add(v369);
    local l__LevelFrame__77 = u358.Misc.LevelFrame;
    local u370 = u4:_x57c044514acd3a73("total_xp");
    local u371 = u4:_x57c044514acd3a73("level");
    local l__Value__78 = u371.Value;
    local l__Value__79 = u370.Value;
    local function v374() --[[ Line: 1786 ]]
    ...
    local function v377() --[[ Line: 1801 ]]
        ...
        if l__Value__78 < l__Value__81 then
            ...
            l__Classes__14._xbe184fb1376a575d:_x7ab8b42cc5920a78("LEVELUP", true);
        else
            l__Value__78 = l__Value__81;
        end;
    end;
    ...
    u357._x624d4a774740097d:Add(v378);
    u357._x624d4a774740097d:Add(v379);
    local v380 = l__InternalSymbols__15.owner("", l__Classes__14._x545ff694ddcc66c8._x54ffdfaa6954a8fc);
    if l__Classes__14._x545ff694ddcc66c8._x52b3d9fd81166d6c and not (v380 and v380._x995dd18e69a73646) then
        ...
        local u381 = u4:_x57c044514acd3a73("in_combat");
        local _ = game:GetService("ReplicatedStorage").Assets.RemoteEvents.Reset;
        local u382 = {};
        local function u387() --[[ Line: 1870 ]]
        ...
        local function u390() --[[ Line: 1896 ]]
            ...
            if u4:_x57c044514acd3a73("killstreak").Value > 0 then
        ...
        local v392 = u381.Changed:Connect(function(p391) --[[ Line: 1942 ]]
        ...
        local v393 = u357._xdcc8a5e630d23bea.attempt_connect:Connect(function() --[[ Line: 1950 ]]
        ...
        u357._x624d4a774740097d:Add(v392);
        u357._x624d4a774740097d:Add(v393);
    end;
    local l__NotificationCanvas__84 = l__Main__71.NotificationCanvas;
    local function u396(p394) --[[ Line: 1969 ]]
        ...
        task.delay(0.1, function() --[[ Line: 1984 ]]
        ...
        l__Promise__9.delay(p394.life_time or 5):andThen(function() --[[ Line: 1999 ]]
            -- upvalues: u395 (copy), l__TweenService__3 (ref)
            if u395 and u395.Parent ~= nil then
    ...
    local v398 = l__Packets__7._xb808d95d66c8eda8.OnClientEvent:Connect(function(p397) --[[ Line: 2013 ]]
        -- upvalues: u396 (copy)
        u396(p397);
    end);
    local v400 = l__Packets__7._xba32886466402e05.OnClientEvent:Connect(function(p399) --[[ Line: 2017 ]]
        game:GetService("TextChatService").TextChannels:WaitForChild("RBXGeneral"):DisplaySystemMessage(p399);
    end);
    u357._x624d4a774740097d:Add(v398);
    u357._x624d4a774740097d:Add(v400);
    local l__KillstreakVisualizer__85 = l__Main__71.BottomCenter.KillstreakVisualizer;
    local u401 = u4:_x57c044514acd3a73("killstreak");
    local l__Value__86 = u401.Value;
    local u402 = 0;
    local l___xfaee1d1d64cdfe93__87 = l__Classes__14._xfaee1d1d64cdfe93;
    local function u406() --[[ Line: 2033 ]]
    ...
    local v408 = u401.Changed:Connect(function(p407) --[[ Line: 2066 ]]
    ...
    local function u416() --[[ Line: 2073 ]]
        -- upvalues: u401 (copy), u2 (ref), l__TweenService__3 (ref), l___xfaee1d1d64cdfe93__87 (copy), l__KillstreakVisualizer__85 (copy)
        if u401.Value == 0 then
        else
            local v409 = u2:numLerp(1.1, 2, l__TweenService__3:GetValue(l___xfaee1d1d64cdfe93__87._x5fc8868a2d4cd8f9, Enum.EasingStyle.Quint, Enum.EasingDirection.In));
            ...
            if u401.Value >= 3 then
                local v411 = u2:numLerp(0, 0.02, l__TweenService__3:GetValue(l___xfaee1d1d64cdfe93__87._x5fc8868a2d4cd8f9, Enum.EasingStyle.Sine, Enum.EasingDirection.In));
            ...
            if u401.Value >= 3 then
                local v412 = u2:numLerp(1, 0, l__TweenService__3:GetValue(l___xfaee1d1d64cdfe93__87._x5fc8868a2d4cd8f9, Enum.EasingStyle.Quint, Enum.EasingDirection.In));
            ...
            if u401.Value >= 5 then
                local v413 = u2:numLerp(1, 0.2, l__TweenService__3:GetValue(l___xfaee1d1d64cdfe93__87._x5fc8868a2d4cd8f9, Enum.EasingStyle.Sine, Enum.EasingDirection.In));
    ...
    local v417 = l___xfaee1d1d64cdfe93__87._xc94f8ca0598b7403.onBeat:Connect(function() --[[ Line: 2111 ]]
        -- upvalues: u416 (copy)
        u416();
    end);
    local v420 = l__RunService__1.RenderStepped:Connect(function(p418) --[[ Line: 2115 ]]
        -- upvalues: l__KillstreakVisualizer__85 (copy), u401 (copy), l___xfaee1d1d64cdfe93__87 (copy), u402 (ref), u2 (ref), l__TweenService__3 (ref)
        local l__Radial__88 = l__KillstreakVisualizer__85.Radial;
        local l__Value__89 = u401.Value;
        if l__Value__89 > 0 then
            if l___xfaee1d1d64cdfe93__87._x371b503c898dc1aa or l___xfaee1d1d64cdfe93__87._x371b503c898dc1aa[l___xfaee1d1d64cdfe93__87._x6f4db409cdf45146] then
                local v419 = l__Value__89 % 2 == 0 and -1 or 1;
                u402 = u2:numLerp(0.3, 4, l__TweenService__3:GetValue(l___xfaee1d1d64cdfe93__87._x5fc8868a2d4cd8f9, Enum.EasingStyle.Quint, Enum.EasingDirection.In));
    ...
    u357._x624d4a774740097d:Add(v420);
    u357._x624d4a774740097d:Add(v417);
    u357._x624d4a774740097d:Add(v408);
    local v435 = u4:_x685b03ceb3f7e330("onDamageTaken"):Connect(function(u421) --[[ Line: 2153 ]]
        ...
        if u421.attacker_identifier and u421.damage > 0 then
            ...
            if u422 then
                ...
                local u424 = nil;
                if u357._x0774fa5576a11975 == "Gradient" then
                ...
                elseif u357._x0774fa5576a11975 == "Blob" then
                    ...
                    warn("UNKNOWN DAMAGE INDICATOR TYPE : ", u357._x0774fa5576a11975);
                end;
                u424.Position = v423;
                ...
                local u427 = nil;
                local u428 = false;
                u427 = l__RunService__1.RenderStepped:Connect(function() --[[ Line: 2213 ]]
                ...
                task.delay(0.8, function() --[[ Line: 2236 ]]
                ...
                u357._x624d4a774740097d:Add(u424);
                u357._x624d4a774740097d:Add(u427);
            end;
        end;
    end);
    u357._x624d4a774740097d:Add(v435);
    local u436 = 0;
    local function u445() --[[ Line: 2251 ]]
        ...
        local l__Value__96 = u4:_x57c044514acd3a73("health").Value;
        local l__Value__97 = u4:_x57c044514acd3a73("health_max").Value;
        ...
        local function v439(_) --[[ Line: 2263 ]]
        ...
        local function v442(p440) --[[ Line: 2268 ]]
    ...
    u445();
    local v446 = u4:_x57c044514acd3a73("health").Changed:Connect(function() --[[ Line: 2298 ]]
        -- upvalues: u445 (copy)
        u445();
    end);
    local v448 = l__Classes__14._xfaee1d1d64cdfe93._xc94f8ca0598b7403.onBeat:Connect(function() --[[ Line: 2302 ]]
        -- upvalues: u4 (ref), u358 (copy), l__TweenService__3 (ref)
        local l__Value__101 = u4:_x57c044514acd3a73("health_max").Value;
        local l__Value__102 = u4:_x57c044514acd3a73("health").Value;
    ...
    for u449 = 1, l__Classes__14.Config._x2b5ce4ee2f16900b do
        ...
        local v455 = l__RunService__1.RenderStepped:Connect(function(_) --[[ Line: 2346 ]]
            -- upvalues: u3 (ref), u449 (copy), u450 (copy), u451 (ref), u452 (copy), u453 (copy)
            local l___xa2a90f9baae72ac5__108 = u3._xa2a90f9baae72ac5;
            local l___x95981622da89ab0b__109 = u3._x95981622da89ab0b;
            local v454 = math.clamp(l___xa2a90f9baae72ac5__108 - u449 + 1, 0, 1);
            u450.Fill.Size = UDim2.fromScale(v454, 1);
            if u449 <= l___x95981622da89ab0b__109 then
                if not u451 then
                    u451 = true;
                    u452();
                end;
        ...
        u357._x624d4a774740097d:Add(v455);
    end;
    local l__CircularImageFill__110 = l__Main__71.BottomLeft.AugmentContainer.AugmentHolder.CircularImageFill;
    local v459 = l__CircularImageFill__110.Progress.Changed:Connect(function(p456) --[[ Line: 2376 ]]
        -- upvalues: l__Classes__14 (ref), l__Main__71 (copy), l__CircularImageFill__110 (copy)
        local l__KeyCode__111 = l__Classes__14._x3e046bec2684f59c:_xc9966245cd0a44a8("AUGMENT").KeyCode;
        l__Main__71.BottomLeft.AugmentContainer.AugmentHolder.AugmentKey.KeyText.Text = l__Classes__14._x3e046bec2684f59c:_xfeef7f7b762e94d9(l__KeyCode__111);
    ...
    u357._x624d4a774740097d:Add(v459);
    ...
    local u460 = u4:_x57c044514acd3a73("impact");
    local u461 = u4:_x57c044514acd3a73("impact_limit");
    local u462 = 0;
    local v464 = l__Packets__7.unreliablePackets._x8183092ff6492439.OnClientEvent:Connect(function(p463) --[[ Line: 2416 ]]
    ...
    local v472 = l__RunService__1.RenderStepped:Connect(function() --[[ Line: 2428 ]]
        ...
        if u4._x7176ea97549fd9b6.is_breaking then
            l__ImpactHolder__114.Visible = true;
            local v465 = math.map(u4._x7176ea97549fd9b6.break_duration, 0, u4._x7176ea97549fd9b6.initial_duration, 0, 1);
        ...
        elseif l__Value__119 > 0 then
            ...
            l__Promise__9.delay(0.07):andThen(function() --[[ Line: 2459 ]]
    ...
    u357._x624d4a774740097d:Add(v472);
    u357._x624d4a774740097d:Add(v464);
    u358.Parent = u357._xef1fb561476b0a5b;
    if l__Classes__14._xd0d75b75975ea69f then
        l__Classes__14._xd0d75b75975ea69f:_x8ad7adc7f7f0508f();
    end;
end;
function u5._xe53615d96cf36a6b(u473) --[[ Line: 2490 ]]
    -- upvalues: u1 (ref), l__Classes__14 (copy), u2 (ref), u3 (ref), u4 (ref), l__RunService__1 (copy)
    task.defer(function() --[[ Line: 2491 ]]
        -- upvalues: u1 (ref), l__Classes__14 (ref), u2 (ref), u3 (ref), u4 (ref), u473 (copy), l__RunService__1 (ref)
        u1 = l__Classes__14._x32ae459de0772e82;
        u2 = l__Classes__14.Util;
        u3 = l__Classes__14._x7058397dabccd000;
        u4 = l__Classes__14._x7430d6d194f43373;
        u473._xef1fb561476b0a5b.Parent = u3._xd30f7d3b3541d0d7.PlayerGui;
        u473:_x24f649dbbf76dcfb();
        table.insert(u473._x90351985ddcad7ec, l__RunService__1.RenderStepped:Connect(function(p474) --[[ Line: 2499 ]]
            -- upvalues: u473 (ref)
            u473:_x8698f905538773a3(p474);
        end));
    end);
end;
return u5;
