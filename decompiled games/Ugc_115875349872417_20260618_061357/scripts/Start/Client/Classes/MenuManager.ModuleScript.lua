...
function u1.enterMenu(u21, p22, p23, p24) --[[ Line: 209 ]]
    ...
    if l__Classes__6._x7430d6d194f43373 then
        l__Classes__6._x7430d6d194f43373:_xbbd21c88eb4b9b6c(p24 == "FFA");
    end;
    if l__Classes__6._x3e046bec2684f59c then
        l__Classes__6._x3e046bec2684f59c:_x4c9977b827e9b5fa("menu", true);
    end;
    u21.in_menu = true;
    ...
    l__Classes__6._x199aee2e6ba696d1:_x8fcdafeb8ad3312d(p22);
    v27.trove:Add(function() --[[ Line: 250 ]]
        -- upvalues: l__Classes__6 (ref)
        l__Classes__6._x199aee2e6ba696d1:cleanUp();
    end);
end;
...
function u1.listenForEvents(u33) --[[ Line: 296 ]]
    ...
    if l__Classes__6._x3e046bec2684f59c then
        l__Classes__6._x3e046bec2684f59c:_xc9966245cd0a44a8("MENU_OPEN").Pressed:Connect(function() --[[ Line: 298 ]]
            -- upvalues: u33 (copy), l__Packets__4 (ref), l__Classes__6 (ref)
            if u33.in_menu then
            elseif u33:_canRequestMenu() then
                if l__Packets__4._xf332c7eb89e7cb16:Fire() == false and l__Classes__6._xafc4950d7b094088 then
                    l__Classes__6._xafc4950d7b094088._xdcc8a5e630d23bea.attempt_connect:Fire();
                end;
            end;
        end);
    end;
    l__Packets__4._xfeb73535ced43c5e.OnClientEvent:Connect(function(p34, p35, p36) --[[ Line: 313 ]]
        ...
        if l__Classes__6._xd0d75b75975ea69f then
            l__Classes__6._xd0d75b75975ea69f:_x8ad7adc7f7f0508f();
        end;
    end);
end;
