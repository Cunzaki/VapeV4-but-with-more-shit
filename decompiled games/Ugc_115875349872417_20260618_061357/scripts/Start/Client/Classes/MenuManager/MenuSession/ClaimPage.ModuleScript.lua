        ...
        return l__Promise__5.new(function(u14, _, p15) --[[ Line: 114 ]]
            ...
            local function u40(u25, u26) --[[ Line: 137 ]]
                ...
                if u25.reason == "kill" then
                    return l__Promise__5.new(function(u27, _, _) --[[ Line: 139 ]]
                        ...
                        if u18 ~= 0.1 then
                            local v34 = l__Classes__8._xbe184fb1376a575d:_x7ab8b42cc5920a78("GENERIC_LONG", true);
            ...
            if v20 then
                u46 = l__Promise__5.delay(v45 - 0.7):andThen(function() --[[ Line: 279 ]]
                    ...
                    l__Classes__8._xbe184fb1376a575d:_x7ab8b42cc5920a78("DNB_BUILDUP", true);
                end);
            else
                u46 = nil;
            end;
            local u48 = l__Promise__5.delay(v45):finally(function() --[[ Line: 284 ]]
                ...
                table.clear(u19);
                l__Classes__8._xbe184fb1376a575d:_x7ab8b42cc5920a78("RELEASE2", true);
                u24:Disconnect();
                u24 = nil;
                u14();
            end);
    ...
    local u57 = u52:finally(function() --[[ Line: 322 ]]
        ...
        return l__Promise__5.new(function(u53, _, p54) --[[ Line: 323 ]]
            ...
            if not u7.finished then
                ...
                l__YenCount__22.Text = "¥" .. l__Classes__8.Util:formatNumber(l__Classes__8._x7430d6d194f43373:_x57c044514acd3a73("yen").Value);
