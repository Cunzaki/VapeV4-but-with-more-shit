...
local u6 = CFrame.new();
local u9 = {
    monarchScopeIn = LPH_NO_VIRTUALIZE(function(p7, p8) --[[ Line: 35 ]]
...
function u4._xc0c41c03168537df(p31) --[[ Line: 137 ]]
    ...
    if v32 then
        task.defer(LPH_JIT_MAX(function() --[[ Line: 178 ]]
...
function u4._x72baca0219a3d784(u54, p55, p56) --[[ Line: 270 ]]
    ...
    local u67 = LPH_NO_VIRTUALIZE(function(p59, _, p60) --[[ Line: 276 ]]
    ...
    local u70 = LPH_JIT_MAX(function(p68) --[[ Line: 319 ]]
        ...
        if u57 then
            ...
            l__Promise__1.delay(p68.shot_time):andThen(LPH_JIT_MAX(function() --[[ Line: 340 ]]
                -- upvalues: l__Classes__4 (ref)
    ...
    LPH_JIT_MAX(function(u71, p72) --[[ Line: 354 ]]
        ...
        if l__Classes__4._x7058397dabccd000._xbcaafe2ed14862c8 then
            ...
            local v75 = l__Packets__2._x1d844bfc9ae8096f.OnClientEvent:Once(LPH_JIT_MAX(function(...) --[[ Line: 367 ]]
            ...
            v76:andThen(LPH_JIT_MAX(function() --[[ Line: 375 ]]
            ...
            local u77 = u6;
            table.insert(u54._x57f55f05c54c5863, l__RunService__6.Heartbeat:Connect(LPH_NO_VIRTUALIZE(function() --[[ Line: 387 ]]
            ...
            l__Classes__4.Util:bindRenderStepToTable(u54._x57f55f05c54c5863, l__Classes__4._x32ae459de0772e82._x8ff5d6204140ad8b + 1, "gun_viewmodel", LPH_NO_VIRTUALIZE(function() --[[ Line: 399 ]]
                -- upvalues: l__Classes__4 (ref), u54 (ref)
            ...
            local u88 = nil;
            local u89 = nil;
            LPH_NO_VIRTUALIZE(function() --[[ Line: 421 ]]
            ...
            local u100 = LPH_JIT_MAX(function(p99) --[[ Line: 454 ]]
                -- upvalues: l__Classes__4 (ref)
            ...
            local u103 = LPH_JIT_MAX(function(p101) --[[ Line: 464 ]]
                -- upvalues: u100 (copy)
            ...
            local u106 = LPH_JIT_MAX(function(p104, p105) --[[ Line: 474 ]]
            ...
            local u109 = LPH_JIT_MAX(function(p107, p108, _) --[[ Line: 484 ]]
                -- upvalues: l__Classes__4 (ref)
                return not l__Classes__4.Util:hasLineOfSight(p107, p108);
            end);
            local u112 = LPH_JIT_MAX(function() --[[ Line: 488 ]]
                ...
                u95 = true;
                u82 = u93;
                l__Promise__1.defer(LPH_JIT_MAX(function() --[[ Line: 492 ]]
            ...
            local u115 = LPH_JIT_MAX(function() --[[ Line: 525 ]]
                ...
                if u82 and not u96 then
                    u96 = true;
                    l__Promise__1.defer(LPH_JIT_MAX(function() --[[ Line: 528 ]]
            ...
            local u117 = LPH_JIT_MAX(function() --[[ Line: 558 ]]
                -- upvalues: l__Classes__4 (ref), u54 (ref)
            ...
            local u127 = LPH_JIT_MAX(function() --[[ Line: 567 ]]
            ...
            local u139 = LPH_JIT_MAX(function(p128) --[[ Line: 615 ]]
            ...
            l__Classes__4.Util:bindRenderStepToTable(u54._x0211cb82d66ed99b, l__Classes__4._x32ae459de0772e82._x8ff5d6204140ad8b + 5, "gun_targetting", LPH_JIT_MAX(function() --[[ Line: 668 ]]
...
function u4._x187df79582936573(u143, u144, p145) --[[ Line: 698 ]]
    ...
    if l__Classes__4._x7058397dabccd000._xbcaafe2ed14862c8 then
        ...
        local u150 = LPH_JIT_MAX(function() --[[ Line: 723 ]]
            ...
            l__Promise__1.delay(u144.shot_time):andThen(LPH_JIT_MAX(function() --[[ Line: 747 ]]
                -- upvalues: l__Classes__4 (ref)
                if l__Classes__4._xd1706540247308ea._x6d87aed2c44a568b == "gun" then
                    l__Classes__4._xd1706540247308ea:_xabcc58e6f4374b9e("melee");
                end;
        ...
        local u152 = u6;
        table.insert(u143._x57f55f05c54c5863, l__RunService__6.Heartbeat:Connect(LPH_NO_VIRTUALIZE(function() --[[ Line: 768 ]]
        ...
        l__Classes__4.Util:bindRenderStepToTable(u143._x57f55f05c54c5863, l__Classes__4._x32ae459de0772e82._x8ff5d6204140ad8b + 1, "gun_viewmodel", LPH_NO_VIRTUALIZE(function() --[[ Line: 780 ]]
        ...
        if v147 <= 0 then
            ...
            v157:andThen(LPH_JIT_MAX(function() --[[ Line: 803 ]]
                -- upvalues: u150 (copy)
                u150();
            end));
            if u5 then
            ...
            u5:andThen(LPH_JIT_MAX(function() --[[ Line: 815 ]]
                -- upvalues: u143 (copy)
                warn("FIRE TIMEOUT");
...
function u4._xa17c0c70a82185fc(u158, u159) --[[ Line: 821 ]]
    ...
    if l__Classes__4._x7058397dabccd000._xbcaafe2ed14862c8 then
        ...
        local u169 = LPH_JIT_MAX(function() --[[ Line: 857 ]]
            ...
            l__Promise__1.defer(LPH_NO_VIRTUALIZE(function() --[[ Line: 894 ]]
                -- upvalues: u158 (ref)
        ...
        if l__tags__33 then
            for v170, _ in l__tags__33 do
                ...
                v171:andThen(LPH_JIT_MAX(function() --[[ Line: 911 ]]
                    -- upvalues: u169 (copy)
                    u169();
                end));
        ...
        local u175 = LPH_NO_VIRTUALIZE(function() --[[ Line: 926 ]]
        ...
        local u176 = nil;
        local u177 = false;
        local u179 = LPH_NO_VIRTUALIZE(function() --[[ Line: 940 ]]
        ...
        if u159.tags.scope then
            ...
            v180:andThen(LPH_NO_VIRTUALIZE(function() --[[ Line: 957 ]]
        ...
        local u186 = LPH_JIT_MAX(function() --[[ Line: 984 ]]
            ...
            u158:_x8a47335f38cccd86("Fire", 1, 1);
            l__Promise__1.delay(u159.shot_time):andThen(LPH_JIT_MAX(function() --[[ Line: 1030 ]]
                -- upvalues: l__Classes__4 (ref)
                if l__Classes__4._xd1706540247308ea._x6d87aed2c44a568b == "gun" then
                    l__Classes__4._xd1706540247308ea:_xabcc58e6f4374b9e("melee");
                end;
        ...
        local u188 = u6;
        table.insert(u158._x57f55f05c54c5863, l__RunService__6.Heartbeat:Connect(LPH_NO_VIRTUALIZE(function() --[[ Line: 1051 ]]
        ...
        l__Classes__4.Util:bindRenderStepToTable(u158._x57f55f05c54c5863, l__Classes__4._x32ae459de0772e82._x8ff5d6204140ad8b + 1, "gun_viewmodel", LPH_NO_VIRTUALIZE(function() --[[ Line: 1065 ]]
            -- upvalues: u175 (copy)
            u175();
        end));
        if v173 <= 0 then
            ...
            v192:andThen(LPH_JIT_MAX(function() --[[ Line: 1082 ]]
                -- upvalues: u186 (copy)
                u186();
            end));
            if u5 then
            ...
            u5:andThen(LPH_JIT_MAX(function() --[[ Line: 1094 ]]
                -- upvalues: u158 (copy)
                warn("FIRE TIMEOUT");
...
function u4._xe53615d96cf36a6b(u205) --[[ Line: 1191 ]]
    ...
    l__Promise__1.defer(LPH_NO_VIRTUALIZE(function() --[[ Line: 1196 ]]
        -- upvalues: u205 (copy)
    ...
    table.insert(u205._x22a4f1cdca62d968, game.Players.LocalPlayer.CharacterAdded:Connect(LPH_NO_VIRTUALIZE(function() --[[ Line: 1202 ]]
        -- upvalues: l__Classes__4 (ref), u205 (copy)
        l__Classes__4._x1ab1568e6fe5e07f:_x8bbde1bc4032804c(u205._x850fb72bedc0eacc, u205._x8703b52a47175c59);
    end)));
    u3 = l__Packets__2._xbfaa5820a4100b86:Fire(u205._x850fb72bedc0eacc);
    task.defer(LPH_JIT_MAX(function() --[[ Line: 1208 ]]
        -- upvalues: u205 (copy)
        u205:_x2245616839d15591();
    end));
    l__Classes__4.Util:bindRenderStepToTable(u205._x22a4f1cdca62d968, l__Classes__4._x32ae459de0772e82._x8ff5d6204140ad8b + 2, "gun_visibility", LPH_NO_VIRTUALIZE(function() --[[ Line: 1212 ]]
        -- upvalues: l__Classes__4 (ref), u205 (copy)
    ...
    task.defer(LPH_JIT_MAX(function() --[[ Line: 1224 ]]
        -- upvalues: u205 (copy), l__Packets__2 (ref), l__Classes__4 (ref)
        table.insert(u205._x22a4f1cdca62d968, l__Packets__2._x75a938726f9fe95f.OnClientEvent:Connect(LPH_JIT_MAX(function() --[[ Line: 1225 ]]
            -- upvalues: u205 (ref)
        ...
        table.insert(l___x22a4f1cdca62d968__41, l__Pressed__42:Connect(LPH_JIT_MAX(function() --[[ Line: 1229 ]]
            -- upvalues: u205 (ref)
        ...
        table.insert(l___x22a4f1cdca62d968__43, l__Pressed__44:Connect(LPH_JIT_MAX(function() --[[ Line: 1233 ]]
