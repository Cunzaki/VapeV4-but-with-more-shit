...
local u22 = {
    level = {
        aggregation = "max",
        getter = function(p10, p11) --[[ Name: getter, Line 59 ]]
        ...
        comparator = function(p13, p14, p15) --[[ Name: comparator, Line 63 ]]
        ...
        raw_comparator = function(p18, p19) --[[ Name: raw_comparator, Line 78 ]]
            for _, v20 in p18 do
                for _, v21 in p19 do
    ...
    never = {
        aggregation = "average",
        getter = function(_, _) --[[ Name: getter, Line 94 ]]
            return 1;
        end,
        comparator = function(_, _, _) --[[ Name: comparator, Line 97 ]]
            return 0;
        end
    },
    always = {
        aggregation = "average",
        getter = function(_, _) --[[ Name: getter, Line 103 ]]
            return 1;
        end,
        comparator = function(_, _, _) --[[ Name: comparator, Line 106 ]]
            return 1;
        end
    }
};
...
local v32 = {
    getDef = function(p26) --[[ Name: getDef, Line 175 ]]
    ...
    getVariable = function(p29) --[[ Name: getVariable, Line 189 ]]
        -- upvalues: u22 (copy)
        local v30 = u22[p29];
    ...
    getAllDefs = function() --[[ Name: getAllDefs, Line 195 ]]
        -- upvalues: u25 (copy)
        return u25;
    end,
    MAXIMUM_SLOT_SIZE = 0
