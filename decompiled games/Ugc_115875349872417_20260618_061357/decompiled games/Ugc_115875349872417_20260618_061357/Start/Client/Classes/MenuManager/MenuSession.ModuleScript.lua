...
local l__InternalSymbols__14 = require(script.Parent.Parent.Parent.InternalSymbols);
    ...
    if u5 then
        ...
        task.spawn(function() --[[ Line: 85 ]]
            ...
            local v7, v8 = pcall(function() --[[ Line: 86 ]]
                ...
                return l__Packets__6._x63ad7818d7c3e77b:Fire();
            end);
            if v7 then
                local v9;
...
function u1.new(p11, p12) --[[ Line: 125 ]]
    -- upvalues: u1 (copy), l__Trove__9 (copy), l__UIAssets__12 (copy), l__Packets__6 (copy), l__Signal__7 (copy), l__CEnum__11 (copy), l__InternalSymbols__14 (copy)
    ...
    l__Packets__6._xee2089b47d2ef51a:Fire();
    u13.onItemProfileUpdated = u13.trove:Construct(l__Signal__7);
    u13.trove:Connect(l__Packets__6._xee2089b47d2ef51a.OnClientEvent, function(p15) --[[ Line: 141 ]]
        -- upvalues: u13 (copy)
    ...
    local v16 = {
        ...
        RETURN = {
            ...
            onPressed = function() --[[ Name: onPressed, Line 270 ]]
                ...
                l__Packets__6._xd5a9d73c53b4d910:Fire({
    ...
    for v26, v27 in pairs(u13.pages) do
        local u28 = l__InternalSymbols__14.owner("MenuPage", v27);
...
function u1.cleanUp(p34) --[[ Line: 386 ]]
    -- upvalues: l__InternalSymbols__14 (copy)
    p34._destroyed = true;
    p34.trove:Clean();
    if p34.spectator_camera then
        l__InternalSymbols__14.owner("SpectatorCamera", p34.spectator_camera):cleanUp();
    end;
    for _, v35 in p34.pages do
        l__InternalSymbols__14.owner("MenuPage", v35):cleanUp();
    end;
end;
function u1.setupCodeScroll(u36) --[[ Line: 398 ]]
    ...
    local u37 = 0;
    u36.trove:Add(l__RunService__1.RenderStepped:Connect(function(p38) --[[ Line: 406 ]]
...
function u1.modifyCodeScroll(u40, u41, u42) --[[ Line: 420 ]]
    -- upvalues: l__Promise__8 (copy), l__RunService__1 (copy), l__Classes__13 (copy)
    local v52 = l__Promise__8.new(function(u43, _, p44) --[[ Line: 421 ]]
        -- upvalues: l__RunService__1 (ref), l__Classes__13 (ref), u42 (copy), u41 (copy), u40 (copy)
        local u45 = os.clock();
        local u46 = nil;
        u46 = l__RunService__1.Heartbeat:Connect(function() --[[ Line: 424 ]]
...
function u1.requestDeploy(p53) --[[ Line: 452 ]]
    ...
    if p53.pagelocked then
        ...
        if v54 < p53.next_deploy_request_at then
            ...
            l__Packets__6._xf2ec37c51f251f47:Fire();
        end;
    end;
end;
function u1.initializeInput(u55) --[[ Line: 466 ]]
    ...
    for _, v56 in u55.nav_buttons do
        ...
        l__inst__22.NavButton.MouseEnter:Connect(function() --[[ Line: 472 ]]
        ...
        l__inst__22.NavButton.MouseLeave:Connect(function() --[[ Line: 475 ]]
            -- upvalues: l__TweenService__2 (ref), l__inst__22 (copy)
            l__TweenService__2:Create(l__inst__22.BodyFrame.ImageLabel, TweenInfo.new(0.5, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {
    ...
    local u58 = {};
    u55.os_ui.HideButton.Activated:Connect(function() --[[ Line: 490 ]]
        -- upvalues: l__Classes__13 (ref), u58 (copy), u55 (copy)
        l__Classes__13._xbe184fb1376a575d:_x7ab8b42cc5920a78("BACK2", true);
        if #u58 == 0 then
...
function u1.initializeVisuals(u61) --[[ Line: 510 ]]
    -- upvalues: l__Classes__13 (copy), l__InternalSymbols__14 (copy)
    local l__YenCount__23 = u61.os_ui.CurrencyLayer.YenFrame.YenCount;
    local u62 = l__Classes__13._x7430d6d194f43373:_x57c044514acd3a73("yen");
    if u62 then
    ...
    u61.trove:Connect(u62.Changed, function() --[[ Line: 531 ]]
    ...
    local u63 = l__Classes__13._x7430d6d194f43373:_x57c044514acd3a73("crimson");
    if u63 then
        u61.trove:Connect(u63.Changed, function() --[[ Line: 547 ]]
        ...
        l__CrimCount__24.Text = l__Classes__13.Util:formatNumber(u63.Value);
        u61.trove:Connect(u61.os_ui.CurrencyLayer.CrimFrame.AddButton.Activated, function() --[[ Line: 555 ]]
            -- upvalues: u61 (copy), l__InternalSymbols__14 (ref)
            if u61.current_page == "shop_page" then
                l__InternalSymbols__14.owner("ShopPage", u61.pages.shop_page):openTab("Deals");
            else
                u61:openPage("shop_page", "Deals");
            end;
        end);
        u61.trove:Connect(l__CrimCount__24.Activated, function() --[[ Line: 563 ]]
            -- upvalues: u61 (copy), l__InternalSymbols__14 (ref)
            if u61.current_page == "shop_page" then
                l__InternalSymbols__14.owner("ShopPage", u61.pages.shop_page):openTab("Deals");
            else
...
function u1.setSidebarMode(p64, p65) --[[ Line: 575 ]]
...
function u1.setDarken(p66, p67) --[[ Line: 590 ]]
    -- upvalues: l__TweenService__2 (copy)
...
function u1._localPlayerIsInLobby(p68) --[[ Line: 600 ]]
...
function u1._canOpenPage(p72, p73) --[[ Line: 621 ]]
    -- upvalues: u2 (copy)
    return not p72:_localPlayerIsInLobby() and true or u2[p73] == true;
end;
function u1.openPage(u74, u75, ...) --[[ Line: 629 ]]
    -- upvalues: l__Classes__13 (copy), l__TweenService__2 (copy), u3 (copy), l__InternalSymbols__14 (copy)
    ...
    if not u74._intialized then
        local u76 = { ... };
        local u77 = select("#", ...);
        table.insert(u74.queued_operations, function() --[[ Line: 637 ]]
    ...
    if u74.current_page ~= u75 then
        ...
        l__Classes__13._xbe184fb1376a575d:_x7ab8b42cc5920a78("BACK1", true);
    end;
    ...
    local v80 = l__InternalSymbols__14.owner("MenuPage", u74.pages[u75]);
    local v81 = v80:start(...);
    local l__current_page__30 = u74.current_page;
    u74.current_page = u75;
    if l__current_page__30 and l__current_page__30 ~= u75 then
        local v82 = l__InternalSymbols__14.owner("MenuPage", u74.pages[l__current_page__30]);
        if v82 then
            v82:close();
        else
...
function u1._setupMidframe(p83) --[[ Line: 700 ]]
...
function u1.finalizeQueueCart(p85, p86) --[[ Line: 708 ]]
    p85.queue_cart = p86;
    if p85.midframe_renderer then
        p85.midframe_renderer:_updateGamemodeLabel();
    end;
end;
function u1.setPagelocked(p87, p88) --[[ Line: 716 ]]
    p87.pagelocked = p88;
end;
function u1.setNotifyVisible(p89, p90, p91) --[[ Line: 720 ]]
...
function u1.start(u96, p97) --[[ Line: 745 ]]
    ...
    if l__Classes__13._xd0d75b75975ea69f then
        l__Classes__13._xd0d75b75975ea69f:_xfbe5ecce6cf9cb86(u96.os_ui.RightContainer.MainOS.NotificationList, true);
    end;
    if l__Classes__13._xafc4950d7b094088 then
        l__Classes__13._xafc4950d7b094088:_x2d147abfc340ba12();
    end;
    if u96.midframe_renderer and u96.midframe_renderer._client then
        u96.trove:Connect(u96.midframe_renderer._client.partyChanged, function() --[[ Line: 769 ]]
    ...
    if v98 then
        task.delay(1, function() --[[ Line: 811 ]]
            -- upvalues: u96 (copy)
