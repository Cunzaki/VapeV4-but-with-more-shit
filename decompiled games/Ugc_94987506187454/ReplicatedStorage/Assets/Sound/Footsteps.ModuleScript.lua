-- Decompiled from: ReplicatedStorage.Assets.Sound.Footsteps
-- Class: ModuleScript
...
u1.MaterialMap = {
    [Enum.Material.Slate] = u1.SoundIds.Concrete,
    [Enum.Material.Concrete] = u1.SoundIds.Concrete,
    [Enum.Material.Brick] = u1.SoundIds.Concrete,
    [Enum.Material.Cobblestone] = u1.SoundIds.Concrete,
    [Enum.Material.Sandstone] = u1.SoundIds.Concrete,
    [Enum.Material.Rock] = u1.SoundIds.Concrete,
    [Enum.Material.Basalt] = u1.SoundIds.Concrete,
    [Enum.Material.CrackedLava] = u1.SoundIds.Concrete,
    [Enum.Material.Asphalt] = u1.SoundIds.Concrete,
    [Enum.Material.Limestone] = u1.SoundIds.Concrete,
    [Enum.Material.Pavement] = u1.SoundIds.Concrete,
    [Enum.Material.Plastic] = u1.SoundIds.Tile,
    [Enum.Material.Marble] = u1.SoundIds.Tile,
    [Enum.Material.Neon] = u1.SoundIds.Tile,
    [Enum.Material.Granite] = u1.SoundIds.Tile,
    [Enum.Material.Wood] = u1.SoundIds.Rubber,
    [Enum.Material.WoodPlanks] = u1.SoundIds.Wood,
    [Enum.Material.CorrodedMetal] = u1.SoundIds.Metal_Solid,
    [Enum.Material.DiamondPlate] = u1.SoundIds.Metal_Solid,
    [Enum.Material.Metal] = u1.SoundIds.Metal_Solid,
    [Enum.Material.Foil] = u1.SoundIds.Metal_Grate,
    [Enum.Material.Ground] = u1.SoundIds.Dirt,
    [Enum.Material.Grass] = u1.SoundIds.Grass,
    [Enum.Material.LeafyGrass] = u1.SoundIds.Grass,
    [Enum.Material.Fabric] = u1.SoundIds.Carpet,
    [Enum.Material.Carpet] = u1.SoundIds.Carpet,
    [Enum.Material.Pebble] = u1.SoundIds.Gravel,
    [Enum.Material.Snow] = u1.SoundIds.Snow,
    [Enum.Material.Sand] = u1.SoundIds.Sand,
    [Enum.Material.Salt] = u1.SoundIds.Sand,
    [Enum.Material.Ice] = u1.SoundIds.Glass,
    [Enum.Material.Glacier] = u1.SoundIds.Glass,
    [Enum.Material.Glass] = u1.SoundIds.Glass,
    [Enum.Material.SmoothPlastic] = u1.SoundIds.Rubber,
    [Enum.Material.ForceField] = u1.SoundIds.Rubber,
    [Enum.Material.Mud] = u1.SoundIds.Mud
};
function u1.CreateSoundGroup(_, p2, p3, p4, p5) --[[ Line: 320 ]]
    -- upvalues: u1 (copy)
    if not p2 then
        warn("Parent not specified, Footstep folder parented to workspace");
    end;
    local v6 = p5 or false;
    local v7 = p4 or {};
    local v8 = p2 or workspace;
    local v9;
    if v6 then
        v9 = Instance.new("Folder");
        v9.Name = p3 or "Footsteps";
    else
        v9 = Instance.new("SoundGroup");
        v9.Volume = 1;
        v9.Name = p3 or "Footsteps";
    end;
    for v10, v11 in pairs(u1.SoundIds) do
        local v12 = 0;
        local v13;
        if v6 then
        ...
        for _, v14 in pairs(v11) do
            ...
            v15.Name = string.format("%s_%02i", v10:lower(), v12);
            if not v6 then
                v15.SoundGroup = v13;
            end;
...
function u1.GetTableFromMaterial(_, p18) --[[ Line: 363 ]]
    -- upvalues: u1 (copy)
    if typeof(p18) == "string" then
        p18 = Enum.Material[p18];
    end;
    return u1.MaterialMap[p18];
end;
function u1.GetRandomSound(_, p19) --[[ Line: 371 ]]
    return p19[math.random(#p19)];
end;
return u1;
