-- Decompiled from: StarterPlayer.StarterPlayerScripts.PlayerModule.ControlModule.VehicleController
-- Class: ModuleScript
...
function u1.BindContextActions(u4) --[[ Line: 50 ]]
    -- upvalues: l__ContextActionService__1 (copy)
    l__ContextActionService__1:BindActionAtPriority("throttleAccel", function(p5, p6, p7) --[[ Line: 52 ]]
        -- upvalues: u4 (copy)
        u4:OnThrottleAccel(p5, p6, p7);
        return Enum.ContextActionResult.Pass;
    end, false, u4.CONTROL_ACTION_PRIORITY, Enum.KeyCode.ButtonR2);
    l__ContextActionService__1:BindActionAtPriority("throttleDeccel", function(p8, p9, p10) --[[ Line: 56 ]]
        -- upvalues: u4 (copy)
        u4:OnThrottleDeccel(p8, p9, p10);
        return Enum.ContextActionResult.Pass;
    end, false, u4.CONTROL_ACTION_PRIORITY, Enum.KeyCode.ButtonL2);
    l__ContextActionService__1:BindActionAtPriority("arrowSteerRight", function(p11, p12, p13) --[[ Line: 61 ]]
        -- upvalues: u4 (copy)
        u4:OnSteerRight(p11, p12, p13);
        return Enum.ContextActionResult.Pass;
    end, false, u4.CONTROL_ACTION_PRIORITY, Enum.KeyCode.Right);
    l__ContextActionService__1:BindActionAtPriority("arrowSteerLeft", function(p14, p15, p16) --[[ Line: 65 ]]
        -- upvalues: u4 (copy)
        u4:OnSteerLeft(p14, p15, p16);
        return Enum.ContextActionResult.Pass;
    end, false, u4.CONTROL_ACTION_PRIORITY, Enum.KeyCode.Left);
end;
function u1.Enable(p17, p18, p19) --[[ Line: 71 ]]
    -- upvalues: l__ContextActionService__1 (copy)
...
function u1.OnThrottleAccel(p20, _, p21, _) --[[ Line: 97 ]]
...
function u1.OnThrottleDeccel(p22, _, p23, _) --[[ Line: 106 ]]
...
function u1.OnSteerRight(p24, _, p25, _) --[[ Line: 115 ]]
...
function u1.OnSteerLeft(p26, _, p27, _) --[[ Line: 124 ]]
...
function u1.Update(p28, p29, p30, _) --[[ Line: 134 ]]
