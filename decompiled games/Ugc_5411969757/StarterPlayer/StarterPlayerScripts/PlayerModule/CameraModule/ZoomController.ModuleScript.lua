-- Decompiled from: StarterPlayer.StarterPlayerScripts.PlayerModule.CameraModule.ZoomController
-- Class: ModuleScript
...
local u4 = {};
u4.__index = u4;
function u4.new(p5, p6, p7, p8) --[[ Line: 36 ]]
...
function u4.Step(p10, p11) --[[ Line: 48 ]]
...
local u19 = 0;
return {
    Update = function(p20, p21, p22) --[[ Name: Update, Line 97 ]]
        ...
        if u18.goal > 1 then
            ...
            local v24 = u19;
            local v25 = u1;
            local v26 = l__clamp__2(l__goal__13 + v24 * (1 + l__goal__13 * 0.0375), v25, u2);
    ...
    SetZoomParameters = function(p28, p29) --[[ Name: SetZoomParameters, Line 121 ]]
