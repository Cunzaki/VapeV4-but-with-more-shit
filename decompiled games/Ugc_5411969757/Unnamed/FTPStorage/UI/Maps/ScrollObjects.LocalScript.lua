-- Decompiled from: .FTPStorage.UI.Maps.ScrollObjects
-- Class: LocalScript
...
local function u2() --[[ Line: 11 ]]
    ...
    local v1 = (l__ScrollingFrame__1.AbsoluteSize.X - 15) * 0.95 / l__UIGridLayout__3.FillDirectionMaxCells;
    l__UIGridLayout__3.CellSize = l__new__2(0, v1, 0, v1 / 3);
