-- Decompiled from: .FTPStorage.UI.Maps.MapsController
-- Class: LocalScript
...
local function u13() --[[ Line: 53 ]]
    -- upvalues: u3 (ref), l__GameInfo__7 (copy), l__FrameBase__11 (copy), l__new__9 (copy), l__Maps__10 (copy), u1 (copy), l__ScrollingFrame__8 (copy), l__MouseoverEffect__14 (copy), u2 (ref)
    if script:FindFirstChild("FramesCreated") == nil then
        ...
        for v5, v6 in pairs(l__GameInfo__7.Maps_info) do
            ...
            u7.MainButton.MouseButton1Down:connect(function() --[[ Line: 80 ]]
                ...
                if u2 ~= nil then
                    local v9 = u2:FindFirstChild("Selected");
                    if v9 ~= nil then
                        v9:Destroy();
                    end;
                end;
            ...
            for _, v10 in pairs(l__ScrollingFrame__8:GetChildren()) do
                if v10:IsA("Frame") and v10:FindFirstChild("MainButton") then
                    ...
                    u11.MouseButton1Down:connect(function() --[[ Line: 102 ]]
                        ...
                        if u2 ~= nil then
                            local v12 = u2:FindFirstChild("Selected");
                            if v12 ~= nil then
                                v12:Destroy();
                            end;
                        end;
...
l__Buttons__5.Start.MouseButton1Down:connect(function() --[[ Line: 172 ]]
    ...
    if u2 ~= nil then
        local v16 = u2:FindFirstChild("ObjectName");
        if v16 ~= nil then
