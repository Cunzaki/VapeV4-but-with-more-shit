-- Decompiled from: Start.Client._x2b906ae2e36ce06d
-- Class: ModuleScript
-- Place: Ugc (115875349872417)

-- Decompiled with Potassium's decompiler.

local function u102(p1, p2) --[[ Line: 62 ]]
...
local u104 = {};
local function u108(p105, p106) --[[ Line: 231 ]]
    -- upvalues: u102 (copy)
    if p105 == nil then
...
local function u228(p114, p115) --[[ Line: 280 ]]
...
local function u234(p229, p230, p231) --[[ Line: 351 ]]
...
function u104._x748a73ba3f41e211(p235, p236, p237, p238, p239) --[[ Line: 372 ]]
...
function u104._xd45afee96b5bee0a(p261, p262, p263) --[[ Line: 486 ]]
    -- upvalues: u103 (copy), u111 (copy)
    if p261 == nil then
        error("Key cannot be nil", 2);
    end;
...
function u104._x310401f3b6df0608(p352, p353, p354, p355, p356) --[[ Line: 619 ]]
    -- upvalues: u104 (copy)
    if p354 == nil then
        error("Nonce cannot be nil", 2);
    end;
    ...
    local l___xd45afee96b5bee0a__1 = u104._xd45afee96b5bee0a;
    local v358 = buffer.create(16);
    buffer.copy(v358, 0, p354, 0, 16);
    local v359 = l___xd45afee96b5bee0a__1(p353, v358, p356);
    local v360 = buffer.create(12);
    buffer.copy(v360, 4, p354, 16, 8);
    return u104._x748a73ba3f41e211(p352, v359, v360, p355, p356);
end;
local v361 = {
    ChaCha20 = u104._x748a73ba3f41e211,
    XChaCha20 = u104._x310401f3b6df0608,
    Poly1305 = u108
};
local function u370(p362, p363) --[[ Line: 666 ]]
...
local function u381(p371, p372) --[[ Line: 684 ]]
...
function v361._x6fd04ca854e4997a(p382, p383, p384, p385, p386, p387) --[[ Line: 712 ]]
    ...
    local v395;
    if p387 then
        v395 = u104._x310401f3b6df0608;
    else
        v395 = u104._x748a73ba3f41e211;
    end;
    local v396 = v395(v394, p383, p384, 0, v393);
    local v397;
    if p387 then
        v397 = u104._x310401f3b6df0608;
    else
        v397 = u104._x748a73ba3f41e211;
    end;
    local v398 = v397(p382, p383, p384, 1, v391);
    return v398, u108(u381(v392, v398), v396);
end;
function v361._x59e0c6087ac2bd98(p399, p400, p401, p402, p403, p404, p405) --[[ Line: 784 ]]
    ...
    local v414;
    if p405 then
        v414 = u104._x310401f3b6df0608;
    else
        v414 = u104._x748a73ba3f41e211;
    end;
    ...
    local v416;
    if p405 then
        v416 = u104._x310401f3b6df0608;
    else
        v416 = u104._x748a73ba3f41e211;
    end;
