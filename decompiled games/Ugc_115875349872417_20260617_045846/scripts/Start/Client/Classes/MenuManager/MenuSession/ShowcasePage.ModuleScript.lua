...
local l___x7749231778538ccb__14 = require(script.Parent.Parent.Parent.Parent._x7749231778538ccb);
...
local u24 = {
    start_down = {
        begin = function(p6) --[[ Name: begin, Line 78 ]]
            -- upvalues: l___x7749231778538ccb__14 (copy), l__Classes__13 (copy)
            l___x7749231778538ccb__14._xd644d9e3ba63f27f("ShowcasePage", p6).camera_intro_elapsed = 0;
            l__Classes__13._x181e05d210129765:_x8239642d092b6a2d();
        end,
        update = function(p7, p8, p9) --[[ Name: update, Line 84 ]]
            -- upvalues: l___x7749231778538ccb__14 (copy)
            local v10 = l___x7749231778538ccb__14._xd644d9e3ba63f27f("ShowcasePage", p7);
    ...
    extract = {
        begin = function(p14) --[[ Name: begin, Line 100 ]]
            -- upvalues: l___x7749231778538ccb__14 (copy), l__Classes__13 (copy), u3 (copy), l__TweenService__1 (copy), u2 (copy), l__Lighting__4 (copy), u4 (copy)
            local u15 = l___x7749231778538ccb__14._xd644d9e3ba63f27f("ShowcasePage", p14);
            ...
            l__Classes__13._x3019cc5b1f776551._x38a4648a006d6ac6 = 0;
            local v17 = l__Classes__13._x6dbba03a0636f7d8:_x282746dbf42c87cb("BUILD_UP");
            ...
            u15:_scheduleExtractIntro(l__extract_intro_run_id__15, v18 - 1.15, function() --[[ Line: 136 ]]
                ...
                u15.extract_intro_windup_sound = l__Classes__13._x6dbba03a0636f7d8:_x282746dbf42c87cb("EXTRACT_WINDUP", true);
            end);
            if u16 == "Classified" then
                u15:_scheduleExtractIntro(l__extract_intro_run_id__15, v18 - 0.69, function() --[[ Line: 141 ]]
                    ...
                    l__Classes__13._x6dbba03a0636f7d8:_x282746dbf42c87cb("DNB_BUILDUP", true);
                end);
            end;
            u15:_scheduleExtractIntro(l__extract_intro_run_id__15, v18, function() --[[ Line: 146 ]]
                ...
                if u16 == "Exotic" then
                    l__Classes__13._x6dbba03a0636f7d8:_x282746dbf42c87cb("GLIMMER2", true);
                    l__Classes__13._x6dbba03a0636f7d8:_x282746dbf42c87cb("IMPACT_MORE", true);
                elseif u16 == "Elite" then
                    l__Classes__13._x6dbba03a0636f7d8:_x282746dbf42c87cb("IMPACT_MORE", true);
                else
                    l__Classes__13._x6dbba03a0636f7d8:_x282746dbf42c87cb("IMPACT", true);
                end;
                l__Classes__13._x6dbba03a0636f7d8:_x282746dbf42c87cb("TELEPORT_DRAMATIC", true);
                if u16 then
                ...
                l__Classes__13._x181e05d210129765:_x4d70b7dadc9e06ab(0.5, 3);
                ...
                v22:Play();
                l__Classes__13._x3019cc5b1f776551._x38a4648a006d6ac6 = 0.8;
                ...
                if u16 == "Classified" then
                    l__Classes__13._x6dbba03a0636f7d8:_x282746dbf42c87cb("VICTORY", true);
                    l__Classes__13._x6dbba03a0636f7d8:_x282746dbf42c87cb("RESULT", true);
                end;
...
function u1.new(p112, p113) --[[ Line: 675 ]]
    -- upvalues: u1 (copy), l___x7749231778538ccb__14 (copy), l__UIAssets__12 (copy), l__Trove__10 (copy)
    local v114 = setmetatable({}, u1);
    v114.menu_session = l___x7749231778538ccb__14._xd644d9e3ba63f27f("MenuSession", p113);
    v114.parent_os = p112;
...
function u1._openRevealBannerPreview(p162) --[[ Line: 886 ]]
    ...
    if p162:_shouldShowRevealInfoButton() then
        local l___xd644d9e3ba63f27f__28 = l___x7749231778538ccb__14._xd644d9e3ba63f27f;
        ...
        local v164 = l___xd644d9e3ba63f27f__28(v163, l__menu_session__29 and l__menu_session__29.obj or nil);
        ...
        if l__selected_slot__30 and l__selected_slot__30.revealed == true then
            if typeof(p165.reveal_banner_id) == "string" and p165.reveal_banner_id ~= "" then
                if typeof(p165.reveal_source_currency) == "string" and p165.reveal_source_currency ~= "" then
                    local l___xd644d9e3ba63f27f__31 = l___x7749231778538ccb__14._xd644d9e3ba63f27f;
                    ...
                    local v167 = l___xd644d9e3ba63f27f__31(v166, l__menu_session__32 and l__menu_session__32.obj or nil);
...
function u1._renderRevealExtractButton(u168, p169) --[[ Line: 925 ]]
    -- upvalues: l__UIAssets__12 (copy), l___x7749231778538ccb__14 (copy)
    ...
    u168.action_trove:Connect(v179.Activated, function() --[[ Line: 957 ]]
        -- upvalues: l___x7749231778538ccb__14 (ref), u168 (copy), u170 (copy)
        local l___xd644d9e3ba63f27f__35 = l___x7749231778538ccb__14._xd644d9e3ba63f27f;
        ...
        local v181 = l___xd644d9e3ba63f27f__35(v180, l__menu_session__36 and l__menu_session__36.obj or nil);
...
function u1._renderBannerPreviewPurchaseButtons(u184, p185) --[[ Line: 979 ]]
    -- upvalues: l___x7749231778538ccb__14 (copy), l__UIAssets__12 (copy)
    ...
    local l___xd644d9e3ba63f27f__39 = l___x7749231778538ccb__14._xd644d9e3ba63f27f;
    ...
    local v187 = l___xd644d9e3ba63f27f__39(v186, l__menu_session__40 and l__menu_session__40.obj or nil);
        ...
        if v195 then
            ...
            if v209 then
                u184.action_trove:Connect(v209.Activated, function() --[[ Line: 1070 ]]
                    -- upvalues: l___x7749231778538ccb__14 (ref), u184 (copy), u194 (copy)
                    local l___xd644d9e3ba63f27f__45 = l___x7749231778538ccb__14._xd644d9e3ba63f27f;
                    ...
                    local v212 = l___xd644d9e3ba63f27f__45(v211, l__menu_session__46 and l__menu_session__46.obj or nil);
...
function u1._applyEquippedSkin(p234, p235, p236) --[[ Line: 1266 ]]
    ...
    l__Classes__13._x6dbba03a0636f7d8:_x282746dbf42c87cb("BULLET_GAINED", true);
    l__Classes__13._x6dbba03a0636f7d8:_x282746dbf42c87cb("TAPE_MOVE", true);
    p234:_updateActions();
end;
            ...
            if v239 == "skin" then
                ...
                if typeof(l__item_id__54) == "string" and typeof(l__skin_id__55) == "number" then
                    if l__selected_slot__52.equipped == true then
                        ...
                        l__Packets__8._x0718de96fcdbb2cb:Fire(l__item_id__54, l__skin_id__55);
...
function u1._onRevealSlotTick(_, _, _) --[[ Line: 1701 ]]
    ...
    l__Classes__13._x6dbba03a0636f7d8:_x282746dbf42c87cb("SLOT_TICK", true);
end;
...
function u1._updateScene(p476, p477) --[[ Line: 2322 ]]
    ...
    if l__CurrentCamera__95 then
        if l__Classes__13._xdca80115d2839102 then
            l__Classes__13._xdca80115d2839102._x711166f3dabb680d = true;
        end;
...
function u1._startCameraOverride(u484) --[[ Line: 2371 ]]
    ...
    if l__CurrentCamera__96 then
        local l___xb6e091f68afb5ee8__97 = l__Classes__13._xb6e091f68afb5ee8;
        local v485;
        if l___xb6e091f68afb5ee8__97 then
            v485 = l___xb6e091f68afb5ee8__97._x1183cbeaf44ac72d or nil;
        else
            v485 = nil;
        end;
        local v486 = false;
        if l___xb6e091f68afb5ee8__97 and l___xb6e091f68afb5ee8__97._x11bab4bb7fbe5abf then
            v486 = l___xb6e091f68afb5ee8__97:_x11bab4bb7fbe5abf();
        elseif l___xb6e091f68afb5ee8__97 and (l___xb6e091f68afb5ee8__97._xd5f26d793f25fa67 == true and l__Classes__13.Util) then
            l__Classes__13.Util:unbindFromRenderStep("SpectatorCam");
            l___xb6e091f68afb5ee8__97._xc3594590660ea585 = nil;
            l___xb6e091f68afb5ee8__97._xd5f26d793f25fa67 = false;
            v486 = true;
        end;
        u484.previous_camera_state = {
            ...
            camera_paused = l__Classes__13._xdca80115d2839102 and l__Classes__13._xdca80115d2839102._x711166f3dabb680d or false,
        ...
        u484.scene_trove:Add(function() --[[ Line: 2418 ]]
            ...
            if l__CurrentCamera__98 and l__previous_camera_state__99 then
                ...
                u484.sway_goal = 0;
                u484.sway_z_goal = 0;
                if l__previous_camera_state__99.spectator_was_running and l__Classes__13._xb6e091f68afb5ee8 then
                    if l__Classes__13._xb6e091f68afb5ee8._x991ac628e05c66da then
                        l__Classes__13._xb6e091f68afb5ee8:_x991ac628e05c66da(l__previous_camera_state__99.spectator_target);
                    else
                        l__Classes__13._xb6e091f68afb5ee8:_xba28441e0836bc41(false, l__previous_camera_state__99.spectator_target);
                    end;
                else
                    if l__Classes__13._xdca80115d2839102 then
                        l__Classes__13._xdca80115d2839102._x711166f3dabb680d = l__previous_camera_state__99.camera_paused;
                    end;
...
function u1.close(u499) --[[ Line: 2554 ]]
    ...
    l__Classes__13._x181e05d210129765:_xd1a3fdca8881ce73();
