...
function u1.new(p2, p3) --[[ Line: 28 ]]
    -- upvalues: u1 (copy), l___x7749231778538ccb__8 (copy), l__UIAssets__6 (copy), l__Trove__5 (copy)
    local v4 = setmetatable({}, u1);
    v4.menu_session = l___x7749231778538ccb__8._xd644d9e3ba63f27f("MenuSession", p3);
    v4.parent_os = p2;
    ...
    if u15 then
        ...
        local function v20() --[[ Line: 127 ]]
            ...
            u17 = l__TextLabel__19.MouseButton1Click:Connect(function() --[[ Line: 139 ]]
                ...
                u17:Disconnect();
                l__Classes__7._x6dbba03a0636f7d8:_x282746dbf42c87cb("TAPE_MOVE", true);
                l__TextLabel__19.Text = "CANCELLING...";
                l__TextLabel__19.BackgroundTransparency = 1;
                l__TextLabel__19.TextColor3 = Color3.fromRGB(141, 141, 141);
                l__Packets__3._x7f478f00464c302e:Fire(u15.entry_userid);
        ...
        local function v25() --[[ Line: 177 ]]
            ...
            u22 = l__TextLabel__18.MouseButton1Click:Connect(function() --[[ Line: 194 ]]
                ...
                l__TextLabel__18.BackgroundTransparency = 1;
                l__TextLabel__18.TextColor3 = Color3.fromRGB(141, 141, 141);
                l__Packets__3._x1761e6dc6421b5f7:Fire(u15.entry_userid);
...
function u1._refreshDuelList(p36) --[[ Line: 337 ]]
    ...
    local l___x04513e3b388a13df__23 = l__Classes__7._x8399b2bb73e12808._x04513e3b388a13df;
    local function v40(p37, p38) --[[ Line: 352 ]]
    ...
    table.sort(v41, function(p46, p47) --[[ Line: 369 ]]
        -- upvalues: u42 (copy), l___x04513e3b388a13df__23 (copy)
        local v48 = u42[p46.state] or (1 / 0);
        local v49 = u42[p47.state] or (1 / 0);
        if v48 == v49 then
            return math.abs(p46.level - l___x04513e3b388a13df__23) < math.abs(p47.level - l___x04513e3b388a13df__23);
        else
            return v48 < v49;
        end;
    end);
...
function u1._setupDuelEntry(u52, p53) --[[ Line: 402 ]]
    ...
    elseif tonumber(l__Name__27) == l__UserId__12 then
        ...
        if v55 then
            ...
            task.spawn(function() --[[ Name: setupFromReadableFolder, Line 443 ]]
                ...
                if u59 then
                    ...
                    local function u61(p60) --[[ Line: 464 ]]
                    ...
                    task.spawn(function() --[[ Line: 451 ]]
                        ...
                        if u63 then
                            local v64 = u63.Changed:Connect(function() --[[ Line: 455 ]]
                    ...
                    local function u66(p65) --[[ Line: 469 ]]
                        -- upvalues: u54 (ref)
                    ...
                    task.spawn(function() --[[ Line: 451 ]]
                        ...
                        if u68 then
                            local v69 = u68.Changed:Connect(function() --[[ Line: 455 ]]
                    ...
                    local function u73(p70) --[[ Line: 473 ]]
                    ...
                    task.spawn(function() --[[ Line: 451 ]]
                        ...
                        if u75 then
                            local v76 = u75.Changed:Connect(function() --[[ Line: 455 ]]
            ...
            warn("NO SUCH PLAYER IN THE SERVER :", l__Name__27);
        end;
    end;
end;
function u1.Init(u78) --[[ Line: 504 ]]
    ...
    u78.trove:Add(l__DuelRequests__10.ChildAdded:Connect(function(u81) --[[ Line: 520 ]]
        -- upvalues: u78 (copy)
    ...
    u78.trove:Add(l__DuelPresence__9.ChildAdded:Connect(function(u82) --[[ Line: 528 ]]
        -- upvalues: u78 (copy)
        if u82:IsA("Folder") then
            task.spawn(function() --[[ Line: 530 ]]
    ...
    u78.trove:Add(l__ServerRegion__30.Changed:Connect(function() --[[ Line: 539 ]]
        -- upvalues: l__main_page__29 (copy), l__ServerRegion__30 (copy)
        l__main_page__29.Borders.PresenceList.Bottomline1.Text = "REGION: " .. l__ServerRegion__30.Value;
    end));
    u78.trove:Add(l__Classes__7._x8399b2bb73e12808:_x9ccd957f12430c82("pingChanged"):Connect(function(p83) --[[ Line: 543 ]]
        -- upvalues: l__main_page__29 (copy)
        l__main_page__29.Borders.PresenceList.Bottomline2.Text = "PING: " .. math.floor(p83 * 1000) .. "ms";
    end));
    local v84 = l__Classes__7._x8399b2bb73e12808:_xe7f02e22353709c3("casual_duel_winstreak");
    if v84 then
    ...
    l__Button__32.MouseButton1Click:Connect(function() --[[ Line: 557 ]]
        -- upvalues: u78 (copy)
        u78.menu_session:requestDeploy();
    end);
    l__Button__32.MouseEnter:Connect(function() --[[ Line: 561 ]]
    ...
    l__Button__32.MouseLeave:Connect(function() --[[ Line: 567 ]]
        -- upvalues: l__TweenService__1 (ref), l__Frame__31 (copy)
