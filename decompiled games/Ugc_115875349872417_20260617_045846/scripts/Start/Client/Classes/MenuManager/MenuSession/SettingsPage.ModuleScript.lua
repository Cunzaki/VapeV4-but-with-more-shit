...
local l___x7749231778538ccb__7 = require(script.Parent.Parent.Parent.Parent._x7749231778538ccb);
local l__LocalPlayer__8 = game.Players.LocalPlayer;
function u1.new(p2, p3) --[[ Line: 25 ]]
    -- upvalues: u1 (copy), l___x7749231778538ccb__7 (copy), l__Trove__4 (copy), l__UIAssets__5 (copy)
    local v4 = setmetatable({}, u1);
    v4.menu_session = l___x7749231778538ccb__7._xd644d9e3ba63f27f("MenuSession", p3);
    v4.parent_os = p2;
...
function u1.saveChanges(p5) --[[ Line: 42 ]]
    ...
    if p5.config and not p5.saved then
        p5.saved = true;
        l__Classes__6._xcc1d26f1d7ab7ac2:_xa9e43af7dbc27298();
        l__Classes__6._xcc1d26f1d7ab7ac2:_x311cb8a4b6f24c96();
    end;
end;
...
function u1.start(p8) --[[ Line: 65 ]]
    -- upvalues: l__LocalPlayer__8 (copy), l__TweenService__1 (copy)
    if p8.config then
        p8.saved = false;
        ...
        warn("SETTINGS NOT FOUND FOR PLAYER : ", l__LocalPlayer__8);
    end;
end;
function u1.Init(u9) --[[ Line: 94 ]]
    ...
    local v10 = l__Classes__6._xcc1d26f1d7ab7ac2:_x32846173efb1c157();
    if v10 then
        u9.config = v10;
        ...
        local function v16(u11) --[[ Line: 108 ]]
            ...
            local function u15(p13) --[[ Line: 124 ]]
                ...
                if not p13 then
                    l__Classes__6._x6dbba03a0636f7d8:_x282746dbf42c87cb("TAPE_MOVE", true);
                end;
            end;
        ...
        local function v34(u24) --[[ Line: 185 ]]
            ...
            local u26 = l__Classes__6._xf1ad98d2d70b7408:_x9afb0bbcc2b58dcd(Enum.KeyCode[u24.value]);
        ...
        v16({
            ...
            onInteract = function(p46) --[[ Name: onInteract, Line 350 ]]
                ...
                l__Classes__6._x181e05d210129765:_x30accd53c498f58e(p46);
        ...
        v16({
            ...
            onInteract = function(p52) --[[ Name: onInteract, Line 411 ]]
                -- upvalues: l__Classes__6 (ref), u9 (copy)
                l__Classes__6._x3019cc5b1f776551._x81af12119ee977ea = p52;
            ...
            if u56 == "empty" then
                ...
                v34({
                    ...
                    parseKeycode = function(p58) --[[ Name: parseKeycode, Line 460 ]]
                        ...
                        local v59 = l__Classes__6._xf1ad98d2d70b7408:_x112ee96acc25a960(p58);
                        if l__Classes__6._xf1ad98d2d70b7408:_x699126f0fae5b271(u56:upper(), v59) then
                            l__keybinds__23[u56] = v59.Name;
                            return l__Classes__6._xf1ad98d2d70b7408:_x9afb0bbcc2b58dcd(v59);
                        end;
        ...
        local function v73(u60, u61) --[[ Line: 478 ]]
            ...
            local function u68(p64) --[[ Line: 482 ]]
                ...
                if not p64 then
                    l__Classes__6._x6dbba03a0636f7d8:_x282746dbf42c87cb("TAPE_SELECT", true);
                end;
                local v65 = 0;
