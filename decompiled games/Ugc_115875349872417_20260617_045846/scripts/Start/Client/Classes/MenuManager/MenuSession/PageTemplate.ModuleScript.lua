...
local l___x7749231778538ccb__3 = require(script.Parent.Parent.Parent.Parent._x7749231778538ccb);
local _ = game.Players.LocalPlayer;
function u1.new(p2, p3) --[[ Line: 25 ]]
    -- upvalues: u1 (copy), l___x7749231778538ccb__3 (copy), l__Trove__2 (copy)
    local v4 = setmetatable({}, u1);
    v4.menu_session = l___x7749231778538ccb__3._xd644d9e3ba63f27f("MenuSession", p3);
    v4.parent_os = p2;
