...
local u5 = {
    ...
    },
    {
        ...
        onEnter = function() --[[ Name: onEnter, Line 65 ]]
            ...
            l__Packets__4._xd107c8ee5ed343a1:Fire({
...
function u1.new(p6, p7) --[[ Line: 100 ]]
    -- upvalues: u1 (copy), l___x7749231778538ccb__11 (copy), l__Trove__5 (copy), l__UIAssets__8 (copy)
    local v8 = setmetatable({}, u1);
    v8.menu_session = l___x7749231778538ccb__11._xd644d9e3ba63f27f("MenuSession", p7);
    v8.parent_os = p6;
...
function u1._activateDirectJoinTemplate(_, p9) --[[ Line: 120 ]]
    ...
    if u4 then
        ...
        if p9.container_type == "match" then
            l__Packets__4._xb0f5f2d2d71ad910:Fire({
        ...
        elseif u56.container_type == "queue" then
            ...
            local function v67() --[[ Line: 484 ]]
                ...
                elseif u57.is_queued then
                    ...
                    l__Classes__10._x6dbba03a0636f7d8:_x282746dbf42c87cb("PULL_SWITCH", true);
                else
...
function u1.Init(u78) --[[ Line: 562 ]]
    ...
    if v79 and v79:IsA("GuiButton") then
        u78.trove:Connect(v79.Activated, function() --[[ Line: 579 ]]
            ...
            l__Packets__4._xa873db53beaadf6d:Fire("CREATE");
        end);
    else
