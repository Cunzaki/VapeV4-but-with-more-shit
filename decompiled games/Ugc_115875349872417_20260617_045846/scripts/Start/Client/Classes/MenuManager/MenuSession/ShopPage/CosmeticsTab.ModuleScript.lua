...
local l___x7749231778538ccb__14 = require(script.Parent.Parent.Parent.Parent.Parent._x7749231778538ccb);
local u2 = {
    Exotic = {
...
function u1.new(p62, p63) --[[ Line: 364 ]]
    -- upvalues: u1 (copy), l__Trove__11 (copy), l___x7749231778538ccb__14 (copy), l__UIAssets__12 (copy)
    ...
    v64._menu_session = l___x7749231778538ccb__14._xd644d9e3ba63f27f("MenuSession", p63);
    v64.main_page = p62;
...
function u1._queuePurchaseOptionsRefresh(u134) --[[ Line: 637 ]]
    ...
    if u134.purchase_option_refresh_queued then
        ...
        task.defer(function() --[[ Line: 643 ]]
            -- upvalues: u134 (copy), l___x7749231778538ccb__14 (ref)
            ...
            local l___xd644d9e3ba63f27f__29 = l___x7749231778538ccb__14._xd644d9e3ba63f27f;
            local v136 = "ShowcasePage";
            if l__pages__28 then
                l__pages__28 = l__pages__28.showcase_page;
            end;
            local v137 = l___xd644d9e3ba63f27f__29(v136, l__pages__28);
...
function u1._openBannerGiftBrowser(u166, u167) --[[ Line: 781 ]]
    ...
    elseif typeof(u167) == "table" and typeof(u167.product_id) == "number" then
        local l___xe4b708070c7cd741__32 = l__Classes__13._xe4b708070c7cd741;
        if l___xe4b708070c7cd741__32 and typeof(l___xe4b708070c7cd741__32._x85ec8b5d5b90212b) == "function" then
            u166._gift_browser_open = true;
            u166:_queuePurchaseOptionsRefresh();
            local v170 = l___xe4b708070c7cd741__32:_x85ec8b5d5b90212b("PlayerBrowser", {
                ignore_self = true,
                max_select = 1,
                ...
                selected_callback = function(p168) --[[ Name: selected_callback, Line 802 ]]
                    ...
                    if typeof(p168) == "number" then
                        ...
                        u166:_queuePurchaseOptionsRefresh();
                        l__Packets__8._x5f5c9057d57f77dd:Fire({
                            op = "gift_dev_product",
...
function u1._notifyPullError(_, p303) --[[ Line: 1379 ]]
    ...
    if p303 == "insufficient_eligible_crimson" then
        l__Classes__13._x9a86d5566d6a5327:_xaf050cbdd701f102({
            play_sound = true,
            main_text = u3[p303]
        });
    end;
...
function u1._showRevealPage(p309, p310, p311, p312) --[[ Line: 1409 ]]
    -- upvalues: l___x7749231778538ccb__14 (copy)
    local v313 = l___x7749231778538ccb__14._xd644d9e3ba63f27f("ShowcasePage", p310);
...
function u1._showDirectPurchaseResultPage(p323, p324, p325) --[[ Line: 1446 ]]
    -- upvalues: l___x7749231778538ccb__14 (copy)
    local v326 = l___x7749231778538ccb__14._xd644d9e3ba63f27f("ShowcasePage", p325);
...
function u1._startShowcaseBannerPull(u348, p349, u350, u351) --[[ Line: 1522 ]]
    -- upvalues: l___x7749231778538ccb__14 (copy), l__Classes__13 (copy), l__HttpService__1 (copy), l__Packets__8 (copy)
    local u352 = l___x7749231778538ccb__14._xd644d9e3ba63f27f("ShowcasePage", p349);
    local u353;
    if u352 then
    ...
    l__Classes__13._x6dbba03a0636f7d8:_x282746dbf42c87cb("EXTRACT_SOUND", true);
    ...
    task.spawn(function() --[[ Line: 1536 ]]
        ...
        local v355, v356 = pcall(function() --[[ Line: 1537 ]]
            ...
            return l__Packets__8._x547c4b3f346ef6af:Fire(u354, u350.id, u351);
        end);
...
function u1.startBannerPullFromShowcase(p357, p358, p359, p360) --[[ Line: 1581 ]]
    ...
    local v361 = l___x7749231778538ccb__14._xd644d9e3ba63f27f("ShowcasePage", p358);
...
function u1.startRevealReroll(p363, p364, p365, p366) --[[ Line: 1612 ]]
    -- upvalues: l___x7749231778538ccb__14 (copy)
    local v367 = l___x7749231778538ccb__14._xd644d9e3ba63f27f("ShowcasePage", p364);
...
function u1.activateBannerPurchaseOption(p369, p370, p371) --[[ Line: 1625 ]]
    ...
    if typeof(p371) == "table" then
        if p371.kind == "robux" then
            ...
            l__Packets__8._x5f5c9057d57f77dd:Fire(p371.product_id);
            return true;
    ...
    if u374 and not u372.pull_in_flight then
        ...
        task.spawn(function() --[[ Line: 1689 ]]
            ...
            local v376, v377 = pcall(function() --[[ Line: 1690 ]]
                ...
                return l__Packets__8._x547c4b3f346ef6af:Fire(u375, u374.id, u373);
            end);
...
function u1._bind(u432) --[[ Line: 1933 ]]
    ...
    u432.yen_inst = l__Classes__13._x8399b2bb73e12808:_xe7f02e22353709c3("yen");
    u432.crimson_inst = l__Classes__13._x8399b2bb73e12808:_xe7f02e22353709c3("crimson");
    ...
    u432.trove:Connect(l__Packets__8._xc2915548d25f77de.OnClientEvent, function(p436) --[[ Line: 1977 ]]
        -- upvalues: u432 (copy)
    ...
    u432.trove:Connect(l__Packets__8._x5885ef99bde095ee.OnClientEvent, function(p438) --[[ Line: 2018 ]]
        -- upvalues: u432 (copy)
