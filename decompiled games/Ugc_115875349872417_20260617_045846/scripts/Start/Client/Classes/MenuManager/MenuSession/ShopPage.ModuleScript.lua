...
local l___x7749231778538ccb__6 = require(script.Parent.Parent.Parent.Parent._x7749231778538ccb);
local u2 = {
    Deals = {
...
function u1.new(p3, p4) --[[ Line: 30 ]]
    -- upvalues: u1 (copy), l___x7749231778538ccb__6 (copy), l__Trove__3 (copy), l__UIAssets__4 (copy), u2 (copy)
    local v5 = setmetatable({}, u1);
    v5.menu_session = l___x7749231778538ccb__6._xd644d9e3ba63f27f("MenuSession", p4);
    v5.parent_os = p3;
    ...
    for v6, v7 in u2 do
        local u8 = l___x7749231778538ccb__6._xd644d9e3ba63f27f("ShopTabClass", require(v7.module)).new(v5.main_page, v5.menu_session);
    ...
    for u17, _ in u16.tabs do
        ...
        if v19 then
            u16.trove:Connect(v19.Activated, function() --[[ Line: 125 ]]
                ...
                l__Classes__5._x6dbba03a0636f7d8:_x282746dbf42c87cb("BACK2", true);
                u16:openTab(u17);
            end);
        else
