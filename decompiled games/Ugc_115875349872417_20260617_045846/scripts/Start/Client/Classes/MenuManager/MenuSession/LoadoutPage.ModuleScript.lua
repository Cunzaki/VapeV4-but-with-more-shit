...
local l___x7749231778538ccb__10 = require(script.Parent.Parent.Parent.Parent._x7749231778538ccb);
local u2 = { "gun", "melee" };
local u3 = {
    gun = true,
    melee = true
...
function u1.new(p12, p13) --[[ Line: 112 ]]
    -- upvalues: u1 (copy), l___x7749231778538ccb__10 (copy), l__UIAssets__8 (copy), l__Trove__7 (copy)
    local v14 = setmetatable({}, u1);
    v14.menu_session = l___x7749231778538ccb__10._xd644d9e3ba63f27f("MenuSession", p13);
    v14.parent_os = p12;
...
function u1.openSection(p76, p77, p78) --[[ Line: 410 ]]
    ...
    if p78 == true then
        l__Classes__9._x6dbba03a0636f7d8:_x282746dbf42c87cb("BACK1", true);
    end;
...
function u1.selectEntry(u84, p85, p86) --[[ Line: 445 ]]
    ...
    if p85 then
        if p86 == true then
            l__Classes__9._x6dbba03a0636f7d8:_x282746dbf42c87cb("UI_CLICK", true);
        end;
    ...
    if p95 and p95.owned then
        if u3[p95.item_type] then
            ...
            if v96 and v96.equipped_loadout then
                l__Classes__9._x6dbba03a0636f7d8:_x282746dbf42c87cb("TAPE_MOVE", true);
                l__Classes__9._x6dbba03a0636f7d8:_x282746dbf42c87cb("BULLET_GAINED", true);
                v96.equipped_loadout[p95.item_type] = p95.item_id;
                l__Packets__5._x15f77d251c70b496:Fire({
...
function u1.tryPurchaseItem(u97, u98) --[[ Line: 560 ]]
    ...
    if v99 then
        if v99.purchasable then
            ...
            l__Classes__9._xe4b708070c7cd741:_x85ec8b5d5b90212b("Modal", {
                title_text = u104 and "Unlock " .. v99.name or "NOT ENOUGH YEN",
                body_text = v110,
                actions = {
                    {
                        action_size = 2,
                        action_text = u104 and "BUY WITH CRIMSON" or "SKIP WITH CRIMSON",
                        action_subtext = v109,
                        ...
                        action_callback = function() --[[ Name: action_callback, Line 611 ]]
                            ...
                            if u101 < (u104 and u103 or u107) then
                                ...
                                l__Packets__5._xec69a99c4f5069c4:Fire({
                                    op = "buy",
            ...
            actions = {
                {
                    ...
                    action_callback = function() --[[ Name: action_callback, Line 663 ]]
                        ...
                        l__Packets__5._xb0f5f2d2d71ad910:Fire({
...
function u1.Init(u126) --[[ Line: 782 ]]
    -- upvalues: l__Classes__9 (copy), l___x7749231778538ccb__10 (copy)
    u126.item_profile_data = u126.menu_session.item_profile_data;
    u126.yen_inst = l__Classes__9._x8399b2bb73e12808:_xe7f02e22353709c3("yen");
    u126.crimson_inst = l__Classes__9._x8399b2bb73e12808:_xe7f02e22353709c3("crimson");
    u126:_buildItems();
    u126.trove:Connect(u126.menu_session.onItemProfileUpdated, function(p127) --[[ Line: 789 ]]
        -- upvalues: u126 (copy), l___x7749231778538ccb__10 (ref)
        u126.item_profile_data = p127;
        u126:refreshAllItems();
        local l___xd644d9e3ba63f27f__26 = l___x7749231778538ccb__10._xd644d9e3ba63f27f;
        ...
        local v129 = l___xd644d9e3ba63f27f__26(v128, l__pages__27);
