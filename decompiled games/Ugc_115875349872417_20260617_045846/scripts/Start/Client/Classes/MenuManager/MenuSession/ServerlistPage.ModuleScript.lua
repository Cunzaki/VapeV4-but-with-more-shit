...
local l___x7749231778538ccb__9 = require(script.Parent.Parent.Parent.Parent._x7749231778538ccb);
...
function u1.new(p17, p18) --[[ Line: 139 ]]
    -- upvalues: u1 (copy), l___x7749231778538ccb__9 (copy), l__Trove__4 (copy), l__UIAssets__6 (copy), u3 (copy), l__Context__10 (copy)
    local v19 = setmetatable({}, u1);
    v19.menu_session = l___x7749231778538ccb__9._xd644d9e3ba63f27f("MenuSession", p18);
    v19.parent_os = p17;
...
function u1.cycleRegionFilter(p27) --[[ Line: 218 ]]
    ...
    l__Classes__8._x6dbba03a0636f7d8:_x282746dbf42c87cb("CASETTE_PLAY", true);
...
function u1.sendSnapshotRequest(p37, p38, p39) --[[ Line: 276 ]]
    ...
    if p38 then
        ...
        if p39 or (not v41 or v40 - v41 >= 5) then
            ...
            l__Packets__3._x53c55d919490b907:Fire({
                op = "get_snapshot",
                server_type = p38
            });
        end;
...
function u1.requestLoadMore(u49) --[[ Line: 319 ]]
    ...
    if u49.load_more_db then
        ...
        l__Classes__8._x6dbba03a0636f7d8:_x282746dbf42c87cb("CASETTE_PLAY", true);
        l__Packets__3._x53c55d919490b907:Fire(v50);
        print("REQUESTED TO LOAD MORE");
    end;
end;
function u1.renderSnapshot(u51, p52) --[[ Line: 338 ]]
    ...
    if l__server_type__16 then
        ...
        local function u64(p53, p54) --[[ Line: 355 ]]
            ...
            if u51.render_id == l__render_id__17 then
                ...
                local u61 = false;
                local u62 = u55.Button.Activated:Connect(function() --[[ Line: 381 ]]
                    -- upvalues: l__Classes__8 (ref), u61 (ref), l__ServerActions__22 (copy), l__TweenService__1 (ref)
                    l__Classes__8._x6dbba03a0636f7d8:_x282746dbf42c87cb("UI_CLICK", true);
                    if u61 then
                        u61 = false;
                        task.delay(0.2, function() --[[ Line: 385 ]]
                ...
                local u63 = u55.ServerActions.JoinFrame.JoinServer.Activated:Connect(function() --[[ Line: 398 ]]
                    -- upvalues: u61 (ref), u51 (ref), u56 (ref)
                    if u61 then
                        u51:tryJoinServer(u56);
                    end;
                end);
                u51.list_trove:Add(function() --[[ Name: clean, Line 404 ]]
...
function u1.onNewSnapshot(p67, p68) --[[ Line: 431 ]]
...
function u1.start(p70, p71) --[[ Line: 446 ]]
...
function u1.refreshList(u72) --[[ Line: 467 ]]
    ...
    if u72.current_server_type and not u72.refresh_db then
        u72.refresh_db = true;
        task.delay(1, function() --[[ Line: 473 ]]
            -- upvalues: u72 (copy)
...
function u1.tryJoinServer(_, p73) --[[ Line: 483 ]]
    ...
    if type(p73) == "table" then
        ...
        if type(v74) == "number" then
            ...
            l__Classes__8._x6dbba03a0636f7d8:_x282746dbf42c87cb("TAPE_MOVE", true);
            l__Packets__3._xd107c8ee5ed343a1:Fire(v75);
        end;
    end;
end;
function u1.Init(u76) --[[ Line: 503 ]]
    ...
    u76.trove:Add(l__Packets__3._x53c55d919490b907.OnClientEvent:Connect(function(p77) --[[ Line: 507 ]]
        -- upvalues: u76 (copy)
    ...
    u76.trove:Add(l__TextButton__29.Activated:Connect(function() --[[ Line: 518 ]]
        -- upvalues: u76 (copy)
        u76:requestLoadMore();
    end));
    u76.trove:Add(l__RefreshButton__30.Activated:Connect(function() --[[ Line: 522 ]]
        -- upvalues: u76 (copy)
        u76:refreshList();
    end));
    u76.trove:Add(l__TextButton__31.Activated:Connect(function() --[[ Line: 526 ]]
        -- upvalues: u76 (copy)
        u76:cycleRegionFilter();
    end));
    u76.trove:Add(l__TextButton__32.Activated:Connect(function() --[[ Line: 530 ]]
        -- upvalues: u76 (copy)
