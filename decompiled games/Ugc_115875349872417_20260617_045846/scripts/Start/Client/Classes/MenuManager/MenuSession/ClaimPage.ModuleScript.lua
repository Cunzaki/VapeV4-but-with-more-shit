...
function u1.new(p2, p3) --[[ Line: 25 ]]
    -- upvalues: u1 (copy), l___x7749231778538ccb__9 (copy), l__Trove__6 (copy)
    local v4 = setmetatable({}, u1);
    v4.menu_session = l___x7749231778538ccb__9._xd644d9e3ba63f27f("MenuSession", p3);
    v4.parent_os = p2;
...
function u1.start(u7, u8) --[[ Line: 51 ]]
        ...
        return l__Promise__5.new(function(u14, _, p15) --[[ Line: 114 ]]
            ...
            local function u40(u25, u26) --[[ Line: 137 ]]
                ...
                if u25.reason == "kill" then
                    return l__Promise__5.new(function(u27, _, _) --[[ Line: 139 ]]
                        ...
                        if u18 ~= 0.1 then
                            local v34 = l__Classes__8._x6dbba03a0636f7d8:_x282746dbf42c87cb("GENERIC_LONG", true);
            ...
            if v20 then
                u46 = l__Promise__5.delay(v45 - 0.7):andThen(function() --[[ Line: 279 ]]
                    ...
                    l__Classes__8._x6dbba03a0636f7d8:_x282746dbf42c87cb("DNB_BUILDUP", true);
                end);
            else
                u46 = nil;
            end;
            local u48 = l__Promise__5.delay(v45):finally(function() --[[ Line: 284 ]]
                ...
                table.clear(u19);
                l__Classes__8._x6dbba03a0636f7d8:_x282746dbf42c87cb("RELEASE2", true);
                u24:Disconnect();
                u24 = nil;
                u14();
            end);
    ...
    local u56 = u52:finally(function() --[[ Line: 322 ]]
        ...
        return l__Promise__5.new(function(u53, _, p54) --[[ Line: 323 ]]
            ...
            if not u7.finished then
                ...
                l__YenCount__22.Text = "¥" .. l__Classes__8.Util:formatNumber(l__Classes__8._x8399b2bb73e12808:_xe7f02e22353709c3("yen").Value);
            ...
            local u55 = l__Promise__5.delay(1.35);
            u55:finally(function() --[[ Line: 351 ]]
                -- upvalues: l__TweenService__2 (ref), u9 (ref), l__Statistics__23 (copy), u53 (copy)
    ...
    local u57 = false;
    local v59 = l__UserInputService__3.InputBegan:Connect(function(p58, _) --[[ Line: 372 ]]
        -- upvalues: u57 (ref), u13 (copy), u52 (copy), u56 (copy), u9 (copy), l__TweenService__2 (ref)
        if p58.UserInputType == Enum.UserInputType.MouseButton1 then
            ...
            if u9 and u9:FindFirstChild("Main") then
                ...
                task.delay(1, function() --[[ Line: 383 ]]
                    -- upvalues: u9 (ref), u57 (ref), l__TweenService__2 (ref)
                    if u9 and u9:FindFirstChild("Main") then
                        u57 = false;
...
function u1.Init(_) --[[ Line: 398 ]] end;
return u1;
