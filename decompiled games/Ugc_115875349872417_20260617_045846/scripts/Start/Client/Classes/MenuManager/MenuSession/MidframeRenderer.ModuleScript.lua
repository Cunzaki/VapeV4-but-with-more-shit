...
function u1.new(p4, p5) --[[ Line: 62 ]]
    -- upvalues: u1 (copy), l___x7749231778538ccb__9 (copy), l__Trove__3 (copy), l__Context__8 (copy), l__MatchmakingClient__11 (copy)
    local u6 = setmetatable({}, u1);
    u6._session = l___x7749231778538ccb__9._xd644d9e3ba63f27f("MenuSession", p5);
    u6.mid_ui = p4;
...
function u1._showInvitePrompt(u14, p15) --[[ Line: 153 ]]
    ...
    local v16 = l__Classes__7._x9a86d5566d6a5327:_x56e35d38c98d820d({
        lifetime = 20,
        play_sound = true,
...
function u1._onQueueStart(p44) --[[ Line: 309 ]]
    ...
    l__Classes__7._x6dbba03a0636f7d8:_x282746dbf42c87cb("BEEP2", true);
...
function u1._onQueueEnd(p45) --[[ Line: 331 ]]
    ...
    l__Classes__7._x6dbba03a0636f7d8:_x282746dbf42c87cb("BEEP1", true);
...
function u1._initState(u88) --[[ Line: 621 ]]
    ...
    u88._trove:Connect(l__PartyContainer__35.AddIcon.Button.Activated, function() --[[ Line: 648 ]]
        ...
        l__Classes__7._xe4b708070c7cd741:_x85ec8b5d5b90212b("PlayerBrowser", {
