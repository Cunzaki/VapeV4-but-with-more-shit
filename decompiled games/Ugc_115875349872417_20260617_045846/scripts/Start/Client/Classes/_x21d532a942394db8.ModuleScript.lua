-- Decompiled from: Start.Client.Classes._x21d532a942394db8
-- Class: ModuleScript
...
local function u13(p9, p10) --[[ Line: 59 ]]
...
local function u17(p14) --[[ Line: 75 ]]
...
local function u22(p18) --[[ Line: 111 ]]
...
local function u27(p23) --[[ Line: 145 ]]
...
local function u33(p28) --[[ Line: 171 ]]
...
local function u40(p34, p35) --[[ Line: 222 ]]
...
local function u45(p41, p42) --[[ Line: 250 ]]
    if not p41 then
        return nil;
    end;
    for _, v43 in p42 do
...
local function u62(p46, p47, p48, p49) --[[ Line: 265 ]]
...
local function u82(p70, p71, p72) --[[ Line: 343 ]]
...
local function u94(p83, p84, p85) --[[ Line: 365 ]]
...
function u1._x83ed94bfb82a8c9f() --[[ Line: 381 ]]
    -- upvalues: u1 (copy)
    return setmetatable({}, u1);
end;
function u1._x456600da66f7bf55(_, p95, p96, p97, p98, p99) --[[ Line: 387 ]]
    -- upvalues: l___x7749231778538ccb__6 (copy), l__SkinDefs__4 (copy), u8 (copy), u13 (copy), u17 (copy), u27 (copy), u33 (copy), u62 (copy), u40 (copy), u82 (copy), u94 (copy)
    local v100 = l___x7749231778538ccb__6._xd644d9e3ba63f27f("", p95);
    ...
    local v104 = v100 and typeof(v100._xf6a9e1e11ca92331) == "function" and (v100._xf6a9e1e11ca92331(p96) or {}) or v103;
    local v105 = u8(v104);
    u13(v105, (u17(v102)));
...
function u1._x8dec6b77b6e41757(_, p133, p134, p135) --[[ Line: 491 ]]
    if p133 then
        p133 = p133.sounds;
    end;
...
function u1._x1cb0a480fdf821f4(p136, p137, p138, p139, p140, p141, p142) --[[ Line: 500 ]]
    -- upvalues: l___x7749231778538ccb__6 (copy)
    local v143 = l___x7749231778538ccb__6._xd644d9e3ba63f27f("", p138);
    local v144 = p136:_x8dec6b77b6e41757(p137, p139, p142);
    if typeof(v144) ~= "Instance" then
        return v143:_x282746dbf42c87cb(v144, p140, p141);
    end;
    if v144:IsA("Sound") or v144:IsA("SoundGroup") then
        return v143:_x96bdbb48d62a3075(v144.Name, v144, p140, p141);
    end;
    warn("INVALID SKIN SOUND INSTANCE : ", v144);
    return nil;
end;
function u1._xbb52e7146aad57dc(_, p145, p146, p147) --[[ Line: 515 ]]
    if p145 then
        p145 = p145.effects;
    end;
...
function u1._x3499149a5ebaf25e(p148, p149, p150, ...) --[[ Line: 524 ]]
    -- upvalues: l__Classes__5 (copy)
    local v151 = p148:_xbb52e7146aad57dc(p149, p150, p150);
    if typeof(v151) == "function" then
        return v151(l__Classes__5._x181e05d210129765, ...);
    else
        return l__Classes__5._x181e05d210129765:_x08cf916050468466(v151, ...);
    end;
end;
function u1._x44bcd6af41218f92(_) --[[ Line: 533 ]] end;
return u1;
