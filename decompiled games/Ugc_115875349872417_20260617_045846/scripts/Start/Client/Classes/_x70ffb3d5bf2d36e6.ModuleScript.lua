-- Decompiled from: Start.Client.Classes._x70ffb3d5bf2d36e6
-- Class: ModuleScript
...
function u1._x83ed94bfb82a8c9f() --[[ Line: 29 ]]
    -- upvalues: u1 (copy), l__LeaderboardAssets__6 (copy)
    local v2 = setmetatable({}, u1);
    v2._x3dcafbe291f6df8b = l__LeaderboardAssets__6.Leaderboard:Clone();
    v2._x5b2bf445cf8f0321 = {};
    return v2;
end;
function u1._xedd8955d1d4cf18b(u3, u4) --[[ Line: 38 ]]
    -- upvalues: l__Trove__4 (copy), l__TitleData__5 (copy), l__RunService__2 (copy), l__Classes__8 (copy)
    if u3._x5b2bf445cf8f0321[u4] then
    else
        local function u5() --[[ Line: 41 ]]
            -- upvalues: u3 (copy), u4 (copy)
            u3:_x19b1a9e110927a66(u4);
        end;
        local u6 = {};
        local v7 = l__Trove__4.new();
        local u8 = v7:Extend();
        local function v28(u9) --[[ Line: 49 ]]
            ...
            task.defer(function() --[[ Name: setupFromReadableFolder, Line 57 ]]
                ...
                if u12 then
                    ...
                    local function u14(p13) --[[ Line: 87 ]]
                        -- upvalues: u10 (ref)
                    ...
                    task.spawn(function() --[[ Line: 71 ]]
                        ...
                        if u16 then
                            local v17 = u16.Changed:Connect(function() --[[ Line: 78 ]]
                    ...
                    local function u19(p18) --[[ Line: 91 ]]
                    ...
                    task.spawn(function() --[[ Line: 71 ]]
                        ...
                        if u21 then
                            local v22 = u21.Changed:Connect(function() --[[ Line: 78 ]]
                    ...
                    local function u24(p23) --[[ Line: 96 ]]
                        -- upvalues: u10 (ref)
                    ...
                    task.spawn(function() --[[ Line: 71 ]]
                        ...
                        if u26 then
                            local v27 = u26.Changed:Connect(function() --[[ Line: 78 ]]
                    ...
                    u3:_x19b1a9e110927a66(u4);
                    warn("?? NO AVAILABLE FOLDER TO READ FROM : ", u4);
                end;
            end);
            u8:Connect(l__RunService__2.Heartbeat, function() --[[ Line: 108 ]]
        ...
        u6._trove = v7;
        u3._x5b2bf445cf8f0321[u4] = u6;
    end;
end;
function u1._x19b1a9e110927a66(p29, p30) --[[ Line: 131 ]]
    local v31 = p29._x5b2bf445cf8f0321[p30];
    if v31 then
        v31._trove:Clean();
        p29._x5b2bf445cf8f0321[p30] = nil;
    end;
end;
function u1._x44bcd6af41218f92(u32) --[[ Line: 140 ]]
    ...
    if l__Context__9.is_public_lobby then
        task.defer(function() --[[ Line: 145 ]]
            ...
            u32._x3dcafbe291f6df8b.Parent = l__Classes__8.MenuManager.screen;
        end);
        for _, u33 in l__Players__1:GetPlayers() do
            task.spawn(function() --[[ Line: 150 ]]
                -- upvalues: u32 (copy), u33 (copy)
                u32:_xedd8955d1d4cf18b(u33);
            end);
        end;
        l__Players__1.PlayerAdded:Connect(function(p34) --[[ Line: 155 ]]
            -- upvalues: u32 (copy)
            u32:_xedd8955d1d4cf18b(p34);
        end);
        l__Players__1.PlayerRemoving:Connect(function(p35) --[[ Line: 159 ]]
            -- upvalues: u32 (copy)
            u32:_x19b1a9e110927a66(p35);
        end);
    end;
end;
return u1;
