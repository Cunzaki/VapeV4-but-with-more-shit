...
u10[13] = function() --[[ Line: 554 ]]
    -- upvalues: u277 (ref), u278 (ref)
    u277 = u277 + 1;
    return u278[u277];
end;
function u11.Instance(p383) --[[ Line: 555 ]]
    -- upvalues: u281 (ref), u280 (ref), u282 (ref), u279 (ref), u277 (ref), u278 (ref)
    local v384 = u281 + 1;
    if u280 < v384 then
        while u280 < v384 do
            u280 = u280 * 2;
...
return {
    Import = function(p509) --[[ Name: Import, Line 676 ]]
        -- upvalues: u279 (ref), u282 (ref), u280 (ref), u281 (ref), u278 (ref), u277 (ref)
        u279 = p509;
        u282 = p509.Buffer;
        u280 = p509.BufferLength;
        u281 = p509.BufferOffset;
        u278 = p509.Instances;
        u277 = p509.InstancesOffset;
    end,
    Export = function() --[[ Name: Export, Line 685 ]]
        -- upvalues: u279 (ref), u280 (ref), u281 (ref), u277 (ref)
        u279.BufferLength = u280;
        u279.BufferOffset = u281;
        u279.InstancesOffset = u277;
        return u279;
    end,
    Truncate = function() --[[ Name: Truncate, Line 692 ]]
        -- upvalues: u281 (ref), u282 (ref), u277 (ref), u278 (ref)
