...
local v36 = u3.Dropdown(v34, { "Rank", "Skill" }, function(p35) --[[ Line: 173 ]]
    -- upvalues: u27 (ref), u26 (ref), l__Call__15 (copy), u25 (ref)
    u27 = p35;
    if u26 then
        l__Call__15("GetRankList", u27, u25);
    end;
end, "Rank");
v36.PosOffsetX = 5;
v36.PosOffsetY = 5;
...
local v38 = u3.Dropdown(v34, l__TypeNames__16, function(p37) --[[ Line: 183 ]]
    -- upvalues: u25 (ref), l__TypeNumberToId__17 (copy), u26 (ref), l__Call__15 (copy), u27 (ref)
    u25 = l__TypeNumberToId__17[p37];
    if u26 then
        l__Call__15("GetRankList", u27, u25);
    end;
...
v7.Add("ranks", {}, function() --[[ Line: 395 ]]
    -- upvalues: u26 (ref), u28 (ref), u13 (ref), l__Call__15 (copy), u27 (ref), u25 (ref)
    if u26 then
        u28();
    else
        u13();
...
local function _() --[[ Line: 404 ]]
    -- upvalues: u20 (copy), u26 (ref), u15 (copy), l__FreeMouse__11 (copy), u17 (copy)
    u20.Text = "C";
    u26 = true;
    u15.Visible = true;
...
u14 = function() --[[ Name: ClosePanel, Line 411 ]]
    -- upvalues: u26 (ref), l__FreeMouse__11 (copy), u17 (copy), u15 (copy), u39 (copy), l__clear__4 (copy)
    u26 = false;
