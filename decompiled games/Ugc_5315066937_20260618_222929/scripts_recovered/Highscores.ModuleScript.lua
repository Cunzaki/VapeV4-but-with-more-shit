...
local u48 = u6.Dropdown(u46, l__TypeNames__20, function(p47) --[[ Line: 204 ]]
    -- upvalues: u38 (ref), l__TypeNumberToId__21 (copy), u37 (ref), l__Call__19 (copy), u40 (ref), u39 (ref), u36 (ref)
    u38 = l__TypeNumberToId__21[p47];
    if u37 then
        l__Call__19("GetHighscores", u40, u39, u38, u36);
    end;
...
local function u53(p51) --[[ Line: 225 ]]
    -- upvalues: u49 (ref), u6 (copy), u46 (copy), u39 (ref), u37 (ref), l__Call__19 (copy), u40 (ref), u38 (ref), u36 (ref), u48 (copy), u50 (ref)
    if u49 then
        u49:Remove();
    end;
    u49 = u6.Dropdown(u46, p51, function(p52) --[[ Line: 229 ]]
        -- upvalues: u39 (ref), u37 (ref), l__Call__19 (ref), u40 (ref), u38 (ref), u36 (ref)
        u39 = p52 - 1;
        if u37 then
            l__Call__19("GetHighscores", u40, u39, u38, u36);
        end;
...
local function u57() --[[ Line: 247 ]]
    -- upvalues: u50 (ref), u6 (copy), u46 (copy), u36 (ref), u37 (ref), l__Call__19 (copy), u40 (ref), u39 (ref), u38 (ref), u49 (ref), u48 (copy)
    local v55 = { "Approved", "All" };
    u50 = u6.Dropdown(u46, v55, function(p56) --[[ Line: 249 ]]
        -- upvalues: u36 (ref), u37 (ref), l__Call__19 (ref), u40 (ref), u39 (ref), u38 (ref)
        u36 = p56 == 2;
        if u37 then
            l__Call__19("GetHighscores", u40, u39, u38, u36);
        end;
...
v14.Ready:Add(function() --[[ Line: 262 ]]
    -- upvalues: u40 (ref), u21 (ref), l__sort__5 (copy), l__AllMaps__25 (copy), u58 (ref), u6 (copy), u46 (copy), u53 (copy), u37 (ref), l__Call__19 (copy), u39 (ref), u38 (ref), u36 (ref), u26 (copy), u49 (ref), u48 (copy), u50 (ref), u1 (copy)
    u40 = u21;
    ...
    for v63 = 1, #l__AllMaps__25 do
        ...
        if v64.AssetId == u40 then
            v62 = v63;
        end;
    end;
    u58 = u6.Dropdown(u46, v61, function(p65) --[[ Line: 278 ]]
        -- upvalues: l__AllMaps__25 (ref), u40 (ref), u53 (ref), u37 (ref), l__Call__19 (ref), u39 (ref), u38 (ref), u36 (ref)
...
local u111 = {
    ...
    function(p104) --[[ Line: 406 ]]
        -- upvalues: u40 (ref), u21 (ref)
        if p104.t.Bot and u40 == u21 then
            return "Spectate";
        end;
    end,
    function(p105) --[[ Line: 411 ]]
        -- upvalues: u40 (ref), u21 (ref), u4 (copy)
        if p105.t.Bot and u40 == u21 then
    ...
    function(p106) --[[ Line: 416 ]]
        -- upvalues: u40 (ref), u21 (ref)
        if p106.t.Bot and u40 == u21 then
            return "Race";
        end;
    end,
    function(_) --[[ Line: 421 ]]
...
local function u163(p138, p139, u140, p141) --[[ Line: 530 ]]
    -- upvalues: l__New__11 (copy), u100 (copy), u4 (copy), l__TextBox__13 (copy), l__Avatar__12 (copy), u19 (ref), u36 (ref), u54 (copy), u6 (copy), u3 (copy), u5 (copy), l__time__1 (copy), l__floor__4 (copy), u137 (copy), l__New__16 (copy), l__MaxAcceleration__17 (copy)
    ...
    if u19 and (u36 and u54[u140.State]) then
...
v15.NewTimeHook:Add(function(p172) --[[ Line: 684 ]]
    -- upvalues: u37 (ref), u38 (ref), u39 (ref), u40 (ref), u72 (ref), u2 (copy), u100 (copy), u4 (copy), u3 (copy), l__sort__5 (copy), u166 (copy), u163 (copy), u45 (copy), l__insert__7 (copy), l__remove__8 (copy), u99 (copy), u70 (ref)
    if u37 and (p172.Style == u38 and (p172.Mode == u39 and p172.Map == u40)) then
        local v173 = true;
        local v174 = nil;
        for v175 = 1, #u72 do
            local v176 = u72[v175];
...
v9.Add("NewHighscores", function(p181) --[[ Line: 739 ]]
    -- upvalues: u37 (ref), u72 (ref), l__clear__6 (copy), u180 (copy), u40 (ref), u39 (ref), u38 (ref), l__remove__8 (copy), u3 (copy), l__sort__5 (copy), u166 (copy), u163 (copy), u45 (copy), l__min__2 (copy), u99 (copy)
    if u37 and (not u72[300] or u72[300].t.Time > p181[1].Time) then
        l__clear__6(u180);
        for v182 = #u72, 1, -1 do
            local v183 = u72[v182];
            local l__t__35 = v183.t;
            if l__t__35.Map == u40 and (l__t__35.Mode == u39 and l__t__35.Style == u38) then
        ...
        for v184 = #p181, 1, -1 do
            ...
            if v185.Map == u40 and (v185.Mode == u39 and v185.Style == u38) then
...
v9.Add("DeleteHighscore", function(p199) --[[ Line: 804 ]]
    -- upvalues: u37 (ref), u71 (copy), u72 (ref), l__remove__8 (copy), u99 (copy)
    if u37 then
...
v9.Add("DeleteHighscores", function(p202) --[[ Line: 819 ]]
    -- upvalues: u37 (ref), l__clear__6 (copy), u180 (copy), u72 (ref), l__remove__8 (copy), u99 (copy)
    if u37 then
        l__clear__6(u180);
        for v203 = 1, #p202 do
...
local function u206() --[[ Line: 839 ]]
    -- upvalues: u31 (copy), u37 (ref), u26 (copy), l__FreeMouse__14 (copy), u28 (copy)
    u31.Text = "C";
    u37 = true;
    u26.Visible = true;
...
u25 = function() --[[ Name: ClosePanel, Line 846 ]]
    -- upvalues: u37 (ref), l__FreeMouse__14 (copy), u28 (copy), u26 (copy), u72 (ref), l__clear__6 (copy)
    u37 = false;
...
v8.Add("OpenWRList", function() --[[ Line: 858 ]]
    -- upvalues: u37 (ref), l__Call__19 (copy), u40 (ref), u39 (ref), u38 (ref), u36 (ref), u206 (ref)
    if not u37 then
        u37 = true;
        if u37 then
            l__Call__19("GetHighscores", u40, u39, u38, u36);
...
v11.Add("wr", {}, function() --[[ Line: 866 ]]
    -- upvalues: u37 (ref), l__Call__19 (copy), u40 (ref), u39 (ref), u38 (ref), u36 (ref), u206 (ref), u25 (ref)
    u37 = not u37;
    if u37 then
        if u37 then
            l__Call__19("GetHighscores", u40, u39, u38, u36);
...
v13.MapInfoChanged:Add(function(p208) --[[ Line: 876 ]]
    -- upvalues: u21 (ref), u37 (ref), u40 (ref), u58 (ref), l__AllMaps__25 (copy)
    ...
    if not u37 then
        ...
        if u58 then
            for v209 = 1, #l__AllMaps__25 do
                if l__AllMaps__25[v209].AssetId == u40 then
                    u58.ChooseItem(v209);
                    return;
                end;
            end;
...
v11.Add("wr", { "MapId" }, function(p210) --[[ Line: 892 ]]
    -- upvalues: u37 (ref), u206 (ref), u58 (ref), l__AllMaps__25 (copy)
    if not u37 then
        u206();
    end;
    if u58 then
...
v12.UserStatusChanged:Add(function(p212, p213) --[[ Line: 916 ]]
    -- upvalues: u71 (copy), u72 (ref), u36 (ref), l__remove__8 (copy), u99 (copy), u19 (ref), u54 (copy)
    local v214 = u71[p212];
    local v215 = v214 and u72[v214];
    if v215 then
        if not u36 and (p213 == 2 or (p213 == 3 or p213 == 4)) then
            v215:Remove();
        ...
        v215.t.State = p213;
        if u19 and (u36 and u54[p213]) then
